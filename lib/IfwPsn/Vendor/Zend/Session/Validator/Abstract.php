...
/**
 * @see IfwPsn_Vendor_Zend_Session_Validator_Interface
 */
require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/Validator/Interface.php';

/**
 * IfwPsn_Vendor_Zend_Session_Validator_Abstract
 *
 * @category   Zend
 * @package    IfwPsn_Vendor_Zend_Session
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwPsn_Vendor_Zend_Session_Validator_Abstract implements IfwPsn_Vendor_Zend_Session_Validator_Interface
{
