...
/**
 * @see IfwPsn_Vendor_Zend_Session_Validator_Abstract
 */
require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/Validator/Abstract.php';

/**
 * IfwPsn_Vendor_Zend_Session_Validator_HttpUserAgent
 *
 * @category   Zend
 * @package    IfwPsn_Vendor_Zend_Session
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwPsn_Vendor_Zend_Session_Validator_HttpUserAgent extends IfwPsn_Vendor_Zend_Session_Validator_Abstract
{
