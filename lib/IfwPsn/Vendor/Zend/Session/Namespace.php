...
/**
 * IfwPsn_Vendor_Zend_Session_Namespace
 *
 * @category   Zend
 * @package    IfwPsn_Vendor_Zend_Session
 * @copyright  Copyright (c) 2005-2014 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwPsn_Vendor_Zend_Session_Namespace extends IfwPsn_Vendor_Zend_Session_Abstract implements IteratorAggregate
{
    ...
    public function __construct($namespace = 'Default', $singleInstance = false)
    {
        ...
        IfwPsn_Vendor_Zend_Session::start(true); // attempt auto-start (throws exception if strict option set)
    ...
    public function __set($name, $value)
    {
        if (isset(self::$_namespaceLocks[$this->_namespace])) {
             ...
             */
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/Exception.php';
            throw new IfwPsn_Vendor_Zend_Session_Exception('This session/namespace has been marked as read-only.');
        }
        ...
        if (parent::$_writable === false) {
             ...
             */
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/Exception.php';
            throw new IfwPsn_Vendor_Zend_Session_Exception(parent::_THROW_NOT_WRITABLE_MSG);
        }
    ...
    public function applySet($callback)
    {
        ...
        if (!is_array($result)) {
             ...
             */
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/Exception.php';
            throw new IfwPsn_Vendor_Zend_Session_Exception('Result must be an array. Got: ' . gettype($result));
        }
    ...
    public function setExpirationSeconds($seconds, $variables = null)
    {
        ...
        if ($seconds <= 0) {
             ...
             */
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/Exception.php';
            throw new IfwPsn_Vendor_Zend_Session_Exception('Seconds must be positive.');
        }
    ...
    public function setExpirationHops($hops, $variables = null, $hopCountOnUsageOnly = false)
    {
        ...
        if ($hops <= 0) {
             ...
             */
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/Exception.php';
            throw new IfwPsn_Vendor_Zend_Session_Exception('Hops must be positive number.');
        }
