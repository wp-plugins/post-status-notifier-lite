...
/**
 * @see IfwPsn_Vendor_Zend_Db_Table_Abstract
 */
require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Db/Table/Abstract.php';

/**
 * @see IfwPsn_Vendor_Zend_Db_Table_Row_Abstract
 */
require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Db/Table/Row/Abstract.php';
...
/**
 * IfwPsn_Vendor_Zend_Session_SaveHandler_DbTable
 *
 * @category   Zend
 * @package    IfwPsn_Vendor_Zend_Session
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwPsn_Vendor_Zend_Session_SaveHandler_DbTable
    extends IfwPsn_Vendor_Zend_Db_Table_Abstract
    implements IfwPsn_Vendor_Zend_Session_SaveHandler_Interface
{
     ...
     * Constructor
     *
     * $config is an instance of IfwPsn_Vendor_Zend_Config or an array of key/value pairs containing configuration options for
     * IfwPsn_Vendor_Zend_Session_SaveHandler_DbTable and IfwPsn_Vendor_Zend_Db_Table_Abstract. These are the configuration options for
     * IfwPsn_Vendor_Zend_Session_SaveHandler_DbTable:
     *
     ...
     *
     * @param  IfwPsn_Vendor_Zend_Config|array $config      User-provided configuration
     * @return void
     * @throws IfwPsn_Vendor_Zend_Session_SaveHandler_Exception
     */
    public function __construct($config)
    {
        if ($config instanceof IfwPsn_Vendor_Zend_Config) {
            ...
            /**
             * @see IfwPsn_Vendor_Zend_Session_SaveHandler_Exception
             */
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/SaveHandler/Exception.php';

            throw new IfwPsn_Vendor_Zend_Session_SaveHandler_Exception(
                '$config must be an instance of IfwPsn_Vendor_Zend_Config or array of key/value pairs containing '
              . 'configuration options for IfwPsn_Vendor_Zend_Session_SaveHandler_DbTable and IfwPsn_Vendor_Zend_Db_Table_Abstract.');
        }
     ...
     * @return IfwPsn_Vendor_Zend_Session_SaveHandler_DbTable
     */
    ...
    protected function _setupTableName()
    {
        if (empty($this->_name) && basename(($this->_name = session_save_path())) != $this->_name) {
            ...
            throw new IfwPsn_Vendor_Zend_Session_SaveHandler_Exception('session.save_path is a path and not a table name.');
        }
    ...
    /**
     * Retrieve session lifetime considering IfwPsn_Vendor_Zend_Session_SaveHandler_DbTable::OVERRIDE_LIFETIME
     *
     * @param IfwPsn_Vendor_Zend_Db_Table_Row_Abstract $row
     * @return int
     */
    protected function _getLifetime(IfwPsn_Vendor_Zend_Db_Table_Row_Abstract $row)
    {
        $return = $this->_lifetime;
     ...
     * @return int
     */
    protected function _getExpirationTime(IfwPsn_Vendor_Zend_Db_Table_Row_Abstract $row)
    {
