...
/**
 * @see IfwPsn_Vendor_Zend_Session_Abstract
 */
require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/Abstract.php';
...
/**
 * @see IfwPsn_Vendor_Zend_Session_SaveHandler_Interface
 */
require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/SaveHandler/Interface.php';


/**
 * IfwPsn_Vendor_Zend_Session
 *
 * @category   Zend
 * @package    IfwPsn_Vendor_Zend_Session
 * @copyright  Copyright (c) 2005-2014 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwPsn_Vendor_Zend_Session extends IfwPsn_Vendor_Zend_Session_Abstract
{
    /**
     * Whether or not IfwPsn_Vendor_Zend_Session is being used with unit tests
     *
     * @internal
     * @var bool
     */
    ...
    /**
     * List of options pertaining to IfwPsn_Vendor_Zend_Session that can be set by developers
     * using IfwPsn_Vendor_Zend_Session::setOptions(). This list intentionally duplicates
    ...
    /**
     * Whether the default options listed in IfwPsn_Vendor_Zend_Session::$_localOptions have been set
     *
     * @var bool
     */
    ...
    public static function setOptions(array $userOptions = array())
    {
        ...
        foreach ($userOptions as $userOptionName => $userOptionValue) {
            ...
            elseif (isset(self::$_localOptions[$userOptionName])) {
                ...
                throw new IfwPsn_Vendor_Zend_Session_Exception("Unknown option: $userOptionName = $userOptionValue");
            }
        }
    }
     ...
     *
     * @param IfwPsn_Vendor_Zend_Session_SaveHandler_Interface $interface
     * @throws IfwPsn_Vendor_Zend_Session_Exception When the session_set_save_handler call fails
     * @return void
     */
    public static function setSaveHandler(IfwPsn_Vendor_Zend_Session_SaveHandler_Interface $saveHandler)
    {
        ...
        if (!$result) {
            throw new IfwPsn_Vendor_Zend_Session_Exception('Unable to set session handler');
        }
    }
    ...
    public static function regenerateId()
    {
        if (!self::$_unitTestEnabled && headers_sent($filename, $linenum)) {
            /** @see IfwPsn_Vendor_Zend_Session_Exception */
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/Exception.php';
            throw new IfwPsn_Vendor_Zend_Session_Exception("You must call " . __CLASS__ . '::' . __FUNCTION__ .
    ...
    public static function start($options = false)
    {
        ...
        if (!self::$_unitTestEnabled && headers_sent($filename, $linenum)) {
            /** @see IfwPsn_Vendor_Zend_Session_Exception */
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/Exception.php';
            throw new IfwPsn_Vendor_Zend_Session_Exception("Session must be started before any output has been sent to the browser;"
     ...
     * has been called during this request by IfwPsn_Vendor_Zend_Session.
     *
     * @return bool
     */
    ...
    public static function setId($id)
    {
        if (!self::$_unitTestEnabled && defined('SID')) {
            /** @see IfwPsn_Vendor_Zend_Session_Exception */
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/Exception.php';
            throw new IfwPsn_Vendor_Zend_Session_Exception('The session has already been started.  The session id must be set first.');
        }
        ...
        if (!is_string($id) || $id === '') {
            /** @see IfwPsn_Vendor_Zend_Session_Exception */
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/Exception.php';
            throw new IfwPsn_Vendor_Zend_Session_Exception('You must provide a non-empty string as a session identifier.');
        }
     ...
     *
     * @param IfwPsn_Vendor_Zend_Session_Validator_Interface $validator
     * @return void
     */
    public static function registerValidator(IfwPsn_Vendor_Zend_Session_Validator_Interface $validator)
    {
        $validator->setup();
    }
    ...
    public static function getIterator()
    {
        if (parent::$_readable === false) {
            /** @see IfwPsn_Vendor_Zend_Session_Exception */
            require_once IFW_PSN_LIB_ROOT . 'IfwPsn/Vendor/Zend/Session/Exception.php';
            throw new IfwPsn_Vendor_Zend_Session_Exception(parent::_THROW_NOT_READABLE_MSG);
        }
