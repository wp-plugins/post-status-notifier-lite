 ...
 * @version    $Id$
 */
class IfwZend_Log_Writer_ZendMonitor extends IfwZend_Log_Writer_Abstract
{
    /**
    ...
    /**
     * Create a new instance of IfwZend_Log_Writer_ZendMonitor
     *
     * @param  array|IfwZend_Config $config
     * @return IfwZend_Log_Writer_ZendMonitor
     */
