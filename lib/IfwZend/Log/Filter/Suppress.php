 ...
 * @version    $Id$
 */
class IfwZend_Log_Filter_Suppress extends IfwZend_Log_Filter_Abstract
{
    /**
     * @var boolean
     */
    ...
    /**
     * Create a new instance of IfwZend_Log_Filter_Suppress
     *
     * @param  array|IfwZend_Config $config
     * @return IfwZend_Log_Filter_Suppress
