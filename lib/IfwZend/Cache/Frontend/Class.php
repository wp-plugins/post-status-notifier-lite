 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Cache_Frontend_Class extends IfwZend_Cache_Core
{
    /**
     * Available options
     *
    ...
    public function __construct(array $options = array())
    {
        ...
        if ($this->_specificOptions['cached_entity'] === null) {
            IfwZend_Cache::throwException('cached_entity must be set !');
        }
    ...
    public function setCachedEntity($cachedEntity)
    {
        if (!is_string($cachedEntity) && !is_object($cachedEntity)) {
            IfwZend_Cache::throwException('cached_entity must be an object or a class name');
        }
