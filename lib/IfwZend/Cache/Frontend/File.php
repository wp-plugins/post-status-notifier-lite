 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Cache_Frontend_File extends IfwZend_Cache_Core
{
     ...
     * - IfwZend_Cache_Frontend_File::MODE_AND or IfwZend_Cache_Frontend_File::MODE_OR
    ...
    public function __construct(array $options = array())
    {
        ...
        if (!isset($this->_specificOptions['master_files'])) {
            IfwZend_Cache::throwException('master_files option must be set');
        }
    }
    ...
    public function setMasterFiles(array $masterFiles)
    {
        ...
        foreach ($masterFiles as $masterFile) {
            ...
            if (!$this->_specificOptions['ignore_missing_master_files'] && !$mtime) {
                IfwZend_Cache::throwException('Unable to read master_file : ' . $masterFile);
            }
