...
class IfwZend_Db
{
    ...
    /**
     * Use the PROFILER constant in the config of a IfwZend_Db_Adapter.
     */
    const PROFILER = 'profiler';

    /**
     * Use the CASE_FOLDING constant in the config of a IfwZend_Db_Adapter.
     */
    const CASE_FOLDING = 'caseFolding';

    /**
     * Use the FETCH_MODE constant in the config of a IfwZend_Db_Adapter.
     */
    const FETCH_MODE = 'fetchMode';

    /**
     * Use the AUTO_QUOTE_IDENTIFIERS constant in the config of a IfwZend_Db_Adapter.
     */
    const AUTO_QUOTE_IDENTIFIERS = 'autoQuoteIdentifiers';

    /**
     * Use the ALLOW_SERIALIZATION constant in the config of a IfwZend_Db_Adapter.
     */
    const ALLOW_SERIALIZATION = 'allowSerialization';

    /**
     * Use the AUTO_RECONNECT_ON_UNSERIALIZE constant in the config of a IfwZend_Db_Adapter.
     */
    ...
    /**
     * Factory for IfwZend_Db_Adapter_Abstract classes.
     *
     * First argument may be a string containing the base of the adapter class
     * name, e.g. 'Mysqli' corresponds to class IfwZend_Db_Adapter_Mysqli.  This
     ...
     *
     * First argument may alternatively be an object of type IfwZend_Config.
     ...
     *
     * If the first argument is of type IfwZend_Config, it is assumed to contain
     * all parameters, and the second argument is ignored.
     *
     * @param  mixed $adapter String name of base adapter class, or IfwZend_Config object.
     * @param  mixed $config  OPTIONAL; an array or IfwZend_Config object with adapter parameters.
     * @return IfwZend_Db_Adapter_Abstract
     * @throws IfwZend_Db_Exception
     */
    public static function factory($adapter, $config = array())
    {
        ...
        /*
         * Convert IfwZend_Config argument to plain string
         * adapter name and separate config object.
         */
        if ($adapter instanceof IfwZend_Config) {
        ...
        if (!is_array($config)) {
            /**
             * @see IfwZend_Db_Exception
             */
            //require_once 'IfwZend/Db/Exception.php';
            throw new IfwZend_Db_Exception('Adapter parameters must be in an array or a IfwZend_Config object');
        }
        ...
        if (!is_string($adapter) || empty($adapter)) {
             ...
             */
            //require_once 'IfwZend/Db/Exception.php';
            throw new IfwZend_Db_Exception('Adapter name must be specified in a string');
        }

        /*
         * Form full adapter class name
         */
        $adapterNamespace = 'IfwZend_Db_Adapter';
        ...
        if (!class_exists($adapterName)) {
            ...
            Ifw_Zend_Loader::loadClass($adapterName);
        }
         ...
         */
        if (! $dbAdapter instanceof IfwZend_Db_Adapter_Abstract) {
            /**
             * @see IfwZend_Db_Exception
             */
            //require_once 'IfwZend/Db/Exception.php';
            throw new IfwZend_Db_Exception("Adapter class '$adapterName' does not extend IfwZend_Db_Adapter_Abstract");
        }
