...
class IfwZend_Locale
{
     ...
     * @throws IfwZend_Locale_Exception When autodetection has been failed
     */
    ...
    public static function getDefault()
    {
        if ((self::$compatibilityMode === true) or (func_num_args() > 0)) {
            if (!self::$_breakChain) {
                ...
                trigger_error('You are running IfwZend_Locale in compatibility mode... please migrate your scripts', E_USER_NOTICE);
     ...
     *
     * @param  string|IfwZend_Locale $locale  Locale to set
     * @param  float              $quality The quality to set from 0 to 1
     * @throws IfwZend_Locale_Exception When a autolocale was given
     * @throws IfwZend_Locale_Exception When a unknown locale was given
     * @return void
     */
    public static function setDefault($locale, $quality = 1)
    {
        if (($locale === 'auto') or ($locale === 'root') or ($locale === 'default') or
            ...
            throw new IfwZend_Locale_Exception('Only full qualified locales can be used as default!');
        }

        if (($quality < 0.1) or ($quality > 100)) {
            //require_once 'IfwZend/Locale/Exception.php';
            throw new IfwZend_Locale_Exception("Quality must be between 0.1 and 100");
        }
        ...
        if (isset(self::$_localeData[(string) $locale]) === true) {
            ...
            if (isset(self::$_localeData[$elocale[0]]) === true) {
                ...
                //require_once 'IfwZend/Locale/Exception.php';
                throw new IfwZend_Locale_Exception("Unknown locale '" . (string) $locale . "' can not be set as default!");
            }
        }
    ...
    public static function getEnvironment()
    {
        ...
        //require_once 'IfwZend/Locale/Data/Translation.php';
        ...
        foreach ($languages as $locale) {
            ...
            if ($language !== 'C') {
                ...
                $language = str_ireplace(
                    array_keys(IfwZend_Locale_Data_Translation::$languageTranslation),
                    array_values(IfwZend_Locale_Data_Translation::$languageTranslation),
                    (string) $language
                );

                $language = str_ireplace(
                    array_keys(IfwZend_Locale_Data_Translation::$regionTranslation),
                    array_values(IfwZend_Locale_Data_Translation::$regionTranslation),
                    $language
                );
     ...
     * Sets a new locale
     *
     * @param  string|IfwZend_Locale $locale (Optional) New locale to set
     * @return void
     */
     ...
     *
     * @param  IfwZend_Locale $object Locale to check for equality
     * @return boolean
     */
    public function equals(IfwZend_Locale $object)
    {
     ...
     * @param  string|IfwZend_Locale $locale (Optional) Locale|Language for which this informations should be returned
    ...
    public static function getTranslationList($path = null, $locale = null, $value = null)
    {
        ...
        $result = IfwZend_Locale_Data::getList($locale, $path, $value);
     ...
     *
     * @param  string|IfwZend_Locale $locale (Optional) Locale for language translation
     * @return array
     * @deprecated
     */
     ...
     *
     * @param  string|IfwZend_Locale $locale (Optional) Locale for script translation
     * @return array
     * @deprecated
     */
     ...
     *
     * @param  string|IfwZend_Locale $locale (Optional) Locale for country translation
     * @return array
     * @deprecated
     */
     ...
     *
     * @param  string|IfwZend_Locale $locale (Optional) Locale for territory translation
     * @return array
     * @deprecated
     */
    ...
    public static function getTranslation($value = null, $path = null, $locale = null)
    {
        //require_once 'IfwZend/Locale/Data.php';
        $locale = self::findLocale($locale);
        $result = IfwZend_Locale_Data::getContent($locale, $path, $value);
     ...
     *
     * @param  string|IfwZend_Locale $locale (Optional) Locale for language translation (defaults to $this locale)
     * @return array
     */
    public static function getQuestion($locale = null)
    {
        //require_once 'IfwZend/Locale/Data.php';
        $locale            = self::findLocale($locale);
        $quest             = IfwZend_Locale_Data::getList($locale, 'question');
     ...
     *
     * @param  string|IfwZend_Locale $locale     Locale to check for
     ...
     *
     * @param string $locale
     * @throws IfwZend_Locale_Exception When the given locale is no locale or the autodetection fails
     * @return string
     */
    public static function findLocale($locale = null)
    {
        ...
        if ($locale === null) {
            $locale = new IfwZend_Locale();
        }

        if (!IfwZend_Locale::isLocale($locale, true, false)) {
            if (!IfwZend_Locale::isLocale($locale, false, false)) {
                $locale = IfwZend_Locale::getLocaleToTerritory($locale);

                if (empty($locale)) {
                    //require_once 'IfwZend/Locale/Exception.php';
                    throw new IfwZend_Locale_Exception("The locale '$locale' is no known locale");
                }
            } else {
                $locale = new IfwZend_Locale($locale);
            }
        }
    ...
    {
        //require_once 'IfwZend/Locale/Data.php';
        return IfwZend_Locale_Data::getCache();
    }

    /**
     * Sets a cache
     *
     * @param  IfwZend_Cache_Core $cache Cache to set
     * @return void
     */
    public static function setCache(IfwZend_Cache_Core $cache)
    {
        //require_once 'IfwZend/Locale/Data.php';
        IfwZend_Locale_Data::setCache($cache);
    }
    ...
    {
        //require_once 'IfwZend/Locale/Data.php';
        return IfwZend_Locale_Data::hasCache();
    }
    ...
    {
        //require_once 'IfwZend/Locale/Data.php';
        IfwZend_Locale_Data::removeCache();
    }
    ...
    {
        //require_once 'IfwZend/Locale/Data.php';
        IfwZend_Locale_Data::clearCache($tag);
    }
    ...
    {
        //require_once 'IfwZend/Locale/Data.php';
        IfwZend_Locale_Data::disableCache($flag);
    }

    /**
     * Internal function, returns a single locale on detection
     *
     * @param  string|IfwZend_Locale $locale (Optional) Locale to work on
     * @param  boolean            $strict (Optional) Strict preparation
     * @throws IfwZend_Locale_Exception When no locale is set which is only possible when the class was wrong extended
     * @return string
     */
    private static function _prepareLocale($locale, $strict = false)
    {
        ...
        // This can only happen when someone extends IfwZend_Locale and erases the default
        if ($locale === null) {
            //require_once 'IfwZend/Locale/Exception.php';
            throw new IfwZend_Locale_Exception('Autodetection of Locale has been failed!');
        }
