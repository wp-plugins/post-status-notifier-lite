 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Translate_Adapter_Gettext extends IfwZend_Translate_Adapter {
    // Internal variables
    ...
    protected function _loadTranslationData($filename, $locale, array $options = array())
    {
        ...
        if (!$this->_file) {
            ...
            throw new IfwZend_Translate_Exception('Error opening translation file \'' . $filename . '\'.');
        }
        if (@filesize($filename) < 10) {
            @fclose($this->_file);
            //require_once 'IfwZend/Translate/Exception.php';
            throw new IfwZend_Translate_Exception('\'' . $filename . '\' is not a gettext file');
        }
