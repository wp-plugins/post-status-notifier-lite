 ...
 */
//require_once 'IfwZend/View/Abstract.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View extends IfwZend_View_Abstract
{
    /**
     ...
     * Constructor
     *
     * Register IfwZend_View_Stream stream wrapper if short tags are disabled.
     *
     * @param  array $config
     * @return void
     */
    public function __construct($config = array())
    {
        ...
        if ($this->_useViewStream) {
            if (!in_array('zend.view', stream_get_wrappers())) {
                //require_once 'IfwZend/View/Stream.php';
                stream_wrapper_register('zend.view', 'IfwZend_View_Stream');
            }
        }
