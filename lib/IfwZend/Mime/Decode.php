...
class IfwZend_Mime_Decode
{
     ...
     * @throws IfwZend_Exception
     */
    public static function splitMessageStruct($message, $boundary, $EOL = IfwZend_Mime::LINEEND)
    {
     ...
     * @return null
     */
    public static function splitMessage($message, &$headers, &$body, $EOL = IfwZend_Mime::LINEEND)
    {
    ...
    public static function splitHeaderField($field, $wantedPart = null, $firstName = 0)
    {
        ...
        if (!preg_match_all('%([^=\s]+)\s*=\s*("[^"]+"|[^;]+)(;\s*|$)%', $field, $matches)) {
            throw new IfwZend_Exception('not a valid header field');
        }
