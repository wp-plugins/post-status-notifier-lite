...
/** @see IfwZend_Validate_Interface */
//require_once 'IfwZend/Validate/Interface.php';
 ...
 * @version    $Id$
 */
class IfwZend_Form implements Iterator, Countable, IfwZend_Validate_Interface
{
    /**#@+
     ...
     * @var string
     */
    protected $_defaultDisplayGroupClass = 'IfwZend_Form_DisplayGroup';
    ...
    public function setOptions(array $options)
    {
        ...
        foreach ($options as $key => $value) {
            ...
            if (method_exists($this, $method)) {
                if($normalized == 'View' && !($value instanceof IfwZend_View_Interface)) {
                    continue;
                }
                $this->$method($value);
            } else {
     ...
     * @return IfwZend_Form
     */
    public function setConfig(IfwZend_Config $config)
    {
     ...
     *
     * @param  IfwZend_Loader_PluginLoader_Interface $loader
     * @param  string $type 'decorator' or 'element'
     * @return IfwZend_Form
     * @throws IfwZend_Form_Exception on invalid type
     */
    public function setPluginLoader(IfwZend_Loader_PluginLoader_Interface $loader, $type = null)
    {
        ...
        switch ($type) {
            ...
            case self::ELEMENT:
                ...
                return $this;
            default:
                //require_once 'IfwZend/Form/Exception.php';
                throw new IfwZend_Form_Exception(sprintf('Invalid type "%s" provided to setPluginLoader()', $type));
        }
    }
     ...
     *
     * @param  string $type
     * @return IfwZend_Loader_PluginLoader_Interface
     */
    public function getPluginLoader($type = null)
    {
        ...
        if (!isset($this->_loaders[$type])) {
            switch ($type) {
                ...
                default:
                    //require_once 'IfwZend/Form/Exception.php';
                    throw new IfwZend_Form_Exception(sprintf('Invalid type "%s" provided to getPluginLoader()', $type));
            }

            //require_once 'IfwZend/Loader/PluginLoader.php';
            $this->_loaders[$type] = new IfwZend_Loader_PluginLoader(
                array('IfwZend_' . $prefixSegment . '_' => 'IfwZend/' . $pathSegment . '/')
            );
        }
     ...
     * @param  string $type
     * @return IfwZend_Form
     * @throws IfwZend_Form_Exception for invalid type
     */
    ...
    public function setMethod($method)
    {
        ...
        if (!in_array($method, $this->_methods)) {
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception(sprintf('"%s" is an invalid form method', $method));
        }
    ...
    public function setName($name)
    {
        ...
        if ('' === (string)$name) {
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception('Invalid name provided; must contain only valid variable characters and be non-empty');
        }
     ...
     * IfwZend_Form_Element. If a string element type is provided, $name must be
     * provided, and $options may be optionally provided for configuring the
     * element.
     *
     * If a IfwZend_Form_Element is provided, $name may be optionally provided,
     * and any provided $options will be ignored.
     *
     * @param  string|IfwZend_Form_Element $element
     * @param  string $name
     * @param  array|IfwZend_Config $options
     * @throws IfwZend_Form_Exception on invalid element
     * @return IfwZend_Form
     */
    public function addElement($element, $name = null, $options = null)
    {
        if (is_string($element)) {
            if (null === $name) {
                //require_once 'IfwZend/Form/Exception.php';
                throw new IfwZend_Form_Exception('Elements specified by string must have an accompanying name');
            }
        ...
        } elseif ($element instanceof IfwZend_Form_Element) {
            $prefixPaths              = array();
            ...
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception('Element must be specified by string or IfwZend_Form_Element instance');
        }
     ...
     * @param  string $name
     * @param  array|IfwZend_Config $options
     * @return IfwZend_Form_Element
     */
    public function createElement($type, $name, $options = null)
    {
        if (!is_string($type)) {
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception('Element type must be a string indicating type');
        }

        if (!is_string($name)) {
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception('Element name must be a string');
        }
    ...
    public function addElements(array $elements)
    {
        foreach ($elements as $key => $spec) {
            ...
            if (is_string($spec) || ($spec instanceof IfwZend_Form_Element)) {
     ...
     *
     * @param  string $name
     * @return IfwZend_Form_Element|null
     */
     ...
     *
     * @param  IfwZend_Form $form
     * @param  string $name
     * @param  int $order
     * @return IfwZend_Form
     */
    public function addSubForm(IfwZend_Form $form, $name, $order = null)
    {
        $name = (string) $name;
    ...
    public function addSubForms(array $subForms)
    {
        foreach ($subForms as $key => $spec) {          
            $name= (string) $key;
            if ($spec instanceof IfwZend_Form) {
     ...
     * @param  array|IfwZend_Config $options
     * @return IfwZend_Form
     * @throws IfwZend_Form_Exception if no valid elements provided
     */
    public function addDisplayGroup(array $elements, $name, $options = null)
    {
        ...
        if (empty($group)) {
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception('No valid elements specified for display group');
        }
        ...
        if (!class_exists($class)) {
            ...
            Ifw_Zend_Loader::loadClass($class);
        }
     ...
     *
     * @param  IfwZend_Form_DisplayGroup $group
     * @param  string|null $name
     * @return IfwZend_Form
     */
    protected function _addDisplayGroupObject(IfwZend_Form_DisplayGroup $group, $name = null)
    {
        if (null === $name) {
            $name = $group->getName();
            if ('' === (string)$name) {
                //require_once 'IfwZend/Form/Exception.php';
                throw new IfwZend_Form_Exception('Invalid display group added; requires name');
            }
        }
    ...
    public function addDisplayGroups(array $groups)
    {
        foreach ($groups as $key => $spec) {
            ...
            if ($spec instanceof IfwZend_Form_DisplayGroup) {
     ...
     *
     * @param  string $name
     * @return IfwZend_Form_DisplayGroup|null
     */
    ...
    public function getElementsAndSubFormsOrdered()
    {
        ...
        foreach ($this->_order as $name => $order) {
            ...
            if ($this->$name instanceof IfwZend_Form_Element ||
                $this->$name instanceof IfwZend_Form) {
                array_splice($ordered, $order, 0, array($this->$name));
            } else if ($this->$name instanceof IfwZend_Form_DisplayGroup) {
                $subordered = array();
    ...
    public function isValid($data)
    {
        if (!is_array($data)) {
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception(__METHOD__ . ' expects an array');
        }
    ...
    public function processAjax(array $data)
    {
        ...
        if ($this->isValidPartial($data)) {
            return IfwZend_Json::encode(true);
        }
        $messages = $this->getMessages();
        return IfwZend_Json::encode($messages);
    }
     ...
     * Set view object
     *
     * @param  IfwZend_View_Interface $view
     * @return IfwZend_Form
     */
    public function setView(IfwZend_View_Interface $view = null)
    {
        $this->_view = $view;
        return $this;
    }
     ...
     *
     * @return IfwZend_View_Interface|null
     */
    public function getView()
    {
        if (null === $this->_view) {
            //require_once 'IfwZend/Controller/Action/HelperBroker.php';
            $viewRenderer = IfwZend_Controller_Action_HelperBroker::getStaticHelper('viewRenderer');
     ...
     * @return IfwZend_Form_Decorator_Interface
     */
     ...
     *
     * @param  string|IfwZend_Form_Decorator_Interface $decorator
     * @param  array|IfwZend_Config $options Options with which to initialize decorator
     * @return IfwZend_Form
     */
    public function addDecorator($decorator, $options = null)
    {
        if ($decorator instanceof IfwZend_Form_Decorator_Interface) {
            ...
            if (is_numeric($name)) {
                //require_once 'IfwZend/Form/Exception.php';
                throw new IfwZend_Form_Exception('Invalid alias provided to addDecorator; must be alphanumeric string');
            }
            if (is_string($spec)) {
                $decorator = array(
                    'decorator' => $spec,
            ...
            } elseif ($spec instanceof IfwZend_Form_Decorator_Interface) {
                $decorator = $spec;
            }
        } else {
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception('Invalid decorator provided to addDecorator; must be string or IfwZend_Form_Decorator_Interface');
        }
    ...
    public function addDecorators(array $decorators)
    {
        foreach ($decorators as $decoratorName => $decoratorInfo) {
            if (is_string($decoratorInfo) ||
                $decoratorInfo instanceof IfwZend_Form_Decorator_Interface) {
                ...
                //require_once 'IfwZend/Form/Exception.php';
                throw new IfwZend_Form_Exception('Invalid decorator passed to addDecorators()');
            }
        }
     ...
     *
     * @param  string $name
     * @return false|IfwZend_Form_Decorator_Abstract
     */
     ...
     * @return string
     */
    public function render(IfwZend_View_Interface $view = null)
    {
        if (null !== $view) {
            $this->setView($view);
        }
     ...
     *
     * @param  IfwZend_Translate|IfwZend_Translate_Adapter|null $translator
     * @return IfwZend_Form
     */
    public function setTranslator($translator = null)
    {
        ...
        } elseif ($translator instanceof IfwZend_Translate_Adapter) {
            $this->_translator = $translator;
        } elseif ($translator instanceof IfwZend_Translate) {
            $this->_translator = $translator->getAdapter();
        } else {
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception('Invalid translator specified');
        }
    ...
    public static function getDefaultTranslator()
    {
        if (null === self::$_translatorDefault) {
            ...
            if (IfwZend_Registry::isRegistered('IfwZend_Translate')) {
                $translator = IfwZend_Registry::get('IfwZend_Translate');
                if ($translator instanceof IfwZend_Translate_Adapter) {
                    return $translator;
                } elseif ($translator instanceof IfwZend_Translate) {
     ...
     *
     * @param  string $name
     * @return IfwZend_Form_Element|IfwZend_Form|null
     */
     ...
     *
     * @param  string $name
     * @param  IfwZend_Form_Element|IfwZend_Form $value
     * @return void
     * @throws IfwZend_Form_Exception for invalid $value
     */
    public function __set($name, $value)
    {
        if ($value instanceof IfwZend_Form_Element) {
            $this->addElement($value, $name);
            return;
        } elseif ($value instanceof IfwZend_Form) {
        ...
        throw new IfwZend_Form_Exception('Only form elements and groups may be overloaded; variable of type "' . $type . '" provided');
    }
     ...
     * @param  array $args
     * @return string
     * @throws IfwZend_Form_Exception for invalid decorator or invalid method call
     */
    public function __call($method, $args)
    {
        if ('render' == substr($method, 0, 6)) {
            ...
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception(sprintf('Decorator by name %s does not exist', $decoratorName));
        }

        //require_once 'IfwZend/Form/Exception.php';
        throw new IfwZend_Form_Exception(sprintf('Method %s does not exist', $method));
    }
     ...
     *
     * @return IfwZend_Form_Element|IfwZend_Form_DisplayGroup|IfwZend_Form
     */
    public function current()
    {
        ...
        if (isset($this->_elements[$key])) {
            ...
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception(sprintf('Corruption detected in form; invalid key ("%s") found in internal iterator', (string) $key));
        }
    }
