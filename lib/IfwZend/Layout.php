 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Layout
{
    /**
     * Placeholder container for layout variables
     * @var IfwZend_View_Helper_Placeholder_Container
     */
     ...
     * @var string
     */
    protected $_helperClass = 'IfwZend_Layout_Controller_Action_Helper_Layout';

    /**
     * Inflector used to resolve layout script
     * @var IfwZend_Filter_Inflector
     */
     ...
     * @var string
     */
    protected $_pluginClass = 'IfwZend_Layout_Controller_Plugin_Layout';
     ...
     * - An array of options
     * - A IfwZend_Config object with options
     *
     ...
     * plugin.
     *
     * @param  string|array|IfwZend_Config $options
     * @return void
     */
    public function __construct($options = null, $initMvc = false)
    {
        if (null !== $options) {
            if (is_string($options)) {
                ...
                throw new IfwZend_Layout_Exception('Invalid option provided to constructor');
            }
        }
    ...
    public static function startMvc($options = null)
    {
        ...
        } elseif (is_array($options) || $options instanceof IfwZend_Config) {
    ...
    /**
     * Retrieve MVC instance of IfwZend_Layout object
     *
     * @return IfwZend_Layout|null
     */
    ...
    public static function resetMvcInstance()
    {
        if (null !== self::$_mvcInstance) {
            ...
            if (IfwZend_Controller_Action_HelperBroker::hasHelper('layout')) {
                IfwZend_Controller_Action_HelperBroker::removeHelper('layout');
            }
    ...
    public function setOptions($options)
    {
        if ($options instanceof IfwZend_Config) {
            ...
            //require_once 'IfwZend/Layout/Exception.php';
            throw new IfwZend_Layout_Exception('setOptions() expects either an array or a IfwZend_Config object');
        }
    ...
    protected function _initPlugin()
    {
        ...
        if (!$front->hasPlugin($pluginClass)) {
            if (!class_exists($pluginClass)) {
                ...
                Ifw_Zend_Loader::loadClass($pluginClass);
            }
    ...
    protected function _initHelper()
    {
        ...
        if (!IfwZend_Controller_Action_HelperBroker::hasHelper('layout')) {
            if (!class_exists($helperClass)) {
                //require_once 'IfwZend/Loader.php';
                Ifw_Zend_Loader::loadClass($helperClass);
            }
            IfwZend_Controller_Action_HelperBroker::getStack()->offsetSet(-90, new $helperClass($this));
        }
    }
     ...
     *
     * @return IfwZend_View_Helper_Placeholder_Container
     */
    protected function _initVarContainer()
    {
        if (null === $this->_container) {
            //require_once 'IfwZend/View/Helper/Placeholder/Registry.php';
            $this->_container = IfwZend_View_Helper_Placeholder_Registry::getRegistry()->getContainer(__CLASS__);
        }
     ...
     * @return IfwZend_Layout
     */
    public function setView(IfwZend_View_Interface $view)
    {
        $this->_view = $view;
        return $this;
    }
     ...
     *
     * @param  IfwZend_Filter_Inflector $inflector
     * @return IfwZend_Layout
     */
    public function setInflector(IfwZend_Filter_Inflector $inflector)
    {
     ...
     * Retrieve inflector
     *
     * @return IfwZend_Filter_Inflector
     */
    public function getInflector()
    {
        if (null === $this->_inflector) {
            //require_once 'IfwZend/Filter/Inflector.php';
            $inflector = new IfwZend_Filter_Inflector();
     ...
     * @return IfwZend_Layout
     * @throws IfwZend_Layout_Exception if non-array/string value passed to $spec
     */
    public function assign($spec, $value = null)
    {
        ...
        //require_once 'IfwZend/Layout/Exception.php';
        throw new IfwZend_Layout_Exception('Invalid values passed to assign()');
    }
