 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Filter_RealPath implements IfwZend_Filter_Interface
{
    /**
     ...
     * Class constructor
     *
     * @param boolean|IfwZend_Config $options Options to set
     */
     ...
     *
     * @param boolean|IfwZend_Config $exists Path must exist
     * @return IfwZend_Filter_RealPath
     */
    public function setExists($exists)
    {
        if ($exists instanceof IfwZend_Config) {
