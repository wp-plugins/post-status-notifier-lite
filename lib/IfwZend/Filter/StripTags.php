 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Filter_StripTags implements IfwZend_Filter_Interface
{
    /**
     * Unique ID prefix used for allowing comments
     */
    const UNIQUE_ID_PREFIX = '__IfwZend_Filter_StripTags__';
     ...
     * @return IfwZend_Filter_StripTags Provides a fluent interface
     */
