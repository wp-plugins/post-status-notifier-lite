 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Filter_PregReplace implements IfwZend_Filter_Interface
{
    /**
     * Pattern to match
     * @var mixed
     ...
     * @return IfwZend_Filter_PregReplace
     */
    ...
    public function filter($value)
    {
        if ($this->_matchPattern == null) {
            ...
            throw new IfwZend_Filter_Exception(get_class($this) . ' does not have a valid MatchPattern set.');
        }
