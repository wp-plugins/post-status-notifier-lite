 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Filter_StringToLower implements IfwZend_Filter_Interface
{
    /**
     ...
     * @return IfwZend_Filter_StringToLower Provides a fluent interface
    ...
    public function setEncoding($encoding = null)
    {
        if ($encoding !== null) {
            if (!function_exists('mb_strtolower')) {
                ...
                throw new IfwZend_Filter_Exception('mbstring is required for this feature');
            }

            $encoding = (string) $encoding;
            if (!in_array(strtolower($encoding), array_map('strtolower', mb_list_encodings()))) {
                //require_once 'IfwZend/Filter/Exception.php';
                throw new IfwZend_Filter_Exception("The given encoding '$encoding' is not supported by mbstring");
            }
        }
