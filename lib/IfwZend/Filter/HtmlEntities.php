 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Filter_HtmlEntities implements IfwZend_Filter_Interface
{
    /**
     ...
     * @return IfwZend_Filter_HtmlEntities Provides a fluent interface
     */
     ...
     *
     * @param  string $value
     * @return IfwZend_Filter_HtmlEntities
     */
    ...
    public function filter($value)
    {
        ...
        if (strlen((string) $value) && !strlen($filtered)) {
            if (!function_exists('iconv')) {
                ...
                throw new IfwZend_Filter_Exception('Encoding mismatch has resulted in htmlentities errors');
            }
