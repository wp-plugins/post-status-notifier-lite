 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Filter_Callback implements IfwZend_Filter_Interface
{
    /**
    ...
    public function __construct($options)
    {
        ...
        if (!array_key_exists('callback', $options)) {
            ...
            throw new IfwZend_Filter_Exception('Missing callback to use');
        }
     ...
     * @return IfwZend_Filter_Callback
     */
