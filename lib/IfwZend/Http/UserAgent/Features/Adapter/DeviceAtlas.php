 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Http_UserAgent_Features_Adapter_DeviceAtlas implements IfwZend_Http_UserAgent_Features_Adapter
{
    /**
    ...
    public static function getFromRequest($request, array $config)
    {
        if (!class_exists('Mobi_Mtld_DA_Api')) {
            if (!isset($config['deviceatlas'])) {
                ...
                throw new IfwZend_Http_UserAgent_Features_Exception('"DeviceAtlas" configuration is not defined');
            }
        }
        ...
        if (!class_exists('Mobi_Mtld_DA_Api')) {
            if (empty($config['deviceatlas_lib_dir'])) {
                //require_once 'IfwZend/Http/UserAgent/Features/Exception.php';
                throw new IfwZend_Http_UserAgent_Features_Exception('The "deviceatlas_lib_dir" parameter is not defined');
            }
        ...
        if (empty($config['deviceatlas_data'])) {
            //require_once 'IfwZend/Http/UserAgent/Features/Exception.php';
            throw new IfwZend_Http_UserAgent_Features_Exception('The "deviceatlas_data" parameter is not defined');
        }
