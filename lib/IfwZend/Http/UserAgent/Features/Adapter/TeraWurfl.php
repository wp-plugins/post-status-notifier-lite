 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Http_UserAgent_Features_Adapter_TeraWurfl implements IfwZend_Http_UserAgent_Features_Adapter
{
    /**
    ...
    public static function getFromRequest($request, array $config)
    {
        if (!class_exists('TeraWurfl')) {
            ...
            if (!isset($config['terawurfl'])) {
                ...
                throw new IfwZend_Http_UserAgent_Features_Exception('"TeraWurfl" configuration is not defined');
            }
            ...
            $config = $config['terawurfl'];
             ...
             if (empty($config['terawurfl_lib_dir'])) {
                // No lib_dir given
                //require_once 'IfwZend/Http/UserAgent/Features/Exception.php';
                throw new IfwZend_Http_UserAgent_Features_Exception('The "terawurfl_lib_dir" parameter is not defined');
            }
