...
//require_once 'IfwZend/Http/UserAgent/Device.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwZend_Http_UserAgent_AbstractDevice
    implements IfwZend_Http_UserAgent_Device
{
    /**
     * Browser signature
     *
     ...
     * @return IfwZend_Http_UserAgent_AbstractDevice
     */
    ...
    protected function _loadFeaturesAdapter()
    {
        ...
        if (empty($config['classname'])) {
            ...
            throw new IfwZend_Http_UserAgent_Exception('The ' . $this->getType() . ' features adapter must have a "classname" config parameter defined');
        }
        ...
        if (!class_exists($className)) {
            if (isset($config['path'])) {
                ...
                //require_once 'IfwZend/Http/UserAgent/Exception.php';
                throw new IfwZend_Http_UserAgent_Exception('The ' . $this->getType() . ' features adapter must have a "path" config parameter defined');
            }

            if (false === include_once ($path)) {
                //require_once 'IfwZend/Http/UserAgent/Exception.php';
                throw new IfwZend_Http_UserAgent_Exception('The ' . $this->getType() . ' features adapter path that does not exist');
            }
        }
