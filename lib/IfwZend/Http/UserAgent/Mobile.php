...
//require_once 'IfwZend/Http/UserAgent/AbstractDevice.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Http_UserAgent_Mobile extends IfwZend_Http_UserAgent_AbstractDevice
{

    const DEFAULT_FEATURES_ADAPTER_CLASSNAME = 'IfwZend_Http_UserAgent_Features_Adapter_WurflApi';

    const DEFAULT_FEATURES_ADAPTER_PATH = 'IfwZend/Http/UserAgent/Features/Adapter/WurflApi.php';
