 ...
 *
 * @category   Zend
 * @package    IfwZend_Http_UserAgent
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Http_UserAgent implements Serializable
{
    /**
     ...
     * Identified device
     *
     * @var IfwZend_Http_UserAgent_Device
     */
    protected $_device;
     ...
     *
     * @var IfwZend_Http_UserAgent_Storage
     */
    protected $_storage;
     ...
     * Constructor
     *
     * @param  null|array|IfwZend_Config|ArrayAccess $options
     * @return void
     */
     ...
     * Configure instance
     *
     * @param  array|IfwZend_Config|ArrayAccess $options
    ...
    public function setOptions($options)
    {
        ...
        if (!is_array($options)
            ...
            //require_once 'IfwZend/Http/UserAgent/Exception.php';
            throw new IfwZend_Http_UserAgent_Exception(sprintf(
                'Invalid argument; expected array, IfwZend_Config object, or object implementing ArrayAccess and Traversable; received %s',
    ...
    protected function _match($deviceClass)
    {
        ...
        if (!$r->implementsInterface('IfwZend_Http_UserAgent_Device')) {
            throw new IfwZend_Http_UserAgent_Exception(sprintf(
                'Invalid device class provided ("%s"); must implement IfwZend_Http_UserAgent_Device',
                $deviceClass
            ));
        }
     ...
     * @return string
     * @throws IfwZend_Loader_PluginLoader_Exception if unable to load UA device
     */
    protected function _getUserAgentDevice($browserType)
    {
        ...
        if (isset($this->_config[$browserType])
            ...
            if (is_array($deviceConfig) && isset($deviceConfig['classname'])) {
                ...
                $prefix = isset($deviceConfig['prefix']) ? $deviceConfig['prefix'] : 'IfwZend_Http_UserAgent';
     ...
     * @return IfwZend_Http_UserAgent_Storage
     */
     ...
     *
     * @param  IfwZend_Http_UserAgent_Storage $storage
     * @return IfwZend_Http_UserAgent
     */
    public function setStorage(IfwZend_Http_UserAgent_Storage $storage)
    {
        if ($this->_immutable) {
            //require_once 'IfwZend/Http/UserAgent/Exception.php';
            throw new IfwZend_Http_UserAgent_Exception(
    ...
    /**
     * Config parameters is an Array or a IfwZend_Config object
     *
     ...
     * capabilities.
     *
     * @return IfwZend_Http_UserAgent_Device $device
     */
    public function getDevice()
    {
        ...
        if (!$storage->isEmpty()) {
            ...
            // IfwZend_Http_UserAgent object is serialized in the session
            $object = $storage->read();
     ...
     * @return void
     * @throws IfwZend_Http_UserAgent_Exception on invalid parameter
     */
     ...
     * @param  string|IfwZend_Loader_PluginLoader $loader
     * @return IfwZend_Http_UserAgent
     */
    public function setPluginLoader($type, $loader)
    {
        ...
        if (is_string($loader)) {
            if (!class_exists($loader)) {
                ...
                Ifw_Zend_Loader::loadClass($loader);
            }
            $loader = new $loader();
        ...
        if (!$loader instanceof IfwZend_Loader_PluginLoader) {
            //require_once 'IfwZend/Http/UserAgent/Exception.php';
            throw new IfwZend_Http_UserAgent_Exception(sprintf(
                'Expected an object extending IfwZend_Loader_PluginLoader; received %s',
                get_class($loader)
            ));
        }

        $basePrefix = 'IfwZend_Http_UserAgent_';
        $basePath   = 'IfwZend/Http/UserAgent/';
        switch ($type) {
            case 'storage':
    ...
    public function getPluginLoader($type)
    {
        ...
        if (!isset($this->_loaders[$type])) {
            ...
            $this->setPluginLoader($type, new IfwZend_Loader_PluginLoader());
        }
     ...
     * @param  string $type
     * @return string
     * @throws IfwZend_Http_UserAgent_Exception on invalid type
     */
     ...
     * user agent
     *
     * @return IfwZend_Http_UserAgent_Result
     */
