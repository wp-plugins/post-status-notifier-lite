 ...
 * @see IfwZend_Uri
 */
//require_once 'IfwZend/Uri.php';


/**
 * @see IfwZend_Http_Client_Adapter_Interface
 */
//require_once 'IfwZend/Http/Client/Adapter/Interface.php';


/**
 * @see IfwZend_Http_Response
 */
//require_once 'IfwZend/Http/Response.php';

/**
 * @see IfwZend_Http_Response_Stream
 */
//require_once 'IfwZend/Http/Response/Stream.php';

/**
 * IfwZend_Http_Client is an implementation of an HTTP client in PHP. The client
 * supports basic features like sending different HTTP requests and handling
 * redirections, as well as more advanced features like proxy settings, HTTP
 * authentication and cookie persistence (using a IfwZend_Http_CookieJar object)
 *
 * @todo Implement proxy settings
 * @category   Zend
 * @package    IfwZend_Http
 * @subpackage Client
 * @throws     IfwZend_Http_Client_Exception
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Http_Client
{
    /**
    ...
    protected $config = array(
        ...
        'useragent'       => 'IfwZend_Http_Client',
        'timeout'         => 10,
        'adapter'         => 'IfwZend_Http_Client_Adapter_Socket',
     ...
     *
     * @var IfwZend_Http_Client_Adapter_Interface
     */
     ...
     *
     * @param IfwZend_Uri_Http|string $uri
     ...
     *
     * @param  IfwZend_Uri_Http|string $uri
     * @return IfwZend_Http_Client
     * @throws IfwZend_Http_Client_Exception
     */
    public function setUri($uri)
    {
        if ($uri instanceof IfwZend_Uri_Http) {
            // clone the URI in order to keep the passed parameter constant
            $uri = clone $uri;
        } elseif (is_string($uri)) {
            $uri = IfwZend_Uri::factory($uri);
        }

        if (!$uri instanceof IfwZend_Uri_Http) {
            /** @see IfwZend_Http_Client_Exception */
            //require_once 'IfwZend/Http/Client/Exception.php';
            throw new IfwZend_Http_Client_Exception('Passed parameter is not a valid HTTP URI.');
        }
     ...
     * @return IfwZend_Uri_Http|string
     */
    public function getUri($as_string = false)
    {
        if ($as_string && $this->uri instanceof IfwZend_Uri_Http) {
     ...
     *
     * @param  IfwZend_Config | array $config
     * @return IfwZend_Http_Client
     * @throws IfwZend_Http_Client_Exception
     */
    public function setConfig($config = array())
    {
        if ($config instanceof IfwZend_Config) {
            ...
            /** @see IfwZend_Http_Client_Exception */
            //require_once 'IfwZend/Http/Client/Exception.php';
            throw new IfwZend_Http_Client_Exception('Array or IfwZend_Config object expected, got ' . gettype($config));
        }
        ...
        if ($this->adapter instanceof IfwZend_Http_Client_Adapter_Interface) {
    ...
    public function setMethod($method = self::GET)
    {
        if (! preg_match('/^[^\x00-\x1f\x7f-\xff\(\)<>@,;:\\\\"\/\[\]\?={}\s]+$/', $method)) {
            /** @see IfwZend_Http_Client_Exception */
            //require_once 'IfwZend/Http/Client/Exception.php';
            throw new IfwZend_Http_Client_Exception("'{$method}' is not a valid HTTP request method.");
        }
    ...
    public function setHeaders($name, $value = null)
    {
        ...
        if (is_array($name)) {
            ...
            if ($this->config['strict'] && (! preg_match('/^[a-zA-Z0-9-]+$/', $name))) {
                /** @see IfwZend_Http_Client_Exception */
                //require_once 'IfwZend/Http/Client/Exception.php';
                throw new IfwZend_Http_Client_Exception("{$name} is not a valid HTTP header name");
            }
     ...
     * <code>
     * $this->setAuth('shahar', 'secret', IfwZend_Http_Client::AUTH_BASIC);
     * </code>
     *
    ...
    public function setAuth($user, $password = '', $type = self::AUTH_BASIC)
    {
        ...
        if ($user === false || $user === null) {
            ...
            if ($this->uri instanceof IfwZend_Uri_Http) {
        ...
        // Else, set up authentication
            ...
            if (! defined('self::AUTH_' . strtoupper($type))) {
                /** @see IfwZend_Http_Client_Exception */
                //require_once 'IfwZend/Http/Client/Exception.php';
                throw new IfwZend_Http_Client_Exception("Invalid or not supported authentication type: '$type'");
            }
     ...
     * and responses.
     *
     * @param IfwZend_Http_CookieJar|boolean $cookiejar Existing cookiejar object, true to create a new one, false to disable
     * @return IfwZend_Http_Client
     * @throws IfwZend_Http_Client_Exception
     */
    public function setCookieJar($cookiejar = true)
    {
        Ifw_Zend_Loader::loadClass('IfwZend_Http_CookieJar');

        if ($cookiejar instanceof IfwZend_Http_CookieJar) {
            $this->cookiejar = $cookiejar;
        } elseif ($cookiejar === true) {
            $this->cookiejar = new IfwZend_Http_CookieJar();
        } elseif (! $cookiejar) {
            $this->cookiejar = null;
        } else {
            /** @see IfwZend_Http_Client_Exception */
            //require_once 'IfwZend/Http/Client/Exception.php';
            throw new IfwZend_Http_Client_Exception('Invalid parameter type passed as CookieJar');
        }
     ...
     *
     * @return IfwZend_Http_CookieJar|null
     */
     ...
     *
     * @param IfwZend_Http_Cookie|string $cookie
    ...
    {
        Ifw_Zend_Loader::loadClass('IfwZend_Http_Cookie');
        ...
        if (isset($this->cookiejar)) {
            if ($cookie instanceof IfwZend_Http_Cookie) {
                $this->cookiejar->addCookie($cookie);
            } elseif (is_string($cookie) && $value !== null) {
                $cookie = IfwZend_Http_Cookie::fromString("{$cookie}={$value}",
                                                       $this->uri,
            ...
            if (preg_match("/[=,; \t\r\n\013\014]/", $cookie)) {
                /** @see IfwZend_Http_Client_Exception */
                //require_once 'IfwZend/Http/Client/Exception.php';
                throw new IfwZend_Http_Client_Exception("Cookie name cannot contain these characters: =,; \t\r\n\013\014 ({$cookie})");
            }
    ...
    public function setFileUpload($filename, $formname, $data = null, $ctype = null)
    {
        if ($data === null) {
            if (($data = @file_get_contents($filename)) === false) {
                /** @see IfwZend_Http_Client_Exception */
                //require_once 'IfwZend/Http/Client/Exception.php';
                throw new IfwZend_Http_Client_Exception("Unable to read file '{$filename}' for upload");
            }
     ...
     *
     * @return IfwZend_Http_Response or null if none
     */
     ...
     *
     * @param IfwZend_Http_Client_Adapter_Interface|string $adapter
     * @return null
     * @throws IfwZend_Http_Client_Exception
     */
    public function setAdapter($adapter)
    {
        if (is_string($adapter)) {
            try {
                ...
                /** @see IfwZend_Http_Client_Exception */
                //require_once 'IfwZend/Http/Client/Exception.php';
                throw new IfwZend_Http_Client_Exception("Unable to load adapter '$adapter': {$e->getMessage()}", 0, $e);
            }

            $adapter = new $adapter;
        }

        if (! $adapter instanceof IfwZend_Http_Client_Adapter_Interface) {
            /** @see IfwZend_Http_Client_Exception */
            //require_once 'IfwZend/Http/Client/Exception.php';
            throw new IfwZend_Http_Client_Exception('Passed adapter is not a HTTP connection adapter');
        }
     ...
     * Load the connection adapter
     *
     * @return IfwZend_Http_Client_Adapter_Interface $adapter
     */
    ...
    protected function _openTempStream()
    {
        ...
        if (false === ($fp = @fopen($this->_stream_name, "w+b"))) {
                ...
                //require_once 'IfwZend/Http/Client/Exception.php';
                throw new IfwZend_Http_Client_Exception("Could not open temp file {$this->_stream_name}");
        }
    ...
    public function request($method = null)
    {
        if (! $this->uri instanceof IfwZend_Uri_Http) {
            /** @see IfwZend_Http_Client_Exception */
            //require_once 'IfwZend/Http/Client/Exception.php';
            throw new IfwZend_Http_Client_Exception('No valid URI has been passed to the client');
        }
        ...
        do {
            ...
            if(is_resource($body) && !($this->adapter instanceof IfwZend_Http_Client_Adapter_Stream)) {
                /** @see IfwZend_Http_Client_Exception */
                //require_once 'IfwZend/Http/Client/Exception.php';
                throw new IfwZend_Http_Client_Exception('Adapter does not support streaming');
            }
            ...
            if($this->config['output_stream']) {
                if($this->adapter instanceof IfwZend_Http_Client_Adapter_Stream) {
            ...
            if (! $response) {
                /** @see IfwZend_Http_Client_Exception */
                //require_once 'IfwZend/Http/Client/Exception.php';
                throw new IfwZend_Http_Client_Exception('Unable to read response, or response is empty');
            }
            ...
            if($this->config['output_stream']) {
                ...
                $response = IfwZend_Http_Response_Stream::fromStream($response, $stream);
                ...
                $response = IfwZend_Http_Response::fromString($response);
            }
    ...
    protected function _prepareHeaders()
    {
        ...
        if (isset($this->cookiejar)) {
            $cookstr = $this->cookiejar->getMatchingCookies($this->uri,
                true, IfwZend_Http_CookieJar::COOKIE_STRING_CONCAT);
        ...
        if (count($this->paramsPost) > 0 || count($this->files) > 0) {
            switch($this->enctype) {
                ...
                default:
                    ...
                    /** @see IfwZend_Http_Client_Exception */
                    //require_once 'IfwZend/Http/Client/Exception.php';
                    throw new IfwZend_Http_Client_Exception("Cannot handle content type '{$this->enctype}' automatically." .
                        " Please use IfwZend_Http_Client::setRawData to send this kind of content.");
                    break;
            }
        }
        ...
        switch ($type) {
            case self::AUTH_BASIC:
                ...
                if (strpos($user, ':') !== false) {
                    /** @see IfwZend_Http_Client_Exception */
                    //require_once 'IfwZend/Http/Client/Exception.php';
                    throw new IfwZend_Http_Client_Exception("The user name cannot contain ':' in 'Basic' HTTP authentication");
                }
            ...
            default:
                /** @see IfwZend_Http_Client_Exception */
                //require_once 'IfwZend/Http/Client/Exception.php';
                throw new IfwZend_Http_Client_Exception("Not a supported HTTP authentication type: '$type'");
        }
