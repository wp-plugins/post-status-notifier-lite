...
/** @see IfwZend_Filter */
//require_once 'IfwZend/Filter.php';

/** @see IfwZend_Form */
//require_once 'IfwZend/Form.php';
 ...
 * @version    $Id$
 */
class IfwZend_Form_Element implements IfwZend_Validate_Interface
{
    /**
     * Element Constants
     */
     ...
     * - IfwZend_Config: IfwZend_Config with options for configuring element
     *
     * @param  string|array|IfwZend_Config $spec
     * @param  array|IfwZend_Config $options
     * @return void
     * @throws IfwZend_Form_Exception if no element name after initialization
     */
    public function __construct($spec, $options = null)
    {
        ...
        } elseif ($spec instanceof IfwZend_Config) {
            $this->setConfig($spec);
        }

        if (is_string($spec) && is_array($options)) {
            $this->setOptions($options);
        } elseif (is_string($spec) && ($options instanceof IfwZend_Config)) {
            $this->setConfig($options);
        }

        if (null === $this->getName()) {
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception('IfwZend_Form_Element requires each element to have a name');
        }
     ...
     * 
     * @param  IfwZend_Form_Decorator_Interface $decorator 
     * @return string
     */
    public static function resolveElementId(IfwZend_Form_Decorator_Interface $decorator)
    {
    ...
    /**
     * Set object state from IfwZend_Config object
     *
     ...
     *
     * @param  IfwZend_Translate|null $translator
     * @return IfwZend_Form_Element
     */
    ...
    public function getTranslator()
    {
        ...
        if (null === $this->_translator) {
            return IfwZend_Form::getDefaultTranslator();
        }
     ...
     * @param  mixed $value
     * @return IfwZend_Form_Element
     * @throws IfwZend_Form_Exception for invalid $name values
     */
    public function setAttrib($name, $value)
    {
        ...
        if ('_' == $name[0]) {
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception(sprintf('Invalid attribute "%s"; must not contain a leading underscore', $name));
        }
    ...
    public function __get($key)
    {
        if ('_' == $key[0]) {
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception(sprintf('Cannot retrieve value for protected/private property "%s"', $key));
        }
    ...
    public function __call($method, $args)
    {
        if ('render' == substr($method, 0, 6)) {
            ...
            //require_once 'IfwZend/Form/Element/Exception.php';
            throw new IfwZend_Form_Element_Exception(sprintf('Decorator by name %s does not exist', $decoratorName));
        }

        //require_once 'IfwZend/Form/Element/Exception.php';
        throw new IfwZend_Form_Element_Exception(sprintf('Method %s does not exist', $method));
    }
     ...
     */
    public function setPluginLoader(IfwZend_Loader_PluginLoader_Interface $loader, $type)
    {
     ...
     * @throws IfwZend_Loader_Exception on invalid type.
     */
     ...
     *
     * @param  string|IfwZend_Validate_Interface $validator
     * @param  bool $breakChainOnFailure
     * @param  array $options
     * @return IfwZend_Form_Element
     * @throws IfwZend_Form_Exception if invalid validator type
     */
    public function addValidator($validator, $breakChainOnFailure = false, $options = array())
    {
        if ($validator instanceof IfwZend_Validate_Interface) {
            ...
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception('Invalid validator provided to addValidator; must be string or IfwZend_Validate_Interface');
        }
    ...
    public function addValidators(array $validators)
    {
        foreach ($validators as $validatorInfo) {
            if (is_string($validatorInfo)) {
            ...
            } elseif ($validatorInfo instanceof IfwZend_Validate_Interface) {
                $this->addValidator($validatorInfo);
                ...
                //require_once 'IfwZend/Form/Exception.php';
                throw new IfwZend_Form_Exception('Invalid validator passed to addValidators()');
            }
        }
     ...
     *
     * @param  string $name
     * @return IfwZend_Validate_Interface|false False if not found, validator otherwise
     */
    ...
    public function getValidators()
    {
        ...
        foreach ($this->_validators as $key => $value) {
            if ($value instanceof IfwZend_Validate_Interface) {
    ...
    public function isValid($value, $context = null)
    {
        ...
        // Find the correct translator. IfwZend_Validate_Abstract::getDefaultTranslator()
        // will get either the static translator attached to IfwZend_Validate_Abstract
        // or the 'IfwZend_Translate' from IfwZend_Registry.
        if (IfwZend_Validate_Abstract::hasDefaultTranslator() &&
            !IfwZend_Form::hasDefaultTranslator())
        {
            $translator = IfwZend_Validate_Abstract::getDefaultTranslator();
     ...
     *
     * @param  string|IfwZend_Filter_Interface $filter
     * @return IfwZend_Form_Element
     */
    public function addFilter($filter, $options = array())
    {
        if ($filter instanceof IfwZend_Filter_Interface) {
            ...
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception('Invalid filter provided to addFilter; must be string or IfwZend_Filter_Interface');
        }
    ...
    public function addFilters(array $filters)
    {
        foreach ($filters as $filterInfo) {
            if (is_string($filterInfo)) {
            ...
            } elseif ($filterInfo instanceof IfwZend_Filter_Interface) {
                $this->addFilter($filterInfo);
                ...
                //require_once 'IfwZend/Form/Exception.php';
                throw new IfwZend_Form_Exception('Invalid filter passed to addFilters()');
            }
        }
     ...
     *
     * @param  string $name
     * @return IfwZend_Filter_Interface
     */
    ...
    public function getFilters()
    {
        ...
        foreach ($this->_filters as $key => $value) {
            if ($value instanceof IfwZend_Filter_Interface) {
                $filters[$key] = $value;
                continue;
            }
     ...
     *
     * @return null|IfwZend_View_Interface
     */
    ...
    protected function _loadFilter(array $filter)
    {
        ...
        if (array_key_exists($name, $this->_filters)) {
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception(sprintf('Filter instance already exists for filter "%s"', $origName));
        }
     ...
     * @return IfwZend_Validate_Interface
     */
    protected function _loadValidator(array $validator)
    {
        ...
        if (array_key_exists($name, $this->_validators)) {
            //require_once 'IfwZend/Form/Exception.php';
            throw new IfwZend_Form_Exception(sprintf('Validator instance already exists for validator "%s"', $origName));
        }
