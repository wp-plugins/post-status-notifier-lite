...
/** @see IfwZend_Form_Element_Xhtml */
//require_once 'IfwZend/Form/Element/Xhtml.php';

/** @see IfwZend_Captcha_Adapter */
//require_once 'IfwZend/Captcha/Adapter.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Form_Element_Captcha extends IfwZend_Form_Element_Xhtml
{
    /**
     ...
     * Get captcha adapter
     *
     * @return IfwZend_Captcha_Adapter
     */
     ...
     * Set captcha adapter
     *
     * @param string|array|IfwZend_Captcha_Adapter $captcha
     * @param array $options
     */
    public function setCaptcha($captcha, $options = array())
    {
        if ($captcha instanceof IfwZend_Captcha_Adapter) {
            $instance = $captcha;
        } else {
            if (is_array($captcha)) {
     ...
     *
     * @param  array $options
     * @return IfwZend_Form_Element_Captcha
     */
    ...
    public function render(IfwZend_View_Interface $view = null)
    {
        ...
        if (!$this->loadDefaultDecoratorsIsDisabled()) {
            ...
            if ($captcha instanceof IfwZend_Captcha_Word && !array_key_exists($key, $decorators)) {
                array_unshift($decorators, $decorator);
            }
        ...
        if ($type == self::CAPTCHA) {
            if (!isset($this->_loaders[$type])) {
                ...
                $this->_loaders[$type] = new IfwZend_Loader_PluginLoader(
                    array('IfwZend_Captcha' => 'IfwZend/Captcha/')
                );
            }
     ...
     * @see IfwZend_Form_Element::addPrefixPath
     */
