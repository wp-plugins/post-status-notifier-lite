...
/** IfwZend_Form_Element_Xhtml */
//require_once 'IfwZend/Form/Element/Xhtml.php';
 ...
 * @version    $Id$
 */
class IfwZend_Form_Element_File extends IfwZend_Form_Element_Xhtml
{
    /**
     * Plugin loader type
     */
    ...
    /**
     * @var IfwZend_File_Transfer_Adapter_Abstract
     */
    protected $_adapter;
     ...
     *
     * @return IfwZend_Form_Element_File
     */
    ...
    public function getPluginLoader($type)
    {
        ...
        if (!array_key_exists($type, $this->_loaders)) {
            ...
            $loader = new IfwZend_Loader_PluginLoader(array(
                'IfwZend_File_Transfer_Adapter' => 'IfwZend/File/Transfer/Adapter/',
            ));
     ...
     *
     * @param  string|IfwZend_File_Transfer_Adapter_Abstract $adapter
     * @return IfwZend_Form_Element_File
     */
    public function setTransferAdapter($adapter)
    {
        if ($adapter instanceof IfwZend_File_Transfer_Adapter_Abstract) {
            ...
            throw new IfwZend_Form_Element_Exception('Invalid adapter specified');
        }
     ...
     *
     * @return IfwZend_File_Transfer_Adapter_Abstract
     */
     ...
     *
     * @param  string $name
     * @return IfwZend_Validate_Interface|null
     */
     ...
     *
     * @param  string $name
     * @return IfwZend_Filter_Interface|null
     */
     ...
     * @return IfwZend_Form_Element_File Provides fluent interface
     */
    ...
    public function render(IfwZend_View_Interface $view = null)
    {
        ...
        foreach ($this->getDecorators() as $decorator) {
            if ($decorator instanceof IfwZend_Form_Decorator_Marker_File_Interface) {
                $marker = true;
            }
        }
        ...
        if (!$marker) {
            //require_once 'IfwZend/Form/Element/Exception.php';
            throw new IfwZend_Form_Element_Exception('No file decorator found... unable to render file element');
        }
