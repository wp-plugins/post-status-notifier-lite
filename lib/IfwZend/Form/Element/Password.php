 ...
 * @version    $Id$
 */
class IfwZend_Form_Element_Password extends IfwZend_Form_Element_Xhtml
{
    /**
     ...
     * @param  bool $flag
     * @return IfwZend_Form_Element_Password
     */
    ...
    public function isValid($value, $context = null)
    {
        foreach ($this->getValidators() as $validator) {
            if ($validator instanceof IfwZend_Validate_Abstract) {
