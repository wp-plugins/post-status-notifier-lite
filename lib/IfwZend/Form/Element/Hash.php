 ...
 * @version    $Id$
 */
class IfwZend_Form_Element_Hash extends IfwZend_Form_Element_Xhtml
{
    /**
     ...
     * Set session object
     *
     * @param  IfwZend_Session_Namespace $session
     * @return IfwZend_Form_Element_Hash
     */
     ...
     *
     * @return IfwZend_Session_Namespace
     */
    public function getSession()
    {
        if (null === $this->_session) {
            //require_once 'IfwZend/Session/Namespace.php';
            $this->_session = new IfwZend_Session_Namespace($this->getSessionName());
        }
