 ...
 * @version    $Id$
 */
class IfwZend_Form_DisplayGroup implements Iterator,Countable
{
    /**
     * Group attributes
     * @var array
     ...
     * @var IfwZend_Loader_PluginLoader
     */
    protected $_loader;
     ...
     * @return void
     */
    public function __construct($name, IfwZend_Loader_PluginLoader $loader, $options = null)
    {
        $this->setName($name);
     ...
     *
     * @param  array $options
     * @return IfwZend_Form_DisplayGroup
     */
     ...
     * @return IfwZend_Form_DisplayGroup
     */
    public function setForm(IfwZend_Form $form)
    {
        $this->_form = $form;
     ...
     *
     * @param  IfwZend_Form_Element $element
     * @return IfwZend_Form_DisplayGroup
     */
    public function addElement(IfwZend_Form_Element $element)
    {
     ...
     * @return IfwZend_Form_DisplayGroup
     * @throws IfwZend_Form_Exception if any element is not a IfwZend_Form_Element
     */
    public function addElements(array $elements)
    {
        foreach ($elements as $element) {
            if (!$element instanceof IfwZend_Form_Element) {
                //require_once 'IfwZend/Form/Exception.php';
                throw new IfwZend_Form_Exception('elements passed via array to addElements() must be IfwZend_Form_Elements only');
            }
     ...
     * @return IfwZend_Form_DisplayGroup
     */
    public function setPluginLoader(IfwZend_Loader_PluginLoader $loader)
    {
        $this->_loader = $loader;
        return $this;
    }
