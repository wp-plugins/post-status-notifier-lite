...
//require_once 'IfwZend/Form/Decorator/FormElements.php';

/**
 * IfwZend_Form_Decorator_PrepareElements
 *
 ...
 * @version    $Id$
 */
class IfwZend_Form_Decorator_PrepareElements extends IfwZend_Form_Decorator_FormElements
{
    /**
    ...
    protected function _recursivelyPrepareForm(IfwZend_Form $form)
    {
