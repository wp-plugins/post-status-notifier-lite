...
/** IfwZend_Form_Decorator_Marker_File_Interface */
//require_once 'IfwZend/Form/Decorator/Marker/File/Interface.php';

/** IfwZend_File_Transfer_Adapter_Http */
//require_once 'IfwZend/File/Transfer/Adapter/Http.php';

/**
 * IfwZend_Form_Decorator_File
 *
 ...
 * @version    $Id$
 */
class IfwZend_Form_Decorator_File
    extends IfwZend_Form_Decorator_Abstract
    implements IfwZend_Form_Decorator_Marker_File_Interface
{
    /**
    ...
    public function render($content)
    {
        ...
        if (IfwZend_File_Transfer_Adapter_Http::isApcAvailable()) {
            $markup[] = $view->formHidden(ini_get('apc.rfc1867_name'), uniqid(), array('id' => 'progress_key'));
        } else if (IfwZend_File_Transfer_Adapter_Http::isUploadProgressAvailable()) {
