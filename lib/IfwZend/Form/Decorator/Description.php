...
/**
 * IfwZend_Form_Decorator_Description
 *
 * Accepts the options:
 ...
 * @version    $Id$
 */
class IfwZend_Form_Decorator_Description extends IfwZend_Form_Decorator_Abstract
{
    /**
     ...
     *
     * @param  string $tag
     * @return IfwZend_Form_Decorator_Description
     */
    ...
    public function render($content)
    {
        ...
        if (!empty($tag)) {
            ...
            $options['tag'] = $tag;
            $decorator = new IfwZend_Form_Decorator_HtmlTag($options);
