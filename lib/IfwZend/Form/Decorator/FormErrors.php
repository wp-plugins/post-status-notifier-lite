...
/**
 * IfwZend_Form_Decorator_FormErrors
 *
 ...
 * @version    $Id$
 */
class IfwZend_Form_Decorator_FormErrors extends IfwZend_Form_Decorator_Abstract
{
    /**
     ...
     * @return IfwZend_Form_Decorator_FormErrors
     */
     ...
     * @return string
     */
    public function renderLabel(IfwZend_Form_Element $element, IfwZend_View_Interface $view)
    {
     ...
     * @return string
     */
    protected function _recurseForm(IfwZend_Form $form, IfwZend_View_Interface $view)
    {
        $content = '';
        ...
        foreach ($form->getElementsAndSubFormsOrdered() as $subitem) {
            if ($subitem instanceof IfwZend_Form_Element && !$this->getOnlyCustomFormErrors()) {
            ...
            } else if ($subitem instanceof IfwZend_Form && !$this->ignoreSubForms()) {
