...
/**
 * IfwZend_Form_Decorator_ViewHelper
 *
 ...
 * @version    $Id$
 */
class IfwZend_Form_Decorator_ViewHelper extends IfwZend_Form_Decorator_Abstract
{
    /**
    ...
    protected $_buttonTypes = array(
        'IfwZend_Form_Element_Button',
        'IfwZend_Form_Element_Reset',
        'IfwZend_Form_Element_Submit',
    );
     ...
     *
     * @param  string $helper
     * @return IfwZend_Form_Decorator_Element_ViewHelper
     */
     ...
     * Get name
     *
     * If element is a IfwZend_Form_Element, will attempt to namespace it if the
     ...
     * @return string
     * @throws IfwZend_Form_Decorator_Exception if element or view are not registered
     */
    public function render($content)
    {
        ...
        if (null === $view) {
            ...
            throw new IfwZend_Form_Decorator_Exception('ViewHelper decorator cannot render without a registered view object');
        }
