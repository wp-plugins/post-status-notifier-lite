...
/**
 * IfwZend_Form_Decorator_Form
 *
 * Render a IfwZend_Form object.
 *
 ...
 * @version    $Id$
 */
class IfwZend_Form_Decorator_Form extends IfwZend_Form_Decorator_Abstract
{
    /**
     * Default view helper
     * @var string
     ...
     *
     * @param  string $helper
     * @return IfwZend_Form_Decorator_Form
     */
    ...
    public function getOptions()
    {
        if (null !== ($element = $this->getElement())) {
            if ($element instanceof IfwZend_Form) {
                $element->getAction();
                $method = $element->getMethod();
                if ($method == IfwZend_Form::METHOD_POST) {
                    $this->setOption('enctype', 'application/x-www-form-urlencoded');
                }
                foreach ($element->getAttribs() as $key => $value) {
                    $this->setOption($key, $value);
                }
            } elseif ($element instanceof IfwZend_Form_DisplayGroup) {
                foreach ($element->getAttribs() as $key => $value) {
                    $this->setOption($key, $value);
                }
            }
