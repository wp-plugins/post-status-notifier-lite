...
/**
 * IfwZend_Form_Decorator_Callback
 *
 ...
 * @version    $Id$
 */
class IfwZend_Form_Decorator_Callback extends IfwZend_Form_Decorator_Abstract
{
    /**
     * Callback
     * @var string|array
     ...
     * @return IfwZend_Form_Decorator_Callback
    ...
    public function setCallback($callback)
    {
        if (!is_callable($callback)) {
            ...
            throw new IfwZend_Form_Exception('Invalid callback provided to callback decorator');
        }
