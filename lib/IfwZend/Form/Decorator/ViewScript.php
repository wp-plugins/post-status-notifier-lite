...
/**
 * IfwZend_Form_Decorator_ViewScript
 *
 ...
 * @version    $Id$
 */
class IfwZend_Form_Decorator_ViewScript extends IfwZend_Form_Decorator_Abstract
{
    /**
     ...
     *
     * @param  string $script
     * @return IfwZend_Form_Decorator_ViewScript
     */
    ...
    public function render($content)
    {
        ...
        if (empty($viewScript)) {
            ...
            throw new IfwZend_Form_Exception('No view script registered with ViewScript decorator');
        }
