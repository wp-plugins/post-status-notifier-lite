...
/**
 * @see IfwZend_Form_Decorator_Abstract
 */
//require_once 'IfwZend/Form/Decorator/Abstract.php';

/**
 * IfwZend_Form_Decorator_Element_HtmlTag
 *
 ...
 * @version    $Id$
 */
class IfwZend_Form_Decorator_HtmlTag extends IfwZend_Form_Decorator_Abstract
{
    /**
    ...
    public function normalizeTag($tag)
    {
        if (!isset($this->_tagFilter)) {
            ...
            //require_once 'IfwZend/Filter/Alnum.php';
            //require_once 'IfwZend/Filter/StringToLower.php';
            $this->_tagFilter = new IfwZend_Filter();
            $this->_tagFilter->addFilter(new IfwZend_Filter_Alnum())
                             ->addFilter(new IfwZend_Filter_StringToLower());
        }
     ...
     *
     * @param  string $tag
     * @return IfwZend_Form_Decorator_HtmlTag
     */
    ...
    protected function _getEncoding()
    {
        ...
        if (null === ($element = $this->getElement())) {
            ...
            $this->_encoding = 'UTF-8';
        } elseif (!$view instanceof IfwZend_View_Abstract
