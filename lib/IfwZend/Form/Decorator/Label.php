 ...
 * @version    $Id$
 */
class IfwZend_Form_Decorator_Label extends IfwZend_Form_Decorator_Abstract
{
    /**
     ...
     *
     * @param  string $id
     * @return IfwZend_Form_Decorator_Label
     */
     ...
     * @param  array $args
     * @return mixed
     * @throws IfwZend_Form_Exception for unsupported methods
     */
    public function __call($method, $args)
    {
        ...
        if (in_array($head, array('get', 'set'))
            ...
            switch ($type) {
                ...
                default:
                    ...
                    throw new IfwZend_Form_Exception(sprintf('Invalid method "%s" called in Label decorator, and detected as type %s', $method, $type));
            }
            ...
            switch ($head) {
                case 'set':
                    if (0 === count($args)) {
                        //require_once 'IfwZend/Form/Exception.php';
                        throw new IfwZend_Form_Exception(sprintf('Method "%s" requires at least one argument; none provided', $method));
                    }
        ...
        //require_once 'IfwZend/Form/Exception.php';
        throw new IfwZend_Form_Exception(sprintf('Invalid method "%s" called in Label decorator', $method));
    }
    ...
    public function render($content)
    {
        ...
        if (null !== $tag) {
            //require_once 'IfwZend/Form/Decorator/HtmlTag.php';
            $decorator = new IfwZend_Form_Decorator_HtmlTag();
            if (null !== $this->_tagClass) {
