 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Config_Writer_Ini extends IfwZend_Config_Writer_FileAbstract
{
    /**
     ...
     * @return IfwZend_Config_Writer_Ini
     */
    ...
    /**
     * Render a IfwZend_Config into a INI config string.
     *
     * @since 1.10
     * @return string
     */
     ...
     * @return void
     */
    protected function _addBranch(IfwZend_Config $config, $parents = array())
    {
        $iniString = '';
    ...
    protected function _prepareValue($value)
    {
        if (is_integer($value) || is_float($value)) {
            ...
            throw new IfwZend_Config_Exception('Value can not contain double quotes "');
        }
    }
     ...
     * @param  IfwZend_Config
     * @return IfwZend_Config
     */
    protected function _sortRootElements(IfwZend_Config $config)
    {
        ...
        return new IfwZend_Config($configArray);
    }
}
