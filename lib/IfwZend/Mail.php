...
/**
 * @see IfwZend_Mail_Transport_Abstract
 */
//require_once 'IfwZend/Mail/Transport/Abstract.php';

/**
 * @see IfwZend_Mime
 */
//require_once 'IfwZend/Mime.php';

/**
 * @see IfwZend_Mime_Message
 */
//require_once 'IfwZend/Mime/Message.php';

/**
 * @see IfwZend_Mime_Part
 */
//require_once 'IfwZend/Mime/Part.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Mail extends IfwZend_Mime_Message
{
    /**#@+
     * @access protected
     */
    ...
    /**
     * @var IfwZend_Mail_Transport_Abstract
     * @static
     */
     ...
     * @var string
     */
    protected $_headerEncoding = IfwZend_Mime::ENCODING_QUOTEDPRINTABLE;
     ...
     * @param  IfwZend_Mail_Transport_Abstract $transport
     */
    public static function setDefaultTransport(IfwZend_Mail_Transport_Abstract $transport)
    {
     ...
     * @return IfwZend_Mail Implements fluent interface
     * @throws IfwZend_Mail_Exception for types not supported by IfwZend_Mime
     */
    public function setType($type)
    {
        $allowed = array(
            IfwZend_Mime::MULTIPART_ALTERNATIVE,
            IfwZend_Mime::MULTIPART_MIXED,
            IfwZend_Mime::MULTIPART_RELATED,
        );
        if (!in_array($type, $allowed)) {
            /**
             * @see IfwZend_Mail_Exception
             */
            //require_once 'IfwZend/Mail/Exception.php';
            throw new IfwZend_Mail_Exception('Invalid content type "' . $type . '"');
        }
     ...
     *
     * If not set, IfwZend_Mime will generate one.
     *
     * @param  string    $boundary
     * @return IfwZend_Mail Provides fluent interface
     */
     ...
     *
     * Either IfwZend_Mime::ENCODING_QUOTEDPRINTABLE or IfwZend_Mime::ENCODING_BASE64
     *
     * @return string
     */
     ...
     * Set the encoding of mail headers
     *
     * @param  string $encoding IfwZend_Mime::ENCODING_QUOTEDPRINTABLE or IfwZend_Mime::ENCODING_BASE64
     * @return IfwZend_Mail Provides fluent interface
     */
    public function setHeaderEncoding($encoding)
    {
        $allowed = array(
            IfwZend_Mime::ENCODING_BASE64,
            IfwZend_Mime::ENCODING_QUOTEDPRINTABLE
        );
        if (!in_array($encoding, $allowed)) {
             ...
             */
            //require_once 'IfwZend/Mail/Exception.php';
            throw new IfwZend_Mail_Exception('Invalid encoding "' . $encoding . '"');
        }
     ...
     * @return IfwZend_Mail Provides fluent interface
    */
    public function setBodyText($txt, $charset = null, $encoding = IfwZend_Mime::ENCODING_QUOTEDPRINTABLE)
    {
        if ($charset === null) {
            $charset = $this->_charset;
        }

        $mp = new IfwZend_Mime_Part($txt);
        $mp->encoding = $encoding;
        $mp->type = IfwZend_Mime::TYPE_TEXT;
        $mp->disposition = IfwZend_Mime::DISPOSITION_INLINE;
        $mp->charset = $charset;
     ...
     * @return IfwZend_Mail Provides fluent interface
     */
    public function setBodyHtml($html, $charset = null, $encoding = IfwZend_Mime::ENCODING_QUOTEDPRINTABLE)
    {
        if ($charset === null) {
            $charset = $this->_charset;
        }

        $mp = new IfwZend_Mime_Part($html);
        $mp->encoding = $encoding;
        $mp->type = IfwZend_Mime::TYPE_HTML;
        $mp->disposition = IfwZend_Mime::DISPOSITION_INLINE;
        $mp->charset = $charset;
    ...
    /**
     * Return IfwZend_Mime_Part representing body HTML
     *
     ...
     *
     * @param  IfwZend_Mime_Part $attachment
     * @return IfwZend_Mail Provides fluent interface
     */
    public function addAttachment(IfwZend_Mime_Part $attachment)
    {
    ...
    /**
     * Creates a IfwZend_Mime_Part attachment
     *
     ...
     * @return IfwZend_Mime_Part Newly created IfwZend_Mime_Part object (to allow
     * advanced settings)
     */
    public function createAttachment($body,
                                     $mimeType    = IfwZend_Mime::TYPE_OCTETSTREAM,
                                     $disposition = IfwZend_Mime::DISPOSITION_ATTACHMENT,
                                     $encoding    = IfwZend_Mime::ENCODING_BASE64,
                                     $filename    = null)
    {

        $mp = new IfwZend_Mime_Part($body);
        $mp->encoding = $encoding;
        $mp->type = $mimeType;
    ...
    {
        if (IfwZend_Mime::isPrintable($value) === false) {
            if ($this->getHeaderEncoding() === IfwZend_Mime::ENCODING_QUOTEDPRINTABLE) {
                $value = IfwZend_Mime::encodeQuotedPrintableHeader($value, $this->getCharset(), IfwZend_Mime::LINELENGTH, IfwZend_Mime::LINEEND);
            } else {
                $value = IfwZend_Mime::encodeBase64Header($value, $this->getCharset(), IfwZend_Mime::LINELENGTH, IfwZend_Mime::LINEEND);
            }
        }
     ...
     *
     * @param string $headerName
     * @return IfwZend_Mail Provides fluent inter
     */
     ...
     * @param  string    $name
     * @return IfwZend_Mail Provides fluent interface
     * @throws IfwZend_Mail_Exception if called subsequent times
     */
    public function setFrom($email, $name = null)
    {
        if (null !== $this->_from) {
             ...
             */
            //require_once 'IfwZend/Mail/Exception.php';
            throw new IfwZend_Mail_Exception('From Header set twice');
        }
     ...
     * @param string $name
     * @return IfwZend_Mail
     * @throws IfwZend_Mail_Exception if called more than one time
     */
    public function setReplyTo($email, $name = null)
    {
        if (null !== $this->_replyTo) {
             ...
             */
            //require_once 'IfwZend/Mail/Exception.php';
            throw new IfwZend_Mail_Exception('Reply-To Header set twice');
        }
    ...
    public function setFromToDefaultFrom() {
        ...
        if($from === null) {
            //require_once 'IfwZend/Mail/Exception.php';
            throw new IfwZend_Mail_Exception(
     ...
     * @param  string    $email
     * @return IfwZend_Mail Provides fluent interface
     * @throws IfwZend_Mail_Exception if set multiple times
     */
    public function setReturnPath($email)
    {
        if ($this->_returnPath === null) {
             ...
             */
            //require_once 'IfwZend/Mail/Exception.php';
            throw new IfwZend_Mail_Exception('Return-Path Header set twice');
        }
        return $this;
    }
    ...
    public function setSubject($subject)
    {
        if ($this->_subject === null) {
             ...
             */
            //require_once 'IfwZend/Mail/Exception.php';
            throw new IfwZend_Mail_Exception('Subject set twice');
        }
        return $this;
    }
     ...
     * Sets Date-header
     *
     * @param  timestamp|string|IfwZend_Date $date
     * @return IfwZend_Mail Provides fluent interface
     * @throws IfwZend_Mail_Exception if called subsequent times or wrong date format.
     */
        ...
        if ($this->_date === null) {
            if ($date === null) {
                ...
                if ($date === false || $date < 0) {
                     ...
                     */
                    //require_once 'IfwZend/Mail/Exception.php';
                    throw new IfwZend_Mail_Exception('String representations of Date Header must be ' .
                                                  'strtotime()-compatible');
                }
                $date = date('r', $date);
            } else if ($date instanceof IfwZend_Date) {
                $date = $date->get(IfwZend_Date::RFC_2822);
            } else {
                /**
                 * @see IfwZend_Mail_Exception
                 */
                //require_once 'IfwZend/Mail/Exception.php';
                throw new IfwZend_Mail_Exception(__METHOD__ . ' only accepts UNIX timestamps, IfwZend_Date objects, ' .
             ...
             */
            //require_once 'IfwZend/Mail/Exception.php';
            throw new IfwZend_Mail_Exception('Date Header set twice');
        }
        return $this;
    }
    ...
    public function setMessageId($id = true)
    {
        ...
        if ($this->_messageId === null) {
             ...
             */
            //require_once 'IfwZend/Mail/Exception.php';
            throw new IfwZend_Mail_Exception('Message-ID set twice');
        }
     ...
     * @return IfwZend_Mail           Provides fluent interface
     * @throws IfwZend_Mail_Exception on attempts to create standard headers
     */
    public function addHeader($name, $value, $append = false)
    {
        ...
        if (in_array(strtolower($name), $prohibit)) {
             ...
             */
            //require_once 'IfwZend/Mail/Exception.php';
            throw new IfwZend_Mail_Exception('Cannot set standard header from addHeader()');
        }
    ...
    {
        if ($transport === null) {
            if (! self::$_defaultTransport instanceof IfwZend_Mail_Transport_Abstract) {
                //require_once 'IfwZend/Mail/Transport/Sendmail.php';
                $transport = new IfwZend_Mail_Transport_Sendmail();
            } else {
