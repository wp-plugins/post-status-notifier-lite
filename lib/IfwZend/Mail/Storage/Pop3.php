...
/**
 * @see IfwZend_Mail_Protocol_Pop3
 */
//require_once 'IfwZend/Mail/Protocol/Pop3.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Mail_Storage_Pop3 extends IfwZend_Mail_Storage_Abstract
{
    /**
     * protocol handler
     * @var null|IfwZend_Mail_Protocol_Pop3
     */
    protected $_protocol;
    ...
    public function getRawContent($id, $part = null)
    {
        ...
        IfwZend_Mime_Decode::splitMessage($content, $null, $body);
        return $body;
    }
    ...
    public function __construct($params)
    {
        ...
        if ($params instanceof IfwZend_Mail_Protocol_Pop3) {
        ...
        $this->_protocol = new IfwZend_Mail_Protocol_Pop3();
     ...
     *
     * @see IfwZend_Mail_Storage_Abstract:__get()
     * @param  string $var
     * @return string
     * @throws IfwZend_Mail_Storage_Exception
     */
