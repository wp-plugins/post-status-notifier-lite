 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Mail_Storage_Folder implements RecursiveIterator
{
    /**
     * subfolders of folder array(localName => IfwZend_Mail_Storage_Folder folder)
     * @var array
     */
    protected $_folders;
     ...
     * @param array  $folders    init with given instances of IfwZend_Mail_Storage_Folder as subfolders
     */
    ...
    public function hasChildren()
    {
        ...
        return $current && $current instanceof IfwZend_Mail_Storage_Folder && !$current->isLeaf();
    }

    /**
     * implements RecursiveIterator::getChildren()
     *
     * @return IfwZend_Mail_Storage_Folder same as self::current()
     */
     ...
     *
     * @return IfwZend_Mail_Storage_Folder current folder
     */
     ...
     * @return IfwZend_Mail_Storage_Folder folder named $folder
    ...
    public function __get($name)
    {
        if (!isset($this->_folders[$name])) {
            ...
            throw new IfwZend_Mail_Storage_Exception("no subfolder named $name");
        }
     ...
     * @param IfwZend_Mail_Storage_Folder $folder instance for new subfolder
     * @return null
     */
    public function __set($name, IfwZend_Mail_Storage_Folder $folder)
    {
