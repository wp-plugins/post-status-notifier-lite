...
/**
 * @see IfwZend_Mail_Storage_Maildir
 */
//require_once 'IfwZend/Mail/Storage/Maildir.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Mail_Storage_Folder_Maildir extends IfwZend_Mail_Storage_Maildir implements IfwZend_Mail_Storage_Folder_Interface
{
    /**
    ...
    protected function _buildFolderTree()
    {
        ...
        $this->_rootFolder->INBOX = new IfwZend_Mail_Storage_Folder('INBOX', 'INBOX', true);
        ...
        if (!$dh) {
             ...
             */
            //require_once 'IfwZend/Mail/Storage/Exception.php';
            throw new IfwZend_Mail_Storage_Exception("can't read folders in maildir");
        }
        $dirs = array();
            ...
            do {
                if (strpos($dir, $parent) === 0) {
                    ...
                    if (strpos($local, $this->_delim) !== false) {
                         ...
                         */
                        //require_once 'IfwZend/Mail/Storage/Exception.php';
                        throw new IfwZend_Mail_Storage_Exception('error while reading maildir');
                    }
                    array_push($stack, $parent);
                    $parent = $dir . $this->_delim;
                    $folder = new IfwZend_Mail_Storage_Folder($local, substr($dir, 1), true);
    ...
    public function selectFolder($globalName)
    {
        ...
        try {
             ...
             */
            //require_once 'IfwZend/Mail/Storage/Exception.php';
            throw new IfwZend_Mail_Storage_Exception('seems like the maildir has vanished, I\'ve rebuild the ' .
