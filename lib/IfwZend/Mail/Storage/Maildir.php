...
/**
 * @see IfwZend_Mail_Message_File
 */
//require_once 'IfwZend/Mail/Message/File.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Mail_Storage_Maildir extends IfwZend_Mail_Storage_Abstract
{
    /**
     * used message class, change it in an extened class to extend the returned message class
     * @var string
     */
    protected $_messageClass = 'IfwZend_Mail_Message_File';
     ...
     * @var array
     */
    protected static $_knownFlags = array('D' => IfwZend_Mail_Storage::FLAG_DRAFT,
                                          'F' => IfwZend_Mail_Storage::FLAG_FLAGGED,
                                          'P' => IfwZend_Mail_Storage::FLAG_PASSED,
                                          'R' => IfwZend_Mail_Storage::FLAG_ANSWERED,
                                          'S' => IfwZend_Mail_Storage::FLAG_SEEN,
                                          'T' => IfwZend_Mail_Storage::FLAG_DELETED);
    ...
    protected function _getFileData($id, $field = null)
    {
        if (!isset($this->_files[$id - 1])) {
            ...
            throw new IfwZend_Mail_Storage_Exception('id does not exist');
        }
        ...
        if (!isset($this->_files[$id - 1][$field])) {
             ...
             */
            //require_once 'IfwZend/Mail/Storage/Exception.php';
            throw new IfwZend_Mail_Storage_Exception('field does not exist');
        }
     ...
     * @return IfwZend_Mail_Message_File
     * @throws IfwZend_Mail_Storage_Exception
     */
    ...
    public function __construct($params)
    {
        ...
        if (!$this->_isMaildir($params->dirname)) {
             ...
             */
            //require_once 'IfwZend/Mail/Storage/Exception.php';
            throw new IfwZend_Mail_Storage_Exception('invalid maildir given');
        }
    ...
    protected function _openMaildir($dirname)
    {
        ...
        if (!$dh) {
             ...
             */
            //require_once 'IfwZend/Mail/Storage/Exception.php';
            throw new IfwZend_Mail_Storage_Exception('cannot open maildir');
        }
        ...
        if ($dh) {
            $this->_getMaildirFiles($dh, $dirname . '/new/', array(IfwZend_Mail_Storage::FLAG_RECENT));
            closedir($dh);
             ...
             */
            //require_once 'IfwZend/Mail/Storage/Exception.php';
            throw new IfwZend_Mail_Storage_Exception('cannot read recent mails in maildir');
        }
    }
    ...
    public function removeMessage($id)
    {
         ...
         */
        //require_once 'IfwZend/Mail/Storage/Exception.php';
        throw new IfwZend_Mail_Storage_Exception('maildir is (currently) read-only');
    }
