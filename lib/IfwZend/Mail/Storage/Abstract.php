 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwZend_Mail_Storage_Abstract implements Countable, ArrayAccess, SeekableIterator
{
    /**
     ...
     * @var string
     */
    protected $_messageClass = 'IfwZend_Mail_Message';
    ...
    public function __get($var)
    {
        ...
        throw new IfwZend_Mail_Storage_Exception($var . ' not found');
    }
     ...
     */
      ...
      *
      * @param    int $id
      * @return   IfwZend_Mail_Message message object
      */
     ...
     public function offsetSet($id, $value)
     {
         ...
         */
        //require_once 'IfwZend/Mail/Storage/Exception.php';
        throw new IfwZend_Mail_Storage_Exception('cannot write mail messages via array access');
     }
      ...
      * Iterator::current()
      *
      * @return   IfwZend_Mail_Message current message
      */
