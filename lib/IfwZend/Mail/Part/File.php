...
/**
 * @see IfwZend_Mail_Part
 */
//require_once 'IfwZend/Mail/Part.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Mail_Part_File extends IfwZend_Mail_Part
{
    ...
    public function __construct(array $params)
    {
        if (empty($params['file'])) {
            ...
            throw new IfwZend_Mail_Exception('no file given in params');
        }
        ...
        if (!$this->_fh) {
             ...
             */
            //require_once 'IfwZend/Mail/Exception.php';
            throw new IfwZend_Mail_Exception('could not open file');
        }
        ...
        IfwZend_Mime_Decode::splitMessage($header, $this->_headers, $null);
        ...
        while (!feof($this->_fh) && ($endPos === null || $pos < $endPos)) {
            ...
            if ($line === false) {
                 ...
                 */
                //require_once 'IfwZend/Mail/Exception.php';
                throw new IfwZend_Mail_Exception('error reading file');
            }
