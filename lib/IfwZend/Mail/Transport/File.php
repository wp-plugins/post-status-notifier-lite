 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Mail_Transport_File extends IfwZend_Mail_Transport_Abstract
{
    /**
     ...
     * Constructor
     *
     * @param  array|IfwZend_Config $options OPTIONAL (Default: null)
     * @return void
     */
     ...
     *
     * @return void
     * @throws IfwZend_Mail_Transport_Exception on not writable target directory
     * @throws IfwZend_Mail_Transport_Exception on file_put_contents() failure
     */
    protected function _sendMail()
    {
        ...
        if (!is_writable(dirname($file))) {
            ...
            throw new IfwZend_Mail_Transport_Exception(sprintf(
        ...
        if (!file_put_contents($file, $email)) {
            //require_once 'IfwZend/Mail/Transport/Exception.php';
            throw new IfwZend_Mail_Transport_Exception('Unable to send mail');
        }
    }
     ...
     *
     * @param IfwZend_Mail_Transport_File File transport instance
     * @return string
     */
