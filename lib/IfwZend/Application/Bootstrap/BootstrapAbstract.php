 ...
 *
 * @uses       IfwZend_Application_Bootstrap_Bootstrapper
 * @uses       IfwZend_Application_Bootstrap_ResourceBootstrapper
 * @category   Zend
 * @package    IfwZend_Application
 * @subpackage Bootstrap
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwZend_Application_Bootstrap_BootstrapAbstract
    implements IfwZend_Application_Bootstrap_Bootstrapper,
               IfwZend_Application_Bootstrap_ResourceBootstrapper
{
    /**
     * @var IfwZend_Application|IfwZend_Application_Bootstrap_Bootstrapper
     */
    ...
    /**
     * @var IfwZend_Loader_PluginLoader_Interface
     */
     ...
     * initializer methods.
     *
     * @param  IfwZend_Application|IfwZend_Application_Bootstrap_Bootstrapper $application
     * @return void
     * @throws IfwZend_Application_Bootstrap_Exception When invalid application is provided
     */
     ...
     *
     * @param  array $options
     * @return IfwZend_Application_Bootstrap_BootstrapAbstract
     */
     ...
     * @param  mixed  $options
     * @return IfwZend_Application_Bootstrap_BootstrapAbstract
     * @throws IfwZend_Application_Bootstrap_Exception When invalid resource is provided
     */
    public function registerPluginResource($resource, $options = null)
    {
        if ($resource instanceof IfwZend_Application_Resource_Resource) {
        ...
        if (!is_string($resource)) {
            throw new IfwZend_Application_Bootstrap_Exception('Invalid resource provided to ' . __METHOD__);
        }
     ...
     * @param  string|IfwZend_Application_Resource_Resource $resource
     * @return IfwZend_Application_Bootstrap_BootstrapAbstract
     * @throws IfwZend_Application_Bootstrap_Exception When unknown resource type is provided
     */
    public function unregisterPluginResource($resource)
    {
        ...
        if (!is_string($resource)) {
            throw new IfwZend_Application_Bootstrap_Exception('Unknown resource type provided to ' . __METHOD__);
        }
    ...
    public function getPluginResource($resource)
    {
        if (array_key_exists(strtolower($resource), $this->_pluginResources)) {
            $resource = strtolower($resource);
            if (!$this->_pluginResources[$resource] instanceof IfwZend_Application_Resource_Resource) {
                $resourceName = $this->_loadPluginResource($resource, $this->_pluginResources[$resource]);
                if (!$resourceName) {
                    throw new IfwZend_Application_Bootstrap_Exception(sprintf('Unable to resolve plugin "%s"; no corresponding plugin with that name', $resource));
                }
        ...
        foreach ($this->_pluginResources as $plugin => $spec) {
            if ($spec instanceof IfwZend_Application_Resource_Resource) {
            ...
            && is_subclass_of($plugin, 'IfwZend_Application_Resource_Resource')
            ) { //@SEE ZF-7550
                $spec = (array) $spec;
                $spec['bootstrap'] = $this;
    ...
    public function getPluginLoader()
    {
        if ($this->_pluginLoader === null) {
            $options = array(
                'IfwZend_Application_Resource'  => 'IfwZend/Application/Resource',
                'ZendX_Application_Resource' => 'ZendX/Application/Resource'
            );

            $this->_pluginLoader = new IfwZend_Loader_PluginLoader($options);
        }
    ...
    {
        if (($application instanceof IfwZend_Application)
            || ($application instanceof IfwZend_Application_Bootstrap_Bootstrapper)
        ) {
            if ($application === $this) {
                throw new IfwZend_Application_Bootstrap_Exception('Cannot set application to same object; creates recursion');
            }
            $this->_application = $application;
        } else {
            throw new IfwZend_Application_Bootstrap_Exception('Invalid application provided to bootstrap constructor (received "' . get_class($application) . '" instance)');
        }
        return $this;
    }
     ...
     *
     * @return IfwZend_Application|IfwZend_Application_Bootstrap_Bootstrapper
     */
    ...
    public function setContainer($container)
    {
        if (!is_object($container)) {
            throw new IfwZend_Application_Bootstrap_Exception('Resource containers must be objects');
        }
    ...
    public function getContainer()
    {
        if (null === $this->_container) {
            $this->setContainer(new IfwZend_Registry());
        }
     ...
     * @return IfwZend_Application_Bootstrap_BootstrapAbstract
     * @throws IfwZend_Application_Bootstrap_Exception When invalid argument was passed
     */
     ...
     * @param  array  $args
     * @return void
     * @throws IfwZend_Application_Bootstrap_Exception On invalid method name
     */
    public function __call($method, $args)
    {
        ...
        throw new IfwZend_Application_Bootstrap_Exception('Invalid method "' . $method . '"');
    }
    ...
    protected function _bootstrap($resource = null)
    {
        if (null === $resource) {
            ...
            throw new IfwZend_Application_Bootstrap_Exception('Invalid argument passed to ' . __METHOD__);
        }
    }
     ...
     * @param  string $resource
     * @return void
     * @throws IfwZend_Application_Bootstrap_Exception When resource not found
     */
    protected function _executeResource($resource)
    {
        ...
        if (isset($this->_started[$resourceName]) && $this->_started[$resourceName]) {
            throw new IfwZend_Application_Bootstrap_Exception('Circular resource dependency detected');
        }
        ...
        throw new IfwZend_Application_Bootstrap_Exception('Resource matching "' . $resource . '" not found');
    }
     ...
     *
     * @param  IfwZend_Application_Resource_Resource $resource
     * @return string
     */
