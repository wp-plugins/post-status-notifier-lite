...
/**
 * @see IfwZend_Application_Bootstrap_Bootstrap
 */
//require_once 'IfwZend/Application/Bootstrap/Bootstrap.php';

/**
 * Base bootstrap class for modules
 *
 * @uses       IfwZend_Loader_Autoloader_Resource
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwZend_Application_Module_Bootstrap
    extends IfwZend_Application_Bootstrap_Bootstrap
{
    /**
    ...
    public function __construct($application)
    {
        ...
        if ($application instanceof IfwZend_Application_Bootstrap_ResourceBootstrapper) {
