 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Application_Resource_Modules extends IfwZend_Application_Resource_ResourceAbstract
{
    /**
     * @var ArrayObject
     */
     ...
     *
     * @return array
     * @throws IfwZend_Application_Resource_Exception When bootstrap class was not found
     */
            ...
            if (!class_exists($bootstrapClass, false)) {
                ...
                if (file_exists($bootstrapPath)) {
                    ...
                    if (($default != $module)
                        ...
                        throw new IfwZend_Application_Resource_Exception(sprintf(
