...
//require_once 'IfwZend/Db/Table.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Application_Resource_Multidb extends IfwZend_Application_Resource_ResourceAbstract
{
    /**
     ...
     *
     * @var null|IfwZend_Db_Adapter_Abstract
     */
    protected $_defaultDb;

    /**
     * Initialize the Database Connections (instances of IfwZend_Db_Table_Abstract)
     *
     * @return IfwZend_Application_Resource_Multidb
     */
    public function init()
    {
        ...
        foreach ($options as $id => $params) {
            ...
            $this->_dbs[$id] = IfwZend_Db::factory($adapter, $params);
     ...
     *
     * @param  string|IfwZend_Db_Adapter_Abstract $db The db to determine whether it's set as default
     ...
     *
     * @param  null|string|IfwZend_Db_Adapter_Abstract $db The adapter to retrieve.
     *                                               Null to retrieve the default connection
     * @return IfwZend_Db_Adapter_Abstract
     * @throws IfwZend_Application_Resource_Exception if the given parameter could not be found
     */
     ...
     *
     * @var IfwZend_Db_Adapter_Abstract $adapter Adapter to set as default
     */
    protected function _setDefault(IfwZend_Db_Adapter_Abstract $adapter)
    {
        IfwZend_Db_Table::setDefaultAdapter($adapter);
