 ...
 */
//require_once 'IfwZend/View/Helper/FormElement.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_FormRadio extends IfwZend_View_Helper_FormElement
{
    /**
     * Input type to use
     * @var string
        ...
        $options = null, $listsep = "<br />\n")
    {
        ...
        $endTag = ' />';
        if (($this->view instanceof IfwZend_View_Abstract) && !$this->view->doctype()->isXhtml()) {
            $endTag= '>';
        }
        ...
        $filter = new IfwZend_Filter_PregReplace($pattern, "");
