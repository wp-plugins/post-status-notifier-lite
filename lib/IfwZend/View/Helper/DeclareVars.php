 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_DeclareVars extends IfwZend_View_Helper_Abstract
{
    /**
     ...
     *
     * Primarily for use when using {@link IfwZend_View_Abstract::strictVars() IfwZend_View strictVars()},
