 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_Doctype extends IfwZend_View_Helper_Abstract
{
    /**#@+
     * DocType constants
     */
     ...
     * @var string
     */
    protected $_regKey = 'IfwZend_View_Helper_Doctype';
    ...
    {
        if (!IfwZend_Registry::isRegistered($this->_regKey)) {
            ...
            IfwZend_Registry::set($this->_regKey, $this->_registry);
            $this->setDoctype($this->_defaultDoctype);
        } else {
            $this->_registry = IfwZend_Registry::get($this->_regKey);
        }
    }
     ...
     * @return IfwZend_View_Helper_Doctype
     */
            ...
            switch ($doctype) {
                ...
                default:
                    if (substr($doctype, 0, 9) != '<!DOCTYPE') {
                        ...
                        $e = new IfwZend_View_Exception('The specified doctype is malformed');
                        $e->setView($this->view);
                        throw $e;
                    }
