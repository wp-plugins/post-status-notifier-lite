 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_Translate extends IfwZend_View_Helper_Abstract
{
    /**
     * Translation object
     *
     ...
     *
     * @param IfwZend_Translate|IfwZend_Translate_Adapter $translate Instance of IfwZend_Translate
     */
     ...
     * @return string|IfwZend_View_Helper_Translate Translated message
     */
    public function translate($messageid = null)
    {
        ...
        $locale = null;
        if ($count > 0) {
            if (IfwZend_Locale::isLocale($options[($count - 1)], null, false) !== false) {
     ...
     *
     * @param  IfwZend_Translate|IfwZend_Translate_Adapter $translate Instance of IfwZend_Translate
     * @throws IfwZend_View_Exception When no or a false instance was set
     * @return IfwZend_View_Helper_Translate
     */
    public function setTranslator($translate)
    {
        if ($translate instanceof IfwZend_Translate_Adapter) {
            $this->_translator = $translate;
        } else if ($translate instanceof IfwZend_Translate) {
     ...
     *
     * @param  string|IfwZend_Locale $locale New locale to set
     * @throws IfwZend_View_Exception When no IfwZend_Translate instance was set
     * @return IfwZend_View_Helper_Translate
     */
