...
/** @see IfwZend_View_Helper_Abstract */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_BaseUrl extends IfwZend_View_Helper_Abstract
{
    /**
     * BaseUrl
     *
     ...
     *
     * @param  string $base
     * @return IfwZend_View_Helper_BaseUrl
     */
    ...
    public function getBaseUrl()
    {
        if ($this->_baseUrl === null) {
            ...
            $baseUrl = IfwZend_Controller_Front::getInstance()->getBaseUrl();
