...
/** IfwZend_View_Helper_FormRadio */
//require_once 'IfwZend/View/Helper/FormRadio.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_FormMultiCheckbox extends IfwZend_View_Helper_FormRadio
{
    /**
     * Input type to use
     * @var string
