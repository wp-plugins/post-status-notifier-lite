...
/** IfwZend_View_Helper_HtmlElement */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_TinySrc extends IfwZend_View_Helper_HtmlElement
{
     ...
     *
     * @param  string $url
     * @return IfwZend_View_Helper_TinySrc
     */
    ...
    public function setDefaultFormat($format = null)
    {
        ...
        if (!in_array($format, array('png', 'jpeg'))) {
            ...
            throw new IfwZend_View_Exception('Invalid format; must be one of "jpeg" or "png"');
        }
        $this->_format = "/$format";
        return $this;
    }
    ...
    public function setDefaultDimensions($width = null, $height = null)
    {
        ...
        if (!$this->_validateDimension($width)) {
            //require_once 'IfwZend/View/Exception.php';
            throw new IfwZend_View_Exception('Invalid dimension; must be an integer, optionally preceded by "-" or "x"');
        }
