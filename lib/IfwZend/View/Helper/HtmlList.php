...
/**
 * IfwZend_View_Helper_FormELement
 */
 ...
 *
 * @uses IfwZend_View_Helper_FormElement
 * @category   Zend
 * @package    IfwZend_View
 * @subpackage Helper
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_HtmlList extends IfwZend_View_Helper_FormElement
{
    ...
    public function htmlList(array $items, $ordered = false, $attribs = false, $escape = true)
    {
        if (!is_array($items)) {
            ...
            $e = new IfwZend_View_Exception('First param must be an array');
            $e->setView($this->view);
            throw $e;
        }
