 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_HeadStyle extends IfwZend_View_Helper_Placeholder_Container_Standalone
{
    /**
     * Registry key for placeholder
     * @var string
     */
    protected $_regKey = 'IfwZend_View_Helper_HeadStyle';
     ...
     * @return IfwZend_View_Helper_HeadStyle
     */
     ...
     * @param  array $args
     * @return void
     * @throws IfwZend_View_Exception When no $content provided or invalid method
     */
    public function __call($method, $args)
    {
        if (preg_match('/^(?P<action>set|(ap|pre)pend|offsetSet)(Style)$/', $method, $matches)) {
            ...
            if (1 > $argc) {
                ...
                $e = new IfwZend_View_Exception(sprintf('Method "%s" requires minimally content for the stylesheet', $method));
                $e->setView($this->view);
                throw $e;
            }
    ...
    public function append($value)
    {
        if (!$this->_isValid($value)) {
            //require_once 'IfwZend/View/Exception.php';
            $e = new IfwZend_View_Exception('Invalid value passed to append; please use appendStyle()');
            $e->setView($this->view);
            throw $e;
        }
    ...
    public function offsetSet($index, $value)
    {
        if (!$this->_isValid($value)) {
            //require_once 'IfwZend/View/Exception.php';
            $e = new IfwZend_View_Exception('Invalid value passed to offsetSet; please use offsetSetStyle()');
            $e->setView($this->view);
            throw $e;
        }
    ...
    public function prepend($value)
    {
        if (!$this->_isValid($value)) {
            //require_once 'IfwZend/View/Exception.php';
            $e = new IfwZend_View_Exception('Invalid value passed to prepend; please use prependStyle()');
            $e->setView($this->view);
            throw $e;
        }
    ...
    public function set($value)
    {
        if (!$this->_isValid($value)) {
            //require_once 'IfwZend/View/Exception.php';
            $e = new IfwZend_View_Exception('Invalid value passed to set; please use setStyle()');
            $e->setView($this->view);
            throw $e;
        }
     ...
     * @return void
     */
    public function captureStart($type = IfwZend_View_Helper_Placeholder_Container_Abstract::APPEND, $attrs = null)
    {
        if ($this->_captureLock) {
            //require_once 'IfwZend/View/Helper/Placeholder/Container/Exception.php';
            $e = new IfwZend_View_Helper_Placeholder_Container_Exception('Cannot nest headStyle captures');
            $e->setView($this->view);
            throw $e;
        }
