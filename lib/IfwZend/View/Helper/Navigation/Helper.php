 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
interface IfwZend_View_Helper_Navigation_Helper
{
    /**
     ...
     *                                               reset.
     * @return IfwZend_View_Helper_Navigation_Helper    fluent interface, returns
     *                                               self
     */
     ...
     *
     * @param  IfwZend_Acl $acl                       [optional] ACL instance
     * @return IfwZend_View_Helper_Navigation_Helper  fluent interface, returns
     *                                             self
     */
     ...
     * @throws IfwZend_View_Exception                   if unable to render
     */
