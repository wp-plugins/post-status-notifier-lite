 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_Navigation_Breadcrumbs
    extends IfwZend_View_Helper_Navigation_HelperAbstract
{
     ...
     *                                                  operate on
     * @return IfwZend_View_Helper_Navigation_Breadcrumbs  fluent interface,
     *                                                  returns self
     */
    public function breadcrumbs(IfwZend_Navigation_Container $container = null)
    {
        if (null !== $container) {
     ...
     */
    public function renderStraight(IfwZend_Navigation_Container $container = null)
    {
        if (null === $container) {
