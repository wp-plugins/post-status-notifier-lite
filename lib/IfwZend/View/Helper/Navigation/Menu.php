 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_Navigation_Menu
    extends IfwZend_View_Helper_Navigation_HelperAbstract
{
     ...
     *                                               operate on
     * @return IfwZend_View_Helper_Navigation_Menu      fluent interface,
     *                                               returns self
     */
    public function menu(IfwZend_Navigation_Container $container = null)
    {
        if (null !== $container) {
     ...
     * @return IfwZend_View_Helper_Navigation_Menu  fluent interface, returns self
     */
     ...
     *
     * Overrides {@link IfwZend_View_Helper_Navigation_Abstract::htmlify()}.
     *
     ...
     *
     * @param  IfwZend_Navigation_Container $container  container to render
     ...
     */
    protected function _renderDeepestMenu(IfwZend_Navigation_Container $container,
                                          $ulClass,
                                          $indent,
                                          $minDepth,
                                          $maxDepth)
     ...
     * @return string
     */
    protected function _renderMenu(IfwZend_Navigation_Container $container,
                                   $ulClass,
                                   $indent,
                                   $minDepth,
                                   $maxDepth,
     ...
     * @return string                                rendered menu
     */
    public function renderMenu(IfwZend_Navigation_Container $container = null,
                               array $options = array())
    {
        if (null === $container) {
     ...
     */
    public function renderSubMenu(IfwZend_Navigation_Container $container = null,
                                  $ulClass = null,
                                  $indent = null)
    {
     ...
     */
    public function renderPartial(IfwZend_Navigation_Container $container = null,
                                  $partial = null)
    {
        if (null === $container) {
            $container = $this->getContainer();
