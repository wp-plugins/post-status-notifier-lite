...
/**
 * @see IfwZend_View_Helper_Navigation_HelperAbstract
 */
//require_once 'IfwZend/View/Helper/Navigation/HelperAbstract.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_Navigation_Links
    extends IfwZend_View_Helper_Navigation_HelperAbstract
{
    /**#@+
     ...
     *
     * @param  IfwZend_Navigation_Container $container  [optional] container to
     *                                               operate on
     * @return IfwZend_View_Helper_Navigation_Links     fluent interface, returns
     *                                               self
     */
    public function links(IfwZend_Navigation_Container $container = null)
    {
        if (null !== $container) {
     ...
     * $flag = IfwZend_View_Helper_Navigation_Links:RENDER_ALL ^
     *         IfwZend_View_Helper_Navigation_Links:RENDER_GLOSSARY;
     * $helper->setRenderFlag($flag);
     *
     * // render only chapters and sections
     * $flag = IfwZend_View_Helper_Navigation_Links:RENDER_CHAPTER |
     *         IfwZend_View_Helper_Navigation_Links:RENDER_SECTION;
     * $helper->setRenderFlag($flag);
     *
     * // render only relations that are not native W3C relations
     * $helper->setRenderFlag(IfwZend_View_Helper_Navigation_Links:RENDER_CUSTOM);
     *
     * // render all relations (default)
     * $helper->setRenderFlag(IfwZend_View_Helper_Navigation_Links:RENDER_ALL);
     * </code>
     *
     ...
     * @return IfwZend_View_Helper_Navigation_Links  fluent interface, returns self
     */
     ...
     * <code>
     * // $page denotes an instance of IfwZend_Navigation_Page
     * $returned = array(
     *     'rel' => array(
     ...
     * </code>
     *
     * @param  IfwZend_Navigation_Page $page  page to find links for
     * @return array                       related pages
     */
    public function findAllRelations(IfwZend_Navigation_Page $page,
                                     $flag = null)
    {
        if (!is_int($flag)) {
     ...
     *
     * @param  IfwZend_Navigation_Page $page       page to find relations for
     * @param  string              $rel         relation, "rel" or "rev"
     * @param  string              $type        link type, e.g. 'start', 'next'
     * @return IfwZend_Navigaiton_Page|array|null  page(s), or null if not found
     * @throws IfwZend_View_Exception              if $rel is not "rel" or "rev"
     */
    public function findRelation(IfwZend_Navigation_Page $page, $rel, $type)
    {
     ...
     * @param  string              $rel         relation, 'rel' or 'rev'
     * @param  string              $type        link type, e.g. 'start', 'next'
     * @return IfwZend_Navigation_Page|array|null  page(s), or null if not found
     */
    protected function _findFromProperty(IfwZend_Navigation_Page $page, $rel, $type)
    {
     ...
     */
    protected function _findFromSearch(IfwZend_Navigation_Page $page, $rel, $type)
    {
        $found = null;
     ...
     *
     * @param  IfwZend_Navigation_Page $page  page to find relation for
     * @return IfwZend_Navigation_Page|null   page or null
     */
    public function searchRelStart(IfwZend_Navigation_Page $page)
    {
     ...
     *
     * @param  IfwZend_Navigation_Page $page  page to find relation for
     * @return IfwZend_Navigation_Page|null   page(s) or null
     */
    public function searchRelNext(IfwZend_Navigation_Page $page)
    {
        $found = null;
        $break = false;
     ...
     * @return IfwZend_Navigation_Page|null   page or null
     */
    public function searchRelPrev(IfwZend_Navigation_Page $page)
    {
        $found = null;
        $prev = null;
     ...
     *
     * @param  IfwZend_Navigation_Page $page       page to find relation for
     * @return IfwZend_Navigation_Page|array|null  page(s) or null
     */
    public function searchRelChapter(IfwZend_Navigation_Page $page)
    {
        $found = array();
     ...
     * @return IfwZend_Navigation_Page|array|null  page(s) or null
     */
    public function searchRelSection(IfwZend_Navigation_Page $page)
    {
        $found = array();
     ...
     * @return IfwZend_Navigation_Page|array|null  page(s) or null
     */
    public function searchRelSubsection(IfwZend_Navigation_Page $page)
    {
        $found = array();
     ...
     * @return IfwZend_Navigation_Page|null   page(s) or null
     */
    public function searchRevSection(IfwZend_Navigation_Page $page)
    {
        $found = null;
     ...
     * @return IfwZend_Navigation_Page|null   page(s) or null
     */
    public function searchRevSubsection(IfwZend_Navigation_Page $page)
    {
        $found = null;
     ...
     *
     * @param  IfwZend_Navigaiton_Page $page  page to find root for
     * @return IfwZend_Navigation_Container   the root container of the given page
     */
    protected function _findRoot(IfwZend_Navigation_Page $page)
    {
        if ($this->_root) {
            return $this->_root;
        }
     ...
     * @return IfwZend_Navigation_Page|array|null  empty if unable to convert
     */
    protected function _convertToPages($mixed, $recursive = true)
    {
        if (is_object($mixed)) {
            if ($mixed instanceof IfwZend_Navigation_Page) {
                // value is a page instance; return directly
                return $mixed;
            } elseif ($mixed instanceof IfwZend_Navigation_Container) {
                ...
                return $pages;
            } elseif ($mixed instanceof IfwZend_Config) {
            ...
            return IfwZend_Navigation_Page::factory(array(
                'type' => 'uri',
                'uri'  => $mixed
            ));
            ...
            if ($recursive && is_numeric(key($mixed))) {
                ...
                try {
                    $page = IfwZend_Navigation_Page::factory($mixed);
                    return $page;
                } catch (Exception $e) {
                }
            }
     ...
     *
     * @param  IfwZend_Navigation_Page $page      the page to render the link for
     ...
     * @throws IfwZend_View_Exception             if $attrib is invalid
     */
    public function renderLink(IfwZend_Navigation_Page $page, $attrib, $relation)
    {
    ...
    // IfwZend_View_Helper_Navigation_Helper:

    /**
     * Renders helper
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::render()}.
     *
     * @param  IfwZend_Navigation_Container $container  [optional] container to
     ...
     */
    public function render(IfwZend_Navigation_Container $container = null)
    {
        if (null === $container) {
