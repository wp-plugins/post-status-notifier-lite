...
/**
 * @see IfwZend_View_Helper_Navigation_Helper
 */
//require_once 'IfwZend/View/Helper/Navigation/Helper.php';

/**
 * @see IfwZend_View_Helper_HtmlElement
 */
//require_once 'IfwZend/View/Helper/HtmlElement.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwZend_View_Helper_Navigation_HelperAbstract
    extends IfwZend_View_Helper_HtmlElement
    implements IfwZend_View_Helper_Navigation_Helper
{
    /**
     * Container to operate on by default
     *
     * @var IfwZend_Navigation_Container
     */
     ...
     *
     * @var string|IfwZend_Acl_Role_Interface
     */
    protected $_role;
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Interface::setContainer()}.
     *
     * @param  IfwZend_Navigation_Container $container        [optional] container
     *                                                     to operate on.
     *                                                     Default is null,
     *                                                     meaning container
     *                                                     will be reset.
     * @return IfwZend_View_Helper_Navigation_HelperAbstract  fluent interface,
     *                                                     returns self
     */
    public function setContainer(IfwZend_Navigation_Container $container = null)
    {
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Interface::getContainer()}.
     *
     ...
     * this method will look in {@link IfwZend_Registry} for a container by using
     * the key 'IfwZend_Navigation'.
     *
     * If no container is set, and nothing is found in IfwZend_Registry, a new
     * container will be instantiated and stored in the helper.
     *
     * @return IfwZend_Navigation_Container  navigation container
     */
    public function getContainer()
    {
        if (null === $this->_container) {
            ...
            if (IfwZend_Registry::isRegistered('IfwZend_Navigation')) {
                $nav = IfwZend_Registry::get('IfwZend_Navigation');
                if ($nav instanceof IfwZend_Navigation_Container) {
                    return $this->_container = $nav;
                }
            }

            // nothing found in registry, create new container
            //require_once 'IfwZend/Navigation.php';
            $this->_container = new IfwZend_Navigation();
        }
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::setTranslator()}.
     *
     * @param  mixed $translator                           [optional] translator.
     *                                                     Expects an object of
     *                                                     type
     *                                                     {@link IfwZend_Translate_Adapter}
     *                                                     or {@link IfwZend_Translate},
     *                                                     or null. Default is
     *                                                     null, which sets no
     *                                                     translator.
     * @return IfwZend_View_Helper_Navigation_HelperAbstract  fluent interface,
    ...
    {
        if (null == $translator ||
            $translator instanceof IfwZend_Translate_Adapter) {
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::getTranslator()}.
     *
     * @return IfwZend_Translate_Adapter|null  translator or null
     */
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::setAcl()}.
     *
     * @param  IfwZend_Acl $acl                               [optional] ACL object.
     *                                                     Default is null.
     * @return IfwZend_View_Helper_Navigation_HelperAbstract  fluent interface,
     *                                                     returns self
     */
    public function setAcl(IfwZend_Acl $acl = null)
    {
        $this->_acl = $acl;
        return $this;
    }
     ...
     * {@link setDefaultAcl()}
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::getAcl()}.
     *
     * @return IfwZend_Acl|null  ACL object or null
     */
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::setRole()}.
     *
     * @param  mixed $role                                 [optional] role to
     *                                                     set. Expects a string,
     *                                                     an instance of type
     *                                                     {@link IfwZend_Acl_Role_Interface},
     *                                                     or null. Default is
     *                                                     null, which will set
     *                                                     no role.
     * @throws IfwZend_View_Exception                         if $role is invalid
     * @return IfwZend_View_Helper_Navigation_HelperAbstract  fluent interface,
     *                                                     returns self
     */
    public function setRole($role = null)
    {
        if (null === $role || is_string($role) ||
            $role instanceof IfwZend_Acl_Role_Interface) {
            $this->_role = $role;
        } else {
            //require_once 'IfwZend/View/Exception.php';
            $e = new IfwZend_View_Exception(sprintf(
                '$role must be a string, null, or an instance of '
                .  'IfwZend_Acl_Role_Interface; %s given',
                gettype($role)
            ));
            $e->setView($this->view);
            throw $e;
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::getRole()}.
     *
     * @return string|IfwZend_Acl_Role_Interface|null  role or null
     */
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::setUseAcl()}.
     *
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::getUseAcl()}.
     *
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::setUseTranslator()}.
     *
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::getUseTranslator()}.
     *
     ...
     * @throws IfwZend_Navigation_Exception  if method does not exist in container
     */
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::__toString()}.
     *
     * @return string
     */
     ...
     *
     * @param  IfwZend_Navigation_Container $container  container to search
     ...
     *                                               if not found
     */
    public function findActive(IfwZend_Navigation_Container $container,
                               $minDepth = null,
                               $maxDepth = -1)
    {
        if (!is_int($minDepth)) {
        ...
        if (is_int($maxDepth) && $foundDepth > $maxDepth) {
            while ($foundDepth > $maxDepth) {
                ...
                if (!$found instanceof IfwZend_Navigation_Page) {
                    $found = null;
                    break;
                }
            }
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::hasContainer()}.
     *
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::hasAcl()}.
     *
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::hasRole()}.
     *
     ...
     *
     * Implements {@link IfwZend_View_Helper_Navigation_Helper::hasTranslator()}.
     *
     ...
     *
     * @param  IfwZend_Navigation_Page $page  page to generate HTML for
     * @return string                      HTML string for the given page
     */
    public function htmlify(IfwZend_Navigation_Page $page)
    {
     ...
     *
     * @param  IfwZend_Navigation_Page $page      page to check
     ...
     */
    public function accept(IfwZend_Navigation_Page $page, $recursive = true)
    {
        // accept by default
        $accept = true;
        ...
        if ($accept && $recursive) {
            ...
            if ($parent instanceof IfwZend_Navigation_Page) {
     ...
     */
    protected function _acceptAcl(IfwZend_Navigation_Page $page)
    {
        if (!$acl = $this->getAcl()) {
     ...
     *
     * Overloads {@link IfwZend_View_Helper_HtmlElement::_htmlAttribs()}.
     *
     ...
     * Normalize an ID
     *
     * Overrides {@link IfwZend_View_Helper_HtmlElement::_normalizeId()}.
     *
     * @param  string $value
     * @return string
     */
     ...
     *
     * @param  IfwZend_Acl $acl  [optional] ACL object. Default is null, which
     *                        sets no ACL object.
     * @return void
     */
    public static function setDefaultAcl(IfwZend_Acl $acl = null)
    {
    ...
    public static function setDefaultRole($role = null)
    {
        if (null === $role ||
            ...
            //require_once 'IfwZend/View/Exception.php';
            throw new IfwZend_View_Exception(
                '$role must be null|string|IfwZend_Acl_Role_Interface'
            );
        }
    }
}
