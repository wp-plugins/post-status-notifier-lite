 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_Navigation_Sitemap
    extends IfwZend_View_Helper_Navigation_HelperAbstract
{
    ...
    /**
     * Whether sitemap should be validated using IfwZend_Validate_Sitemap_*
     *
     * @var bool
     */
     ...
     *                                               operate on
     * @return IfwZend_View_Helper_Navigation_Sitemap   fluent interface, returns
     *                                               self
     */
    public function sitemap(IfwZend_Navigation_Container $container = null)
    {
        if (null !== $container) {
    ...
    /**
     * Sets whether sitemap should be validated using IfwZend_Validate_Sitemap_*
     *
    ...
    /**
     * Returns whether sitemap should be validated using IfwZend_Validate_Sitemap_*
     *
     ...
     *                                              scheme and host)
     * @throws IfwZend_Uri_Exception                   if invalid server URL
     * @return IfwZend_View_Helper_Navigation_Sitemap  fluent interface, returns
     *                                              self
     */
    public function setServerUrl($serverUrl)
    {
        ...
        $uri = IfwZend_Uri::factory($serverUrl);
        $uri->setFragment('');
        $uri->setPath('');
        $uri->setQuery('');
        ...
        if ($uri->valid()) {
            ...
            $e = new IfwZend_Uri_Exception(sprintf(
    ...
    {
        $enc = 'UTF-8';
        if ($this->view instanceof IfwZend_View_Interface
     ...
     *
     * @param  IfwZend_Navigation_Page $page  page to get URL from
     * @return string
     */
    public function url(IfwZend_Navigation_Page $page)
    {
        $href = $page->getHref();
     ...
     *
     * @param  IfwZend_Navigation_Container $container  [optional] container to get
     *                                               breadcrumbs from, defaults
     *                                               to what is registered in the
     *                                               helper
     * @return DOMDocument                           DOM representation of the
     *                                               container
     * @throws IfwZend_View_Exception                   if schema validation is on
     ...
     */
    public function getDomSitemap(IfwZend_Navigation_Container $container = null)
    {
        if (null === $container) {
        ...
        if ($this->getUseSitemapValidators()) {
            //require_once 'IfwZend/Validate/Sitemap/Changefreq.php';
            //require_once 'IfwZend/Validate/Sitemap/Lastmod.php';
            //require_once 'IfwZend/Validate/Sitemap/Loc.php';
            //require_once 'IfwZend/Validate/Sitemap/Priority.php';

            // create validators
            $locValidator        = new IfwZend_Validate_Sitemap_Loc();
            $lastmodValidator    = new IfwZend_Validate_Sitemap_Lastmod();
            $changefreqValidator = new IfwZend_Validate_Sitemap_Changefreq();
            $priorityValidator   = new IfwZend_Validate_Sitemap_Priority();
        }
