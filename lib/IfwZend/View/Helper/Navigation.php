 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_Navigation
    extends IfwZend_View_Helper_Navigation_HelperAbstract
{
     ...
     * @var string
     */
    const NS = 'IfwZend_View_Helper_Navigation';
     ...
     *                                               operate on
     * @return IfwZend_View_Helper_Navigation           fluent interface, returns
     *                                               self
     */
    public function navigation(IfwZend_Navigation_Container $container = null)
    {
        if (null !== $container) {
     ...
     * @throws IfwZend_View_Exception        if proxying to a helper, and the
     ...
     * {@link IfwZend_View_Helper_Navigation_Helper}.
     *
     ...
     * @return IfwZend_View_Helper_Navigation_Helper  helper instance
     * @throws IfwZend_Loader_PluginLoader_Exception  if $strict is true and
     *                                             helper cannot be found
     * @throws IfwZend_View_Exception                 if $strict is true and
    ...
    public function findHelper($proxy, $strict = true)
    {
        ...
        if (!$helper instanceof IfwZend_View_Helper_Navigation_Helper) {
            if ($strict) {
     ...
     *
     * @param  IfwZend_View_Helper_Navigation_Helper $helper  helper instance
     * @return void
     */
    protected function _inject(IfwZend_View_Helper_Navigation_Helper $helper)
    {
     ...
     * @return IfwZend_View_Helper_Navigation  fluent interface, returns self
     */
     ...
     * @throws IfwZend_Loader_PluginLoader_Exception    if helper cannot be found
     * @throws IfwZend_View_Exception                   if helper doesn't implement
