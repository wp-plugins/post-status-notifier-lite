...
/** IfwZend_View_Helper_Partial */
//require_once 'IfwZend/View/Helper/Partial.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_PartialLoop extends IfwZend_View_Helper_Partial
{
    ...
    public function partialLoop($name = null, $module = null, $model = null)
    {
        ...
        if (!is_array($model)
            ...
            $e = new IfwZend_View_Helper_Partial_Exception('PartialLoop helper requires iterable data');
            $e->setView($this->view);
            throw $e;
        }
