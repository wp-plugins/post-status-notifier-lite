 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_View_Helper_Partial extends IfwZend_View_Helper_Abstract
{
    /**
     ...
     * @return string|IfwZend_View_Helper_Partial
     */
    public function partial($name = null, $module = null, $model = null)
    {
        ...
        if ((null !== $module) && is_string($module)) {
            ...
            $moduleDir = IfwZend_Controller_Front::getInstance()->getControllerDirectory($module);
            if (null === $moduleDir) {
                //require_once 'IfwZend/View/Helper/Partial/Exception.php';
                $e = new IfwZend_View_Helper_Partial_Exception('Cannot render partial; module does not exist');
                $e->setView($this->view);
                throw $e;
            }
     ...
     *
     * @param  string $key
     * @return IfwZend_View_Helper_Partial
     */
