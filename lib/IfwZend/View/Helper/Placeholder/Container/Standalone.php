 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwZend_View_Helper_Placeholder_Container_Standalone extends IfwZend_View_Helper_Abstract implements IteratorAggregate, Countable, ArrayAccess
{
    /**
     * @var IfwZend_View_Helper_Placeholder_Container_Abstract
     */
    ...
    {
        $this->setRegistry(IfwZend_View_Helper_Placeholder_Registry::getRegistry());
     ...
     * Set registry object
     *
     * @param  IfwZend_View_Helper_Placeholder_Registry $registry
     * @return IfwZend_View_Helper_Placeholder_Container_Standalone
     */
    public function setRegistry(IfwZend_View_Helper_Placeholder_Registry $registry)
    {
     ...
     *
     * @param  IfwZend_View_Helper_Placeholder_Container_Abstract $container
     * @return IfwZend_View_Helper_Placeholder_Container_Standalone
     */
    public function setContainer(IfwZend_View_Helper_Placeholder_Container_Abstract $container)
    {
    ...
    public function __call($method, $args)
    {
        ...
        $e = new IfwZend_View_Exception('Method "' . $method . '" does not exist');
        $e->setView($this->view);
        throw $e;
    }
