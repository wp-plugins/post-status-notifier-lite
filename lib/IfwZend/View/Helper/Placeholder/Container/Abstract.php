 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwZend_View_Helper_Placeholder_Container_Abstract extends ArrayObject
{
    /**
     ...
     * @return void
     * @throws IfwZend_View_Helper_Placeholder_Exception if nested captures detected
     */
    public function captureStart($type = IfwZend_View_Helper_Placeholder_Container_Abstract::APPEND, $key = null)
    {
        if ($this->_captureLock) {
            //require_once 'IfwZend/View/Helper/Placeholder/Container/Exception.php';
            $e = new IfwZend_View_Helper_Placeholder_Container_Exception('Cannot nest placeholder captures for the same placeholder');
            $e->setView($this->view);
            throw $e;
        }
