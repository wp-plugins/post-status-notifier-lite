...
/** IfwZend_Wildfire_Plugin_FirePhp_TableMessage */
//require_once 'IfwZend/Wildfire/Plugin/FirePhp/TableMessage.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Db_Profiler_Firebug extends IfwZend_Db_Profiler
{
    /**
     ...
     * @var IfwZend_Wildfire_Plugin_FirePhp_TableMessage
     */
    ...
    public function __construct($label = null)
    {
        $this->_label = $label;
        if(!$this->_label) {
            $this->_label = 'IfwZend_Db_Profiler_Firebug';
        }
    }
    ...
    public function setEnabled($enable)
    {
        ...
        if ($this->getEnabled()) {
            ...
            if (!$this->_message) {
                $this->_message = new IfwZend_Wildfire_Plugin_FirePhp_TableMessage($this->_label);
                ...
                IfwZend_Wildfire_Plugin_FirePhp::getInstance()->send($this->_message);
            }
