 ...
 * is that you can use IfwZend_Db_Expr in the IfwZend_Db_Select::order() method to
 ...
 * specified to methods of IfwZend_Db classes, if the value is an instance of
 * IfwZend_Db_Expr instead of a plain string, then the expression is not quoted.
