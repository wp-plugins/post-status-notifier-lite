...
/**
 * @see IfwZend_Db_Statement_Oracle
 */
//require_once 'IfwZend/Db/Statement/Oracle.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Db_Adapter_Oracle extends IfwZend_Db_Adapter_Abstract
{
    /**
    ...
    protected $_numericDataTypes = array(
        ...
        'BINARY_DOUBLE'      => IfwZend_Db::FLOAT_TYPE,
        'BINARY_FLOAT'       => IfwZend_Db::FLOAT_TYPE,
        'NUMBER'             => IfwZend_Db::FLOAT_TYPE,
    );
     ...
     * @var string
     */
    protected $_defaultStmtClass = 'IfwZend_Db_Statement_Oracle';
     ...
     *
     * @return void
     * @throws IfwZend_Db_Adapter_Oracle_Exception
     */
    protected function _connect()
    {
        ...
        if (!extension_loaded('oci8')) {
            /**
             * @see IfwZend_Db_Adapter_Oracle_Exception
             */
            //require_once 'IfwZend/Db/Adapter/Oracle/Exception.php';
            throw new IfwZend_Db_Adapter_Oracle_Exception('The OCI8 extension is required for this adapter but the extension is not loaded');
        }
        ...
        if (!$this->_connection) {
             ...
             */
            //require_once 'IfwZend/Db/Adapter/Oracle/Exception.php';
            throw new IfwZend_Db_Adapter_Oracle_Exception(oci_error());
        }
    }
     ...
     * @return IfwZend_Db_Adapter_Oracle
     */
     ...
     * @return IfwZend_Db_Statement_Oracle
     */
    public function prepare($sql)
    {
        ...
        if ($stmt instanceof IfwZend_Db_Statement_Oracle) {
     ...
     *
     * @param string|array|IfwZend_Db_Expr $ident The identifier or expression.
    ...
    protected function _commit()
    {
        if (!oci_commit($this->_connection)) {
             ...
             */
            //require_once 'IfwZend/Db/Adapter/Oracle/Exception.php';
            throw new IfwZend_Db_Adapter_Oracle_Exception(oci_error($this->_connection));
        }
        $this->_setExecuteMode(OCI_COMMIT_ON_SUCCESS);
    }
    ...
    public function setFetchMode($mode)
    {
        switch ($mode) {
            ...
            case IfwZend_Db::FETCH_BOUND: // bound to PHP variable
                 ...
                 */
                //require_once 'IfwZend/Db/Adapter/Oracle/Exception.php';
                throw new IfwZend_Db_Adapter_Oracle_Exception('FETCH_BOUND is not supported yet');
                break;
            default:
                /**
                 * @see IfwZend_Db_Adapter_Oracle_Exception
                 */
                //require_once 'IfwZend/Db/Adapter/Oracle/Exception.php';
                throw new IfwZend_Db_Adapter_Oracle_Exception("Invalid fetch mode '$mode' specified");
                break;
        }
    }
    ...
    public function limit($sql, $count, $offset = 0)
    {
        ...
        if ($count <= 0) {
             ...
             */
            //require_once 'IfwZend/Db/Adapter/Oracle/Exception.php';
            throw new IfwZend_Db_Adapter_Oracle_Exception("LIMIT argument count=$count is not valid");
        }
        ...
        if ($offset < 0) {
             ...
             */
            //require_once 'IfwZend/Db/Adapter/Oracle/Exception.php';
            throw new IfwZend_Db_Adapter_Oracle_Exception("LIMIT argument offset=$offset is not valid");
        }
    ...
    private function _setExecuteMode($mode)
    {
        switch($mode) {
            ...
            default:
                 ...
                 */
                //require_once 'IfwZend/Db/Adapter/Oracle/Exception.php';
                throw new IfwZend_Db_Adapter_Oracle_Exception("Invalid execution mode '$mode' specified");
                break;
        }
    }
