 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Db_Adapter_Pdo_Sqlite extends IfwZend_Db_Adapter_Pdo_Abstract
{
    ...
    protected $_numericDataTypes = array(
        ...
        'INTEGER'            => IfwZend_Db::BIGINT_TYPE,
    ...
    protected function _connect()
    {
        ...
        if ($retval === false) {
            ...
            /** @see IfwZend_Db_Adapter_Exception */
            //require_once 'IfwZend/Db/Adapter/Exception.php';
            throw new IfwZend_Db_Adapter_Exception($error[2]);
        }
