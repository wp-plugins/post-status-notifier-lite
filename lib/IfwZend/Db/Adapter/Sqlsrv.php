...
/**
 * @see IfwZend_Db_Statement_Sqlsrv
 */
//require_once 'IfwZend/Db/Statement/Sqlsrv.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Db_Adapter_Sqlsrv extends IfwZend_Db_Adapter_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_defaultStmtClass = 'IfwZend_Db_Statement_Sqlsrv';

    /**
     * Creates a connection resource.
     *
     * @return void
     * @throws IfwZend_Db_Adapter_Sqlsrv_Exception
     */
    protected function _connect()
    {
        ...
        if (!extension_loaded('sqlsrv')) {
            /**
             * @see IfwZend_Db_Adapter_Sqlsrv_Exception
             */
            //require_once 'IfwZend/Db/Adapter/Sqlsrv/Exception.php';
            throw new IfwZend_Db_Adapter_Sqlsrv_Exception('The Sqlsrv extension is required for this adapter but the extension is not loaded');
        }
        ...
        if (!$this->_connection) {
             ...
             */
            //require_once 'IfwZend/Db/Adapter/Sqlsrv/Exception.php';
            throw new IfwZend_Db_Adapter_Sqlsrv_Exception(sqlsrv_errors());
        }
    }
    ...
    protected function _checkRequiredOptions(array $config)
    {
        ...
        if (! array_key_exists('dbname', $config)) {
            ...
            throw new IfwZend_Db_Adapter_Exception("Configuration array must have a key for 'dbname' that names the database instance");
        }
        ...
        if (! array_key_exists('password', $config) && array_key_exists('username', $config)) {
             ...
             */
            //require_once 'IfwZend/Db/Adapter/Exception.php';
            throw new IfwZend_Db_Adapter_Exception("Configuration array must have a key for 'password' for login credentials.
        ...
        if (array_key_exists('password', $config) && !array_key_exists('username', $config)) {
             ...
             */
            //require_once 'IfwZend/Db/Adapter/Exception.php';
            throw new IfwZend_Db_Adapter_Exception("Configuration array must have a key for 'username' for login credentials.
                                                If Windows Authentication is desired, both keys 'username' and 'password' should be ommited from config.");
        }
    }
    ...
    public function setTransactionIsolationLevel($level = null)
    {
        ...
        switch ($level) {
            ...
            default:
                //require_once 'IfwZend/Db/Adapter/Sqlsrv/Exception.php';
                throw new IfwZend_Db_Adapter_Sqlsrv_Exception("Invalid transaction isolation level mode '$level' specified");
        }

        if (!sqlsrv_query($this->_connection, "SET TRANSACTION ISOLATION LEVEL $sql;")) {
            //require_once 'IfwZend/Db/Adapter/Sqlsrv/Exception.php';
            throw new IfwZend_Db_Adapter_Sqlsrv_Exception("Transaction cannot be changed to '$level'");
        }
     ...
     * @return IfwZend_Db_Statement_Sqlsrv
     */
    public function prepare($sql)
    {
        ...
        if (!class_exists($stmtClass)) {
            ...
            Ifw_Zend_Loader::loadClass($stmtClass);
        }
    ...
    public function describeTable($tableName, $schemaName = null)
    {
        ...
        $primaryKeysResult = $stmt->fetchAll(IfwZend_Db::FETCH_NUM);
    ...
    {
        switch ($mode) {
            case IfwZend_Db::FETCH_NUM:   // seq array
            case IfwZend_Db::FETCH_ASSOC: // assoc array
            case IfwZend_Db::FETCH_BOTH:  // seq+assoc array
            case IfwZend_Db::FETCH_OBJ:   // object
                $this->_fetchMode = $mode;
                break;
            case IfwZend_Db::FETCH_BOUND: // bound to PHP variable
                //require_once 'IfwZend/Db/Adapter/Sqlsrv/Exception.php';
                throw new IfwZend_Db_Adapter_Sqlsrv_Exception('FETCH_BOUND is not supported yet');
                break;
            default:
                //require_once 'IfwZend/Db/Adapter/Sqlsrv/Exception.php';
                throw new IfwZend_Db_Adapter_Sqlsrv_Exception("Invalid fetch mode '$mode' specified");
                break;
        }
    }
     ...
     */
     public function limit($sql, $count, $offset = 0)
     {
        ...
        if ($count <= 0) {
            //require_once 'IfwZend/Db/Adapter/Exception.php';
            throw new IfwZend_Db_Adapter_Exception("LIMIT argument count=$count is not valid");
        }
        ...
        if ($offset < 0) {
            /** @see IfwZend_Db_Adapter_Exception */
            //require_once 'IfwZend/Db/Adapter/Exception.php';
            throw new IfwZend_Db_Adapter_Exception("LIMIT argument offset=$offset is not valid");
        }
