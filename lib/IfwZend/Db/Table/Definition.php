 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Db_Table_Definition
{
     ...
     * @return IfwZend_Db_Table_Definition
     */
    ...
    {
        // @todo logic here
        $tableConfig[IfwZend_Db_Table::DEFINITION_CONFIG_NAME] = $tableName;
        $tableConfig[IfwZend_Db_Table::DEFINITION] = $this;

        if (!isset($tableConfig[IfwZend_Db_Table::NAME])) {
            $tableConfig[IfwZend_Db_Table::NAME] = $tableName;
        }
