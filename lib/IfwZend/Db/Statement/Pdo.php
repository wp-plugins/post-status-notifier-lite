 ...
 * are re-thrown as IfwZend_Db_Statement_Exception.
 *
 * @category   Zend
 * @package    IfwZend_Db
 * @subpackage Statement
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Db_Statement_Pdo extends IfwZend_Db_Statement implements IteratorAggregate
{
    ...
    public function _execute(array $params = null)
    {
        try {
            ...
            //require_once 'IfwZend/Db/Statement/Exception.php';
            throw new IfwZend_Db_Statement_Exception($e->getMessage(), (int) $e->getCode(), $e);
        }
    }
