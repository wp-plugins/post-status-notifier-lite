 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Db_Statement_Oracle extends IfwZend_Db_Statement
{
     ...
     * @param string $sql
     * @return void
     * @throws IfwZend_Db_Statement_Oracle_Exception
     */
    protected function _prepare($sql)
    {
        ...
        if (!$this->_stmt) {
            /**
             * @see IfwZend_Db_Statement_Oracle_Exception
             */
            //require_once 'IfwZend/Db/Statement/Oracle/Exception.php';
            throw new IfwZend_Db_Statement_Oracle_Exception(oci_error($connection));
        }
    }
    ...
    protected function _bindParam($parameter, &$variable, $type = null, $length = null, $options = null)
    {
        ...
        if ($retval === false) {
             ...
             */
            //require_once 'IfwZend/Db/Statement/Oracle/Exception.php';
            throw new IfwZend_Db_Statement_Oracle_Exception(oci_error($this->_stmt));
        }
    ...
    public function fetch($style = null, $cursor = null, $offset = null)
    {
        ...
        switch ($style) {
            ...
            default:
                 ...
                 */
                //require_once 'IfwZend/Db/Statement/Oracle/Exception.php';
                throw new IfwZend_Db_Statement_Oracle_Exception(
                    array(
                        'code'    => 'HYC00',
        ...
        if (! $row && $error = oci_error($this->_stmt)) {
             ...
             */
            //require_once 'IfwZend/Db/Statement/Oracle/Exception.php';
            throw new IfwZend_Db_Statement_Oracle_Exception($error);
        }
    ...
    public function fetchAll($style = null, $col = 0)
    {
        ...
        $result = Array();
        if ($flags != OCI_FETCHSTATEMENT_BY_ROW) { /* not IfwZend_Db::FETCH_OBJ */
            ...
            if ($style == IfwZend_Db::FETCH_COLUMN) {
                $result = $result[$col];
            }
