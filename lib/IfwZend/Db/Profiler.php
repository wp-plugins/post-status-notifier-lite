...
class IfwZend_Db_Profiler
{
    ...
    /**
     * Array of IfwZend_Db_Profiler_Query objects.
     *
     * @var array
     */
     ...
     * @return IfwZend_Db_Profiler Provides a fluent interface
     */
     ...
     * the IfwZend_Db_Profiler::* constants to only save profiles for that type of
     ...
     *
     * @return integer|null
     * @see    IfwZend_Db_Profiler::setFilterQueryType()
     */
     ...
     */
    public function queryClone(IfwZend_Db_Profiler_Query $query)
    {
    ...
    /**
     * Starts a query.  Creates a new query profile object (IfwZend_Db_Profiler_Query)
     ...
     * @param  integer $queryType   OPTIONAL Type of query, one of the IfwZend_Db_Profiler::* constants
     * @return integer|null
     */
    public function queryStart($queryText, $queryType = null)
    {
        ...
        /**
         * @see IfwZend_Db_Profiler_Query
         */
        //require_once 'IfwZend/Db/Profiler/Query.php';
        $this->_queryProfiles[] = new IfwZend_Db_Profiler_Query($queryText, $queryType);
     ...
     *
     * @param  integer $queryId
     * @throws IfwZend_Db_Profiler_Exception
     * @return void
     */
    public function queryEnd($queryId)
    {
        // Don't do anything if the IfwZend_Db_Profiler is not enabled.
        if (!$this->_enabled) {
            return self::IGNORED;
        }
        ...
        if (!isset($this->_queryProfiles[$queryId])) {
            /**
             * @see IfwZend_Db_Profiler_Exception
             */
            //require_once 'IfwZend/Db/Profiler/Exception.php';
            throw new IfwZend_Db_Profiler_Exception("Profiler has no query with handle '$queryId'.");
        }
        ...
        if ($qp->hasEnded()) {
             ...
             */
            //require_once 'IfwZend/Db/Profiler/Exception.php';
            throw new IfwZend_Db_Profiler_Exception("Query with profiler handle '$queryId' has already ended.");
        }
     ...
     * by queryStart() and it will return a IfwZend_Db_Profiler_Query object.
     *
     * @param  integer $queryId
     * @throws IfwZend_Db_Profiler_Exception
     * @return IfwZend_Db_Profiler_Query
     */
    public function getQueryProfile($queryId)
    {
        if (!array_key_exists($queryId, $this->_queryProfiles)) {
             ...
             */
            //require_once 'IfwZend/Db/Profiler/Exception.php';
            throw new IfwZend_Db_Profiler_Exception("Query handle '$queryId' not found in profiler log.");
        }
    ...
    /**
     * Get an array of query profiles (IfwZend_Db_Profiler_Query objects).  If $queryType
     * is set to one of the IfwZend_Db_Profiler::* constants then only queries of that
     ...
     * one or more of the IfwZend_Db_Profiler::* constants, the elapsed time will be calculated
     ...
     * be counted.  If $queryType is set to one of the IfwZend_Db_Profiler::* constants, only queries of
    ...
    /**
     * Get the IfwZend_Db_Profiler_Query object for the last query that was run, regardless if it has
     * ended or not.  If the query has not ended, its end time will be null.  If no queries have
     * been profiled, false is returned.
     *
     * @return IfwZend_Db_Profiler_Query|false
     */
