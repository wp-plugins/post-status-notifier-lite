...
/**
 * IfwZend_Controller_Request_Apache404
 *
 * HTTP request object for use with IfwZend_Controller family. Extends basic HTTP
 ...
 * @subpackage Request
 */
class IfwZend_Controller_Request_Apache404 extends IfwZend_Controller_Request_Http
{
