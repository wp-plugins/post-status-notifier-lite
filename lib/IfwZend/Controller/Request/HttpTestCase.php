...
/**
 * @see IfwZend_Controller_Request_Http
 */
//require_once 'IfwZend/Controller/Request/Http.php';

/**
 * IfwZend_Controller_Request_HttpTestCase
 *
 * HTTP request object for use with IfwZend_Controller family.
 *
 * @uses IfwZend_Controller_Request_Http
 * @package IfwZend_Controller
 * @subpackage Request
 */
class IfwZend_Controller_Request_HttpTestCase extends IfwZend_Controller_Request_Http
{
    /**
     * Request headers
     * @var array
     ...
     * Clear GET values
     *
     * @return IfwZend_Controller_Request_HttpTestCase
     */
    ...
    public function setMethod($type)
    {
        ...
        if (!in_array($type, $this->_validMethodTypes)) {
            ...
            throw new IfwZend_Controller_Exception('Invalid request method specified');
        }
        $this->_method = $type;
        return $this;
    }
