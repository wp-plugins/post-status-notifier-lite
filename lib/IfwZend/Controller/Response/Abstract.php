 ...
 *
 * Base class for IfwZend_Controller responses
 *
 * @package IfwZend_Controller
 * @subpackage Response
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwZend_Controller_Response_Abstract
{
    /**
     * Body content
     * @var array
    ...
    public function setHttpResponseCode($code)
    {
        if (!is_int($code) || (100 > $code) || (599 < $code)) {
            //require_once 'IfwZend/Controller/Response/Exception.php';
            throw new IfwZend_Controller_Response_Exception('Invalid HTTP response code');
        }
     ...
     * @return boolean
     * @throws IfwZend_Controller_Response_Exception
     */
    public function canSendHeaders($throw = false)
    {
        ...
        if ($ok && $throw && $this->headersSentThrowsException) {
            //require_once 'IfwZend/Controller/Response/Exception.php';
            throw new IfwZend_Controller_Response_Exception('Cannot send headers; headers already sent in ' . $file . ', line ' . $line);
        }
    ...
    public function append($name, $content)
    {
        if (!is_string($name)) {
            //require_once 'IfwZend/Controller/Response/Exception.php';
            throw new IfwZend_Controller_Response_Exception('Invalid body segment key ("' . gettype($name) . '")');
        }
    ...
    public function insert($name, $content, $parent = null, $before = false)
    {
        ...
        if ((null !== $parent) && !is_string($parent)) {
            //require_once 'IfwZend/Controller/Response/Exception.php';
            throw new IfwZend_Controller_Response_Exception('Invalid body segment parent key ("' . gettype($parent) . '")');
        }
