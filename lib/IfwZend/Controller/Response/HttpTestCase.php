...
/**
 * @see IfwZend_Controller_Response_Http
 */
//require_once 'IfwZend/Controller/Response/Http.php';

/**
 * IfwZend_Controller_Response_HttpTestCase
 *
 * @uses IfwZend_Controller_Response_Http
 * @package IfwZend_Controller
 * @subpackage Response
 */
class IfwZend_Controller_Response_HttpTestCase extends IfwZend_Controller_Response_Http
{
    /**
