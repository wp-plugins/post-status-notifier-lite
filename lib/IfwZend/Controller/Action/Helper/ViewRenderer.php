 ...
 *
 * IfwZend_Controller_Action_Helper_ViewRenderer provides transparent view
 ...
 * <code>
 * // In your bootstrap:
 * IfwZend_Controller_Action_HelperBroker::addHelper(new IfwZend_Controller_Action_Helper_ViewRenderer());
 *
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Controller_Action_Helper_ViewRenderer extends IfwZend_Controller_Action_Helper_Abstract
{
    /**
     ...
     * @return void
     */
    public function __construct(IfwZend_View_Interface $view = null, array $options = array())
    {
        if (null !== $view) {
            $this->setView($view);
        }
    ...
    public function getModuleDirectory()
    {
        ...
        if ((null === $moduleDir) || is_array($moduleDir)) {
            ...
            throw new IfwZend_Controller_Action_Exception('ViewRenderer cannot locate module directory for module "' . $module . '"');
        }
    ...
    public function getInflector()
    {
        if (null === $this->_inflector) {
            /**
             * @see IfwZend_Filter_Inflector
             */
            //require_once 'IfwZend/Filter/Inflector.php';
            /**
             * @see IfwZend_Filter_PregReplace
             */
            //require_once 'IfwZend/Filter/PregReplace.php';
            /**
             * @see IfwZend_Filter_Word_UnderscoreToSeparator
             */
            //require_once 'IfwZend/Filter/Word/UnderscoreToSeparator.php';
            $this->_inflector = new IfwZend_Filter_Inflector();
            $this->_inflector->setStaticRuleReference('moduleDir', $this->_moduleDir) // moduleDir must be specified before the less specific 'module'
                 ->addRules(array(
                     ...
                     ':controller' => array('Word_CamelCaseToDash', new IfwZend_Filter_Word_UnderscoreToSeparator('/'), 'StringToLower', new IfwZend_Filter_PregReplace('/\./', '-')),
                     ':action'     => array('Word_CamelCaseToDash', new IfwZend_Filter_PregReplace('#[^a-z0-9' . preg_quote('/', '#') . ']+#i', '-'), 'StringToLower'),
                 ))
     ...
     * @return IfwZend_Controller_Action_Helper_ViewRenderer Provides a fluent interface
     */
    public function setInflector(IfwZend_Filter_Inflector $inflector, $reference = false)
    {
    ...
    public function initView($path = null, $prefix = null, array $options = array())
    {
        ...
        if (empty($path)) {
            ...
            if (empty($path)) {
                 ...
                 */
                //require_once 'IfwZend/Controller/Action/Exception.php';
                throw new IfwZend_Controller_Action_Exception('ViewRenderer initialization failed: retrieved view base path is empty');
            }
        }
