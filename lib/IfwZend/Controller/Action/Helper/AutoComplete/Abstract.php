 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwZend_Controller_Action_Helper_AutoComplete_Abstract extends IfwZend_Controller_Action_Helper_Abstract
{
    /**
     ...
     *
     * @return IfwZend_Controller_Action_Helper_AutoComplete_Abstract Provides a fluent interface
     */
    public function disableLayouts()
    {
        ...
        if (null !== ($layout = IfwZend_Layout::getMvcInstance())) {
    ...
    public function encodeJson($data, $keepLayouts = false)
    {
        if ($this->validateData($data)) {
            return IfwZend_Controller_Action_HelperBroker::getStaticHelper('Json')->encodeJson($data, $keepLayouts);
        }
