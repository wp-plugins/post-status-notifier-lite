...
/**
 * @see IfwZend_Controller_Action_Helper_Abstract
 */
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Controller_Action_Helper_ContextSwitch extends IfwZend_Controller_Action_Helper_Abstract
{
    /**
    ...
    /**
     * @var IfwZend_Controller_Action_Helper_ViewRenderer
     */
     ...
     *
     * @param  array $options
     * @return IfwZend_Controller_Action_Helper_ContextSwitch Provides a fluent interface
     */
    ...
    public function initContext($format = null)
    {
        ...
        if (null !== ($callback = $this->getCallback($context, self::TRIGGER_INIT))) {
            if (is_string($callback) && method_exists($this, $callback)) {
                ...
                throw new IfwZend_Controller_Action_Exception(sprintf('Invalid context callback registered for context "%s"', $context));
            }
        }
    ...
    public function initJsonContext()
    {
        ...
        if ($view instanceof IfwZend_View_Interface) {
            ...
            if (is_string($suffixInfo)) {
                ...
                switch (true) {
                    case (($count < 2) && (null === $context)):
                         ...
                         */
                        //require_once 'IfwZend/Controller/Action/Exception.php';
                        throw new IfwZend_Controller_Action_Exception('Invalid suffix information provided in config');
                    case ($count < 2):
    ...
    public function setSuffix($context, $suffix, $prependViewRendererSuffix = true)
    {
        if (!isset($this->_contexts[$context])) {
             ...
             */
            //require_once 'IfwZend/Controller/Action/Exception.php';
            throw new IfwZend_Controller_Action_Exception(sprintf('Cannot set suffix; invalid context type "%s"', $context));
        }
    ...
    public function getSuffix($type)
    {
        if (!isset($this->_contexts[$type])) {
             ...
             */
            //require_once 'IfwZend/Controller/Action/Exception.php';
            throw new IfwZend_Controller_Action_Exception(sprintf('Cannot retrieve suffix; invalid context type "%s"', $type));
        }
     ...
     * @throws IfwZend_Controller_Action_Exception if context does not exist and throwException is true
     * @return bool
     */
    public function hasContext($context, $throwException = false)
    {
        ...
        if ($throwException) {
             ...
             */
            //require_once 'IfwZend/Controller/Action/Exception.php';
            throw new IfwZend_Controller_Action_Exception(sprintf('Context "%s" does not exist', $context));
        }
    ...
    public function addHeader($context, $header, $content)
    {
        ...
        if (isset($this->_contexts[$context]['headers'][$header])) {
             ...
             */
            //require_once 'IfwZend/Controller/Action/Exception.php';
            throw new IfwZend_Controller_Action_Exception(sprintf('Cannot add "%s" header to context "%s": already exists', $header, $context));
        }
    ...
    protected function _validateTrigger($trigger)
    {
        ...
        if (!in_array($trigger, array(self::TRIGGER_INIT, self::TRIGGER_POST))) {
             ...
             */
            //require_once 'IfwZend/Controller/Action/Exception.php';
            throw new IfwZend_Controller_Action_Exception(sprintf('Invalid trigger "%s"', $trigger));
        }
    ...
    public function setCallback($context, $trigger, $callback)
    {
        ...
        if (!is_string($callback)) {
            if (!is_array($callback) || (2 != count($callback))) {
                 ...
                 */
                //require_once 'IfwZend/Controller/Action/Exception.php';
                throw new IfwZend_Controller_Action_Exception('Invalid callback specified');
            }
        }
    ...
    public function setDefaultContext($type)
    {
        if (!isset($this->_contexts[$type])) {
             ...
             */
            //require_once 'IfwZend/Controller/Action/Exception.php';
            throw new IfwZend_Controller_Action_Exception(sprintf('Cannot set default context; invalid context type "%s"', $type));
        }
    ...
    public function addContext($context, array $spec)
    {
        if ($this->hasContext($context)) {
             ...
             */
            //require_once 'IfwZend/Controller/Action/Exception.php';
            throw new IfwZend_Controller_Action_Exception(sprintf('Cannot add context "%s"; already exists', $context));
        }
        $context = (string) $context;
        ...
        if (null !== $context) {
            if (null !== ($callback = $this->getCallback($context, self::TRIGGER_POST))) {
                if (is_string($callback) && method_exists($this, $callback)) {
                     ...
                     */
                    //require_once 'IfwZend/Controller/Action/Exception.php';
                    throw new IfwZend_Controller_Action_Exception(sprintf('Invalid postDispatch context callback registered for context "%s"', $context));
                }
            }
        }
    }
    ...
    public function postJsonContext()
    {
        ...
        if ($view instanceof IfwZend_View_Interface) {
            ...
            if(method_exists($view, 'getVars')) {
                ...
                $vars = IfwZend_Json::encode($view->getVars());
                $this->getResponse()->setBody($vars);
            } else {
                //require_once 'IfwZend/Controller/Action/Exception.php';
                throw new IfwZend_Controller_Action_Exception('View does not implement the getVars() method needed to encode the view into JSON');
            }
        }
    }
     ...
     * @return IfwZend_Controller_Action_Helper_ContextSwitch|void Provides a fluent interface
     */
    ...
    public function hasActionContext($action, $context)
    {
        ...
        if (!is_array($allContexts)) {
             ...
             */
            //require_once 'IfwZend/Controller/Action/Exception.php';
            throw new IfwZend_Controller_Action_Exception("Invalid contexts found for controller");
        }
        ...
        if (!is_array($contexts)) {
             ...
             */
            //require_once 'IfwZend/Controller/Action/Exception.php';
            throw new IfwZend_Controller_Action_Exception(sprintf("Invalid contexts found for action '%s'", $action));
        }
     ...
     *
     * @return IfwZend_Controller_Action_Helper_ViewRenderer Provides a fluent interface
     */
    protected function _getViewRenderer()
    {
        if (null === $this->_viewRenderer) {
            $this->_viewRenderer = IfwZend_Controller_Action_HelperBroker::getStaticHelper('viewRenderer');
        }
