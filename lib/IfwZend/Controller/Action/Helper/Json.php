 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Controller_Action_Helper_Json extends IfwZend_Controller_Action_Helper_Abstract
{
    /**
     ...
     *         if $keepLayouts and parmas for IfwZend_Json::encode are required
     *         then, the array can contains a 'keepLayout'=>true|false
     *         that will not be passed to IfwZend_Json::encode method but will be passed
     *         to IfwZend_View_Helper_Json
     * @throws IfwZend_Controller_Action_Helper_Json
     * @return string
     */
    public function encodeJson($data, $keepLayouts = false)
    {
        /**
         * @see IfwZend_View_Helper_Json
         */
        //require_once 'IfwZend/View/Helper/Json.php';
        $jsonHelper = new IfwZend_View_Helper_Json();
        ...
        if (!$keepLayouts) {
            ...
            IfwZend_Controller_Action_HelperBroker::getStaticHelper('viewRenderer')->setNoRender(true);
        }
