 ...
 * @version    $Id$
 */
class IfwZend_Controller_Action_Helper_FlashMessenger extends IfwZend_Controller_Action_Helper_Abstract implements IteratorAggregate, Countable
{
    /**
    ...
    /**
     * $_session - IfwZend_Session storage object
     *
     * @var IfwZend_Session
     */
    ...
    {
        if (!self::$_session instanceof IfwZend_Session_Namespace) {
            self::$_session = new IfwZend_Session_Namespace($this->getName());
     ...
     *
     * @return IfwZend_Controller_Action_Helper_FlashMessenger Provides a fluent interface
     */
