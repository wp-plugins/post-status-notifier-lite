...
/**
 * @see IfwZend_Cache_Manager
 */
//require_once 'IfwZend/Cache/Manager.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Controller_Action_Helper_Cache
    extends IfwZend_Controller_Action_Helper_Abstract
{

    /**
     * Local Cache Manager object used by Helper
     *
     * @var IfwZend_Cache_Manager
     */
    ...
    {
        $cache = $this->getCache(IfwZend_Cache_Manager::PAGECACHE);
        if ($recursive) {
            $backend = $cache->getBackend();
            if (($backend instanceof IfwZend_Cache_Backend)
    ...
    {
        return $this->getCache(IfwZend_Cache_Manager::PAGECACHE)
            ->clean(IfwZend_Cache::CLEANING_MODE_MATCHING_ANY_TAG, $tags);
    }
    ...
    public function preDispatch()
    {
        ...
        foreach ($stats as $status) {
            if ($status['name'] == 'IfwZend_Cache_Frontend_Page::_flush'
            || $status['name'] == 'IfwZend_Cache_Frontend_Capture::_flush') {
                $obStarted = true;
            }
        }
        ...
        in_array($action, $this->_caching[$controller])) {
            ...
            $this->getCache(IfwZend_Cache_Manager::PAGECACHE)
     ...
     *
     * @param IfwZend_Cache_Manager $manager
     * @return void
     */
    public function setManager(IfwZend_Cache_Manager $manager)
    {
    ...
    public function getManager()
    {
        ...
        $this->_manager = new IfwZend_Cache_Manager;
        return $this->_manager;
    }
    ...
    /**
     * Proxy non-matched methods back to IfwZend_Cache_Manager where
     * appropriate
     *
     * @param string $method
     * @param array $args
    ...
    public function __call($method, $args)
    {
        ...
        throw new IfwZend_Controller_Action_Exception('Method does not exist:'
            . $method);
    }
