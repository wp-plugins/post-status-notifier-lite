 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Controller_Action_Helper_Redirector extends IfwZend_Controller_Action_Helper_Abstract
{
    /**
     ...
     *
     * @param  int $code
     * @throws IfwZend_Controller_Action_Exception on invalid HTTP status code
     * @return true
     */
    protected function _checkCode($code)
    {
        ...
        if ((300 > $code) || (307 < $code) || (304 == $code) || (306 == $code)) {
            ...
            throw new IfwZend_Controller_Action_Exception('Invalid redirect HTTP status code (' . $code  . ')');
        }
     ...
     *
     * @param  int $code
     * @return IfwZend_Controller_Action_Helper_Redirector Provides a fluent interface
     */
    ...
    public function redirectAndExit()
    {
        if ($this->getCloseSessionOnExit()) {
            ...
            if (class_exists('IfwZend_Session', false) && IfwZend_Session::isStarted()) {
     ...
     * @param  array $args
     * @return mixed
     * @throws IfwZend_Controller_Action_Exception for invalid methods
     */
    public function __call($method, $args)
    {
        ...
        //require_once 'IfwZend/Controller/Action/Exception.php';
        throw new IfwZend_Controller_Action_Exception(sprintf('Invalid method "%s" called on redirector', $method));
    }
}
