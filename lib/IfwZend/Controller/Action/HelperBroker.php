...
/**
 * @see IfwZend_Controller_Action_HelperBroker_PriorityStack
 */
//require_once 'IfwZend/Controller/Action/HelperBroker/PriorityStack.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Controller_Action_HelperBroker
{
    /**
     * $_actionController - ActionController reference
     *
     * @var IfwZend_Controller_Action
     */
     ...
     *
     * @var IfwZend_Controller_Action_HelperBroker_PriorityStack
     */
    ...
    {
        if ((null !== $loader) && (!$loader instanceof IfwZend_Loader_PluginLoader_Interface)) {
            //require_once 'IfwZend/Controller/Action/Exception.php';
            throw new IfwZend_Controller_Action_Exception('Invalid plugin loader provided to HelperBroker');
        }
    ...
    public static function getPluginLoader()
    {
        if (null === self::$_pluginLoader) {
            ...
            self::$_pluginLoader = new IfwZend_Loader_PluginLoader(array(
                'IfwZend_Controller_Action_Helper' => 'IfwZend/Controller/Action/Helper/',
            ));
        }
     ...
     *
     * @param string $path
     * @param string $prefix Optional; defaults to 'IfwZend_Controller_Action_Helper'
     * @return void
     */
    static public function addPath($path, $prefix = 'IfwZend_Controller_Action_Helper')
    {
        self::getPluginLoader()->addPrefixPath($prefix, $path);
    }
     ...
     *
     * @param IfwZend_Controller_Action_Helper_Abstract $helper
     * @return void
     */
    static public function addHelper(IfwZend_Controller_Action_Helper_Abstract $helper)
    {
    ...
    public static function getExistingHelper($name)
    {
        ...
        if (!isset($stack->{$name})) {
            //require_once 'IfwZend/Controller/Action/Exception.php';
            throw new IfwZend_Controller_Action_Exception('Action helper "' . $name . '" has not been registered with the helper broker');
        }
     ...
     *
     * @return IfwZend_Controller_Action_HelperBroker_PriorityStack
     */
    public static function getStack()
    {
        if (self::$_stack == null) {
            self::$_stack = new IfwZend_Controller_Action_HelperBroker_PriorityStack();
        }
     ...
     * @return void
     */
    public function __construct(IfwZend_Controller_Action $actionController)
    {
     ...
     * @param  array $args
     * @return mixed
     * @throws IfwZend_Controller_Action_Exception if helper does not have a direct() method
     */
    public function __call($method, $args)
    {
        ...
        if (!method_exists($helper, 'direct')) {
            //require_once 'IfwZend/Controller/Action/Exception.php';
            throw new IfwZend_Controller_Action_Exception('Helper "' . $method . '" does not support overloading via direct()');
        }
    ...
    protected static function _loadHelper($name)
    {
        ...
        } catch (IfwZend_Loader_PluginLoader_Exception $e) {
            //require_once 'IfwZend/Controller/Action/Exception.php';
            throw new IfwZend_Controller_Action_Exception('Action Helper by name ' . $name . ' not found', 0, $e);
        }

        $helper = new $class();

        if (!$helper instanceof IfwZend_Controller_Action_Helper_Abstract) {
            //require_once 'IfwZend/Controller/Action/Exception.php';
            throw new IfwZend_Controller_Action_Exception('Helper name ' . $name . ' -> class ' . $class . ' is not of type IfwZend_Controller_Action_Helper_Abstract');
        }
