...
/** IfwZend_Controller_Router_Route_Abstract */
//require_once 'IfwZend/Controller/Router/Route/Abstract.php';
 ...
 */
class IfwZend_Controller_Router_Route extends IfwZend_Controller_Router_Route_Abstract
{
    /**
     * Default translator
     *
    ...
    {
        $reqs = ($config->reqs instanceof IfwZend_Config) ? $config->reqs->toArray() : array();
        $defs = ($config->defaults instanceof IfwZend_Config) ? $config->defaults->toArray() : array();
     ...
     * @param IfwZend_Translate $translator Translator to use for this instance
     */
    public function __construct($route, $defaults = array(), $reqs = array(), IfwZend_Translate $translator = null, $locale = null)
    {
        ...
        foreach ($this->_parts as $key => $part) {
            ...
            if (isset($name)) {
                if (isset($data[$name]) && !$useDefault) {
                    ...
                    throw new IfwZend_Controller_Router_Exception($name . ' is not specified');
                }
     ...
     *
     * @param  IfwZend_Translate $translator
     * @return void
     */
    public static function setDefaultTranslator(IfwZend_Translate $translator = null)
    {
     ...
     * @return void
     */
    public function setTranslator(IfwZend_Translate $translator)
    {
        $this->_translator = $translator;
    }
     ...
     * Get the translator
     *
     * @throws IfwZend_Controller_Router_Exception When no translator can be found
     * @return IfwZend_Translate
     */
    public function getTranslator()
    {
        if ($this->_translator !== null) {
            ...
            if ($translator instanceof IfwZend_Translate) {
                return $translator;
            }
        }

        //require_once 'IfwZend/Controller/Router/Exception.php';
        throw new IfwZend_Controller_Router_Exception('Could not find a translator');
    }
