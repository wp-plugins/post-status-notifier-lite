...
/** IfwZend_Controller_Router_Abstract */
//require_once 'IfwZend/Controller/Router/Abstract.php';

/** IfwZend_Controller_Router_Route */
//require_once 'IfwZend/Controller/Router/Route.php';
 ...
 */
class IfwZend_Controller_Router_Rewrite extends IfwZend_Controller_Router_Abstract
{
     ...
     *
     * @var IfwZend_Controller_Router_Route_Interface
     */
     ...
     *
     * @return IfwZend_Controller_Router_Rewrite
     */
    public function addDefaultRoutes()
    {
        if (!$this->hasRoute('default')) {
            ...
            //require_once 'IfwZend/Controller/Router/Route/Module.php';
            $compat = new IfwZend_Controller_Router_Route_Module(array(), $dispatcher, $request);
     ...
     * @param  IfwZend_Controller_Router_Route_Interface $route      Instance of the route
     * @return IfwZend_Controller_Router_Rewrite
     */
    public function addRoute($name, IfwZend_Controller_Router_Route_Interface $route)
    {
    ...
    /**
     * Create routes out of IfwZend_Config configuration
     *
     * Example INI:
     ...
     *
     * routes.news.type = "IfwZend_Controller_Router_Route_Static"
     * routes.news.route = "news"
     * routes.news.defaults.controller = "news"
     * routes.news.defaults.action = "list"
     *
     * And finally after you have created a IfwZend_Config with above ini:
     * $router = new IfwZend_Controller_Router_Rewrite();
     * $router->addConfig($config, 'routes');
     *
     * @param  IfwZend_Config $config  Configuration object
     * @param  string      $section Name of the config section containing route's definitions
     * @throws IfwZend_Controller_Router_Exception
     * @return IfwZend_Controller_Router_Rewrite
     */
    public function addConfig(IfwZend_Config $config, $section = null)
    {
        if ($section !== null) {
            if ($config->{$section} === null) {
                //require_once 'IfwZend/Controller/Router/Exception.php';
                throw new IfwZend_Controller_Router_Exception("No route configuration in section '{$section}'");
            }
        ...
        foreach ($config as $name => $info) {
            ...
            if ($route instanceof IfwZend_Controller_Router_Route_Chain) {
                if (!isset($info->chain)) {
                    //require_once 'IfwZend/Controller/Router/Exception.php';
                    throw new IfwZend_Controller_Router_Exception("No chain defined");
                }

                if ($info->chain instanceof IfwZend_Config) {
                ...
                $this->addRoute($name, $route);
            } elseif (isset($info->chains) && $info->chains instanceof IfwZend_Config) {
     ...
     *
     * @param  IfwZend_Config $info
     * @return IfwZend_Controller_Router_Route_Interface
     */
    protected function _getRouteFromConfig(IfwZend_Config $info)
    {
        $class = (isset($info->type)) ? $info->type : 'IfwZend_Controller_Router_Route';
     ...
     *
     * @param  string                                 $name
     * @param  IfwZend_Controller_Router_Route_Interface $route
     * @param  IfwZend_Config                            $childRoutesInfo
     * @return void
     */
    protected function _addChainRoutesFromConfig($name,
                                                 IfwZend_Controller_Router_Route_Interface $route,
                                                 IfwZend_Config $childRoutesInfo)
    {
    ...
    public function removeRoute($name)
    {
        if (!isset($this->_routes[$name])) {
            //require_once 'IfwZend/Controller/Router/Exception.php';
            throw new IfwZend_Controller_Router_Exception("Route $name is not defined");
        }
     ...
     * @param string $name Name of the route
     * @throws IfwZend_Controller_Router_Exception
     * @return IfwZend_Controller_Router_Route_Interface Route object
     */
    ...
    public function getCurrentRoute()
    {
        if (!isset($this->_currentRoute)) {
            //require_once 'IfwZend/Controller/Router/Exception.php';
            throw new IfwZend_Controller_Router_Exception("Current route is not defined");
        }
     ...
     *
     * @throws IfwZend_Controller_Router_Exception
     * @return IfwZend_Controller_Request_Abstract Request object
     */
    public function route(IfwZend_Controller_Request_Abstract $request)
    {
        if (!$request instanceof IfwZend_Controller_Request_Http) {
            //require_once 'IfwZend/Controller/Router/Exception.php';
            throw new IfwZend_Controller_Router_Exception('IfwZend_Controller_Router_Rewrite requires a IfwZend_Controller_Request_Http-based request object');
        }
        ...
        foreach (array_reverse($this->_routes, true) as $name => $route) {
         ...
         if (!$routeMatched) {
             //require_once 'IfwZend/Controller/Router/Exception.php';
             throw new IfwZend_Controller_Router_Exception('No route matched the request', 404);
         }
     ...
     * @return boolean|IfwZend_Controller_Router_Rewrite
     *              Returns a boolean if first param isn't set, returns an
     *              instance of IfwZend_Controller_Router_Rewrite otherwise.
     *
     */
