 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
interface IfwZend_Controller_Router_Interface
{
    /**
     * Processes a request and sets its controller and action.  If
     * no route was possible, an exception is thrown.
     *
     * @param  IfwZend_Controller_Request_Abstract
     * @throws IfwZend_Controller_Router_Exception
     * @return IfwZend_Controller_Request_Abstract|boolean
     */
    public function route(IfwZend_Controller_Request_Abstract $dispatcher);
