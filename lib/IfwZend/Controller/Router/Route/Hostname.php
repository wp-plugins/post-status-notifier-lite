 ...
 */
class IfwZend_Controller_Router_Route_Hostname extends IfwZend_Controller_Router_Route_Abstract
{
     ...
     * @return void
     */
    public function setRequest(IfwZend_Controller_Request_Abstract $request = null)
    {
    ...
    public function getRequest()
    {
        if ($this->_request === null) {
            ...
            $this->_request = IfwZend_Controller_Front::getInstance()->getRequest();
        }
     ...
     *
     * @param IfwZend_Controller_Request_Http $request Request to get the host from
