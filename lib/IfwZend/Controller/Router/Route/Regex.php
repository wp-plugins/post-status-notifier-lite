 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Controller_Router_Route_Regex extends IfwZend_Controller_Router_Route_Abstract
{
    ...
    public static function getInstance(IfwZend_Config $config)
    {
        ...
        $map = ($config->map instanceof IfwZend_Config) ? $config->map->toArray() : array();
    ...
    public function assemble($data = array(), $reset = false, $encode = false, $partial = false)
    {
        if ($this->_reverse === null) {
            ...
            throw new IfwZend_Controller_Router_Exception('Cannot assemble. Reversed route is not specified.');
        }
        ...
        if ($return === false) {
            //require_once 'IfwZend/Controller/Router/Exception.php';
            throw new IfwZend_Controller_Router_Exception('Cannot assemble. Too few arguments?');
        }
