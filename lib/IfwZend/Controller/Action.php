...
/**
 * @see IfwZend_Controller_Action_HelperBroker
 */
//require_once 'IfwZend/Controller/Action/HelperBroker.php';

/**
 * @see IfwZend_Controller_Action_Interface
 */
//require_once 'IfwZend/Controller/Action/Interface.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwZend_Controller_Action implements IfwZend_Controller_Action_Interface
{
    /**
    ...
    /**
     * IfwZend_Controller_Request_Abstract object wrapping the request environment
     * @var IfwZend_Controller_Request_Abstract
     */
    protected $_request = null;

    /**
     * IfwZend_Controller_Response_Abstract object wrapping the response
     ...
     *
     * @var IfwZend_Controller_Action_HelperBroker
     */
     ...
     * @return void
     */
    public function __construct(IfwZend_Controller_Request_Abstract $request, IfwZend_Controller_Response_Abstract $response, array $invokeArgs = array())
    {
        $this->setRequest($request)
             ->setResponse($response)
             ->_setInvokeArgs($invokeArgs);
        $this->_helper = new IfwZend_Controller_Action_HelperBroker($this);
        $this->init();
    }
     ...
     *
     * Initializes {@link $view} if not otherwise a IfwZend_View_Interface.
     *
     * If {@link $view} is not otherwise set, instantiates a new IfwZend_View
     ...
     * @throws IfwZend_Controller_Exception if base view directory does not exist
     */
    public function initView()
    {
        ...
        if (isset($this->view) && ($this->view instanceof IfwZend_View_Interface)) {
            return $this->view;
        }
        ...
        if (!file_exists($baseDir) || !is_dir($baseDir)) {
            ...
            throw new IfwZend_Controller_Exception('Missing base view directory ("' . $baseDir . '")');
        }

        //require_once 'IfwZend/View.php';
        $this->view = new IfwZend_View(array('basePath' => $baseDir));
     ...
     *
     * @see IfwZend_Controller_Response_Abstract::appendBody()
     ...
     * @param  bool $noController  Defaults to false; i.e. use controller name as subdir in which to search for view script
     * @return string
     * @throws IfwZend_Controller_Exception with bad $action
     */
    public function getViewScript($action = null, $noController = null)
    {
        ...
        if (null === $action) {
            ...
            //require_once 'IfwZend/Controller/Exception.php';
            throw new IfwZend_Controller_Exception('Invalid action specifier for view render');
        }

        if (null === $this->_delimiters) {
            $dispatcher = IfwZend_Controller_Front::getInstance()->getDispatcher();
     ...
     *
     * @return IfwZend_Controller_Request_Abstract
     */
     ...
     *
     * @return IfwZend_Controller_Response_Abstract
     */
     ...
     * @return IfwZend_Controller_Action_Helper_Abstract
     */
     ...
     *
     * @param IfwZend_Controller_Front $front
     * @return IfwZend_Controller_Action
     */
    public function setFrontController(IfwZend_Controller_Front $front)
    {
    ...
    public function getFrontController()
    {
        ...
        if (class_exists('IfwZend_Controller_Front')) {
        ...
        //require_once 'IfwZend/Controller/Exception.php';
        throw new IfwZend_Controller_Exception('Front controller class has not been loaded');
    }
     ...
     * {@link IfwZend_Controller_Front}, it may modify the
    ...
    public function __call($methodName, $args)
    {
        ...
        if ('Action' == substr($methodName, -6)) {
            ...
            throw new IfwZend_Controller_Action_Exception(sprintf('Action "%s" does not exist and was not trapped in __call()', $action), 404);
        }

        throw new IfwZend_Controller_Action_Exception(sprintf('Method "%s" does not exist and was not trapped in __call()', $methodName), 500);
    }
     ...
     * request.
     *
     * Returns a IfwZend_Controller_Response_Abstract object, instantiating one
     ...
     *
     * @param null|IfwZend_Controller_Request_Abstract $request Optional request
     * object to use
     * @param null|IfwZend_Controller_Response_Abstract $response Optional response
     * object to use
     * @return IfwZend_Controller_Response_Abstract
     */
    public function run(IfwZend_Controller_Request_Abstract $request = null, IfwZend_Controller_Response_Abstract $response = null)
    {
        if (null !== $request) {
            $this->setRequest($request);
        } else {
     ...
     *
     * Proxies to {@link IfwZend_Controller_Action_Helper_Redirector::gotoUrl()}.
     *
     * @param string $url
