...
/** IfwZend_Controller_Action_HelperBroker */
//require_once 'IfwZend/Controller/Action/HelperBroker.php';

/** IfwZend_Controller_Plugin_Broker */
//require_once 'IfwZend/Controller/Plugin/Broker.php';
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Controller_Front
{
    /**
     * Base URL
     * @var string
    ...
    /**
     * Instance of IfwZend_Controller_Dispatcher_Interface
    ...
    /**
     * Instance of IfwZend_Controller_Plugin_Broker
     * @var IfwZend_Controller_Plugin_Broker
     */
    protected $_plugins = null;

    /**
     * Instance of IfwZend_Controller_Request_Abstract
     * @var IfwZend_Controller_Request_Abstract
     */
    protected $_request = null;

    /**
     * Instance of IfwZend_Controller_Response_Abstract
    ...
    /**
     * Instance of IfwZend_Controller_Router_Interface
     * @var IfwZend_Controller_Router_Interface
     */
    ...
    {
        $this->_plugins = new IfwZend_Controller_Plugin_Broker();
    }
    ...
    public function resetInstance()
    {
        ...
        foreach ($reflection->getProperties() as $property) {
            ...
            switch ($name) {
                ...
                case '_invokeParams':
                    ...
                    break;
                case '_plugins':
                    $this->{$name} = new IfwZend_Controller_Plugin_Broker();
                    break;
        ...
        IfwZend_Controller_Action_HelperBroker::resetHelpers();
    }
     ...
     *
     * @param string|array $controllerDirectory Path to IfwZend_Controller_Action
     * controller classes or array of such paths
     * @return void
     * @throws IfwZend_Controller_Exception if called from an object instance
     */
     ...
     * @return IfwZend_Controller_Front
     * @throws IfwZend_Controller_Exception if directory not found or readable
     */
     ...
     *
     * @param string|array $directory Path to IfwZend_Controller_Action controller
    ...
    public function addModuleDirectory($path)
    {
        try{
            ...
            //require_once 'IfwZend/Controller/Exception.php';
            throw new IfwZend_Controller_Exception("Directory $path not readable", 0, $e);
        }
        foreach ($dir as $file) {
     ...
     *
     * @param string|IfwZend_Controller_Request_Abstract $request
     * @throws IfwZend_Controller_Exception if invalid request class
     * @return IfwZend_Controller_Front
     */
    public function setRequest($request)
    {
        if (is_string($request)) {
            if (!class_exists($request)) {
                //require_once 'IfwZend/Loader.php';
                Ifw_Zend_Loader::loadClass($request);
            }
            $request = new $request();
        }
        if (!$request instanceof IfwZend_Controller_Request_Abstract) {
            //require_once 'IfwZend/Controller/Exception.php';
            throw new IfwZend_Controller_Exception('Invalid request class');
        }
     ...
     *
     * @return null|IfwZend_Controller_Request_Abstract
     */
     ...
     *
     * @param string|IfwZend_Controller_Router_Interface $router
     * @throws IfwZend_Controller_Exception if invalid router class
     * @return IfwZend_Controller_Front
     */
    public function setRouter($router)
    {
        if (is_string($router)) {
            if (!class_exists($router)) {
                //require_once 'IfwZend/Loader.php';
                Ifw_Zend_Loader::loadClass($router);
            }
            $router = new $router();
        }

        if (!$router instanceof IfwZend_Controller_Router_Interface) {
            //require_once 'IfwZend/Controller/Exception.php';
            throw new IfwZend_Controller_Exception('Invalid router class');
        }
     ...
     *
     * Instantiates a IfwZend_Controller_Router_Rewrite object if no router currently set.
     *
     * @return IfwZend_Controller_Router_Interface
     */
    public function getRouter()
    {
        if (null == $this->_router) {
            //require_once 'IfwZend/Controller/Router/Rewrite.php';
            $this->setRouter(new IfwZend_Controller_Router_Rewrite());
        }
     ...
     * @param string $base
     * @return IfwZend_Controller_Front
     * @throws IfwZend_Controller_Exception for non-string $base
     */
    public function setBaseUrl($base = null)
    {
        if (!is_string($base) && (null !== $base)) {
            //require_once 'IfwZend/Controller/Exception.php';
            throw new IfwZend_Controller_Exception('Rewrite base must be a string');
        }
     ...
     * taking a IfwZend_Controller_Dispatcher_Token object, instantiating the controller, and
     * call the action method of the controller.
     *
     * @param IfwZend_Controller_Dispatcher_Interface $dispatcher
     * @return IfwZend_Controller_Front
     */
    public function setDispatcher(IfwZend_Controller_Dispatcher_Interface $dispatcher)
    {
     ...
     *
     * @return IfwZend_Controller_Dispatcher_Interface
     */
    public function getDispatcher()
    {
         ...
         */
        if (!$this->_dispatcher instanceof IfwZend_Controller_Dispatcher_Interface) {
            //require_once 'IfwZend/Controller/Dispatcher/Standard.php';
            $this->_dispatcher = new IfwZend_Controller_Dispatcher_Standard();
        }
     ...
     *
     * @param string|IfwZend_Controller_Response_Abstract $response
     * @throws IfwZend_Controller_Exception if invalid response class
     * @return IfwZend_Controller_Front
     */
    public function setResponse($response)
    {
        if (is_string($response)) {
            if (!class_exists($response)) {
                //require_once 'IfwZend/Loader.php';
                Ifw_Zend_Loader::loadClass($response);
            }
            $response = new $response();
        }
        if (!$response instanceof IfwZend_Controller_Response_Abstract) {
            //require_once 'IfwZend/Controller/Exception.php';
            throw new IfwZend_Controller_Exception('Invalid response class');
        }
     ...
     *
     * @return null|IfwZend_Controller_Response_Abstract
     */
     ...
     * Register a plugin.
     *
     * @param  IfwZend_Controller_Plugin_Abstract $plugin
     * @param  int $stackIndex Optional; stack index for plugin
     * @return IfwZend_Controller_Front
     */
    public function registerPlugin(IfwZend_Controller_Plugin_Abstract $plugin, $stackIndex = null)
    {
     ...
     * Unregister a plugin.
     *
     * @param  string|IfwZend_Controller_Plugin_Abstract $plugin Plugin class or object to unregister
     * @return IfwZend_Controller_Front
     */
     ...
     *
     * @param  string $class
     * @return false|IfwZend_Controller_Plugin_Abstract|array
     */
     ...
     * @return boolean|IfwZend_Controller_Front Used as a setter, returns object; as a getter, returns boolean
     */
