 ...
 * @version    $Id$
 */
class IfwZend_Controller_Plugin_ActionStack extends IfwZend_Controller_Plugin_Abstract
{
     ...
     * @var string
     */
    protected $_registryKey = 'IfwZend_Controller_Plugin_ActionStack';
     ...
     * Constructor
     *
     * @param  IfwZend_Registry $registry
     * @param  string $key
     * @return void
     */
    public function __construct(IfwZend_Registry $registry = null, $key = null)
    {
        if (null === $registry) {
            $registry = IfwZend_Registry::getInstance();
        }
     ...
     *
     * @param  IfwZend_Registry $registry
     * @return IfwZend_Controller_Plugin_ActionStack
     */
    public function setRegistry(IfwZend_Registry $registry)
    {
     ...
     *
     * @return false|IfwZend_Controller_Request_Abstract
     */
    public function popStack()
    {
        ...
        if (!$next instanceof IfwZend_Controller_Request_Abstract) {
            //require_once 'IfwZend/Controller/Exception.php';
            throw new IfwZend_Controller_Exception('ArrayStack should only contain request objects');
        }
     ...
     * @return void
     */
    public function forward(IfwZend_Controller_Request_Abstract $next)
    {
        $request = $this->getRequest();
