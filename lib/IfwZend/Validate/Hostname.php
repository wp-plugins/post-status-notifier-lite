...
/**
 * @see IfwZend_Validate_Ip
 */
//require_once 'IfwZend/Validate/Ip.php';

/**
 * Please note there are two standalone test scripts for testing IDN characters due to problems
 * with file encoding.
 *
 * The first is tests/IfwZend/Validate/HostnameTestStandalone.php which is designed to be run on
 * the command line.
 *
 * The second is tests/IfwZend/Validate/HostnameTestForm.php which is designed to be run via HTML
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_Hostname extends IfwZend_Validate_Abstract
{
    ...
    protected $_validIdns = array(
        ...
        'CN'  => 'Hostname/Cn.php',
        'COM' => 'IfwZend/Validate/Hostname/Com.php',
        ...
        'HK'  => 'IfwZend/Validate/Hostname/Cn.php',
        ...
        'JP'  => 'IfwZend/Validate/Hostname/Jp.php',
        ...
        'NET' => 'IfwZend/Validate/Hostname/Com.php',
        'NO'  => array(1 => '/^[\x{002d}0-9a-zàáä-éêñ-ôöøüčđńŋšŧž]{1,63}$/iu'),
        'NU'  => 'IfwZend/Validate/Hostname/Com.php',
        ...
        'TW'  => 'IfwZend/Validate/Hostname/Cn.php',
        ...
        '中国' => 'IfwZend/Validate/Hostname/Cn.php',
        '公司' => 'IfwZend/Validate/Hostname/Cn.php',
        '网络' => 'IfwZend/Validate/Hostname/Cn.php'
    );
     ...
     * @param IfwZend_Validate_Ip $ipValidator OPTIONAL
     * @return void
     ...
     *
     * @param array $options
     * @return IfwZend_Validate_Hostname
     */
     ...
     * @return void;
     */
    public function setIpValidator(IfwZend_Validate_Ip $ipValidator = null)
    {
        if ($ipValidator === null) {
            $ipValidator = new IfwZend_Validate_Ip();
        }
     ...
     *
     * @param  integer $allow
     * @return IfwZend_Validate_Hostname Provides a fluent interface
     */
     ...
     *
     * @param  string $value
     * @throws IfwZend_Validate_Exception if a fatal error occurs for validation process
     * @return boolean
     */
        ...
        if ((count($domainParts) > 1) && (strlen($value) >= 4) && (strlen($value) <= 254)) {
            ...
            do {
                ...
                if (preg_match('/([^.]{2,10})$/i', end($domainParts), $matches) ||
                     ...
                     * @see IfwZend_Validate_Hostname_Interface
                     */
