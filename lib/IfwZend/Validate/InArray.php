 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_InArray extends IfwZend_Validate_Abstract
{
     ...
     *
     * @param  array|IfwZend_Config $haystack
     * @return void
     */
    public function __construct($options)
    {
        if ($options instanceof IfwZend_Config) {
            ...
            throw new IfwZend_Validate_Exception('Array expected as parameter');
        } else {
            $count = func_num_args();
            $temp  = array();
            if ($count > 1) {
     ...
     * @return IfwZend_Validate_InArray Provides a fluent interface
     */
