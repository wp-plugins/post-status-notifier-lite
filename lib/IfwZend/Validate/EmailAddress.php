 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_EmailAddress extends IfwZend_Validate_Abstract
{
    ...
    protected $_options = array(
        ...
        'deep'     => false,
        'domain'   => true,
        'allow'    => IfwZend_Validate_Hostname::ALLOW_DNS,
        'hostname' => null
    );
     ...
     * 'hostname' => A hostname validator, see IfwZend_Validate_Hostname
     * 'allow'    => Options for the hostname validator, see IfwZend_Validate_Hostname::ALLOW_*
     * 'mx'       => If MX check should be enabled, boolean
     * 'deep'     => If a deep MX check should be done, boolean
     *
     * @param array|IfwZend_Config $options OPTIONAL
     * @return void
     */
     ...
     *
     * @param array $options
     * @return IfwZend_Validate_EmailAddress fluid interface
     */
     ...
     * @return IfwZend_Validate_Abstract Provides a fluent interface
    ...
    /**
     * @param IfwZend_Validate_Hostname $hostnameValidator OPTIONAL
     * @param int                    $allow             OPTIONAL
     * @return void
     */
    public function setHostnameValidator(IfwZend_Validate_Hostname $hostnameValidator = null, $allow = IfwZend_Validate_Hostname::ALLOW_DNS)
    {
        if (!$hostnameValidator) {
            $hostnameValidator = new IfwZend_Validate_Hostname($allow);
        }
    ...
    public function setValidateMx($mx)
    {
        if ((bool) $mx && !$this->validateMxSupported()) {
            ...
            throw new IfwZend_Validate_Exception('MX checking not available on this system');
        }
