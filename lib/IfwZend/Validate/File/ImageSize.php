 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_File_ImageSize extends IfwZend_Validate_Abstract
{
    /**
     ...
     * - maxwidth
     *
     * @param  IfwZend_Config|array $options
     * @return void
     */
    public function __construct($options)
    {
        if ($options instanceof IfwZend_Config) {
            ...
            throw new IfwZend_Validate_Exception ('Invalid options to validator provided');
        }
     ...
     * @throws IfwZend_Validate_Exception      When minwidth is greater than maxwidth
     * @throws IfwZend_Validate_Exception      When minheight is greater than maxheight
     * @return IfwZend_Validate_File_ImageSize Provides a fluent interface
     */
    public function setImageMin($options)
    {
        if (isset($options['minwidth'])) {
            if (($this->_maxwidth !== null) and ($options['minwidth'] > $this->_maxwidth)) {
                //require_once 'IfwZend/Validate/Exception.php';
                throw new IfwZend_Validate_Exception("The minimum image width must be less than or equal to the "
        ...
        if (isset($options['maxheight'])) {
            if (($this->_maxheight !== null) and ($options['minheight'] > $this->_maxheight)) {
                //require_once 'IfwZend/Validate/Exception.php';
                throw new IfwZend_Validate_Exception("The minimum image height must be less than or equal to the "
     ...
     * @throws IfwZend_Validate_Exception When maxwidth is smaller than minwidth
     * @throws IfwZend_Validate_Exception When maxheight is smaller than minheight
     * @return IfwZend_Validate_StringLength Provides a fluent interface
     */
    public function setImageMax($options)
    {
        if (isset($options['maxwidth'])) {
            if (($this->_minwidth !== null) and ($options['maxwidth'] < $this->_minwidth)) {
                //require_once 'IfwZend/Validate/Exception.php';
                throw new IfwZend_Validate_Exception("The maximum image width must be greater than or equal to the "
        ...
        if (isset($options['maxheight'])) {
            if (($this->_minheight !== null) and ($options['maxheight'] < $this->_minheight)) {
                //require_once 'IfwZend/Validate/Exception.php';
                throw new IfwZend_Validate_Exception("The maximum image height must be greater than or equal to the "
     ...
     * @param  array  $file  File data from IfwZend_File_Transfer
     * @return boolean
     */
    public function isValid($value, $file = null)
    {
        ...
        if (!Ifw_Zend_Loader::isReadable($value)) {
