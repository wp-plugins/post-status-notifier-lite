...
/**
 * @see IfwZend_Validate_File_Size
 */
//require_once 'IfwZend/Validate/File/Size.php';
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_File_FilesSize extends IfwZend_Validate_File_Size
{
    /**
     ...
     *
     * @param  integer|array|IfwZend_Config $options Options for this validator
     * @return void
     */
    ...
    public function isValid($value, $file = null)
    {
        ...
        foreach ($value as $files) {
            // Is file readable ?
            if (!Ifw_Zend_Loader::isReadable($files)) {
