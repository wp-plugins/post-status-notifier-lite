...
/**
 * @see IfwZend_Validate_File_MimeType
 */
//require_once 'IfwZend/Validate/File/MimeType.php';
 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_File_IsCompressed extends IfwZend_Validate_File_MimeType
{
    /**
     ...
     *
     * @param  string|array|IfwZend_Config $compression
     * @return void
     */
    ...
    protected function _throw($file, $errorType)
    {
        ...
        switch($errorType) {
            case IfwZend_Validate_File_MimeType::FALSE_TYPE :
                $errorType = self::FALSE_TYPE;
                break;
            case IfwZend_Validate_File_MimeType::NOT_DETECTED :
                $errorType = self::NOT_DETECTED;
                break;
            case IfwZend_Validate_File_MimeType::NOT_READABLE :
