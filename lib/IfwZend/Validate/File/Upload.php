 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_File_Upload extends IfwZend_Validate_Abstract
{
    /**@#+
     ...
     *
     * The array $files must be given in syntax of IfwZend_File_Transfer to be checked
     * If no files are given the $_FILES array will be used automatically.
     * NOTE: This validator will only work with HTTP POST uploads!
     *
     * @param  array|IfwZend_Config $files Array of files in syntax of IfwZend_File_Transfer
     * @return void
     */
    public function __construct($files = array())
    {
        if ($files instanceof IfwZend_Config) {
            $files = $files->toArray();
        }
     ...
     * @return array
     * @throws IfwZend_Validate_Exception If file is not found
     */
    public function getFiles($file = null)
    {
        if ($file !== null) {
            ...
            if (count($return) === 0) {
                ...
                throw new IfwZend_Validate_Exception("The file '$file' was not found");
            }
     ...
     *
     * @param  array $files The files to check in syntax of IfwZend_File_Transfer
     * @return IfwZend_Validate_File_Upload Provides a fluent interface
     */
