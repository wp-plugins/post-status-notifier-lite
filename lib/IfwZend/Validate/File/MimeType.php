 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_File_MimeType extends IfwZend_Validate_Abstract
{
    /**#@+
    ...
    {
        if ($mimetype instanceof IfwZend_Config) {
        ...
        if (null === $this->_magicfile) {
            if (!empty($_ENV['MAGIC'])) {
                ...
                foreach ($this->_magicFiles as $file) {
                    ...
                    } catch (IfwZend_Validate_Exception $e) {
     ...
     *
     * @param  string $file
     * @throws IfwZend_Validate_Exception When finfo can not read the magicfile
     * @return IfwZend_Validate_File_MimeType Provides fluid interface
     */
    public function setMagicFile($file)
    {
        if (empty($file)) {
            ...
            $this->_magicfile = null;
            //require_once 'IfwZend/Validate/Exception.php';
            throw new IfwZend_Validate_Exception('Magicfile can not be set. There is no finfo extension installed');
        } else if (!is_file($file) || !is_readable($file)) {
            //require_once 'IfwZend/Validate/Exception.php';
            throw new IfwZend_Validate_Exception('The given magicfile can not be read');
        } else {
            ...
            if (empty($this->_finfo)) {
                $this->_finfo = null;
                //require_once 'IfwZend/Validate/Exception.php';
                throw new IfwZend_Validate_Exception('The given magicfile is not accepted by finfo');
            } else {
     ...
     * @return IfwZend_Validate_File_Extension Provides a fluent interface
     */
