 ...
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_File_Hash extends IfwZend_Validate_Abstract
{
    /**
     ...
     *
     * @param  string|array $options
     * @return IfwZend_Validate_File_Hash Provides a fluent interface
     */
    ...
    public function addHash($options)
    {
        if (is_string($options)) {
            ...
            //require_once 'IfwZend/Validate/Exception.php';
            throw new IfwZend_Validate_Exception("False parameter given");
        }
        ...
        if (!in_array($algorithm, $known)) {
            //require_once 'IfwZend/Validate/Exception.php';
            throw new IfwZend_Validate_Exception("Unknown algorithm '{$algorithm}'");
        }
