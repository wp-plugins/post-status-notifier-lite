 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_Identical extends IfwZend_Validate_Abstract
{
    /**
     * Error codes
     * @const string
    ...
    {
        if ($token instanceof IfwZend_Config) {
            $token = $token->toArray();
        }
     ...
     *
     * @param  mixed $token
     * @return IfwZend_Validate_Identical
     */
     ...
     *
     * @param IfwZend_Validate_Identical
     */
