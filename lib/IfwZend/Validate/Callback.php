 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_Callback extends IfwZend_Validate_Abstract
{
    /**
     * Invalid callback
     */
    ...
    public function __construct($callback = null)
    {
        ...
        if (null === ($initializedCallack = $this->getCallback())) {
            ...
            throw new IfwZend_Validate_Exception('No callback registered');
        }
    }
     ...
     *
     * @param  string|array $callback
     * @return IfwZend_Validate_Callback Provides a fluent interface
     */
