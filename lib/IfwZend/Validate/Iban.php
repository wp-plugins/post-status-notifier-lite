 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_Iban extends IfwZend_Validate_Abstract
{
     ...
     *
     * @param  string|IfwZend_Config|IfwZend_Locale $locale OPTIONAL
     * @return void
     */
    ...
    public function setLocale($locale = null)
    {
        if ($locale !== false) {
            ...
            if (strlen($locale) < 4) {
                ...
                throw new IfwZend_Validate_Exception('Region must be given for IBAN validation');
            }
        }
    ...
    public function isValid($value)
    {
        ...
        if (empty($this->_locale)) {
            ...
            $region = new IfwZend_Locale($this->_locale);
