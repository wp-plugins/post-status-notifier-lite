 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_Ccnum extends IfwZend_Validate_Abstract
{
    /**
    ...
    public function isValid($value)
    {
        ...
        if (null === self::$_filter) {
            /**
             * @see IfwZend_Filter_Digits
             */
            //require_once 'IfwZend/Filter/Digits.php';
            self::$_filter = new IfwZend_Filter_Digits();
        }
