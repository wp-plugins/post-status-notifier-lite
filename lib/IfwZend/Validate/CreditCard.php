 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_CreditCard extends IfwZend_Validate_Abstract
{
    /**
     * Detected CCI list
     *
     ...
     * @return IfwZend_Validate_CreditCard Provides a fluid interface
     */
    ...
    public function setService($service)
    {
        if (!is_callable($service)) {
            ...
            throw new IfwZend_Validate_Exception('Invalid callback given');
        }
    ...
    public function isValid($value)
    {
        ...
        if (!empty($this->_service)) {
            try {
                //require_once 'IfwZend/Validate/Callback.php';
                $callback = new IfwZend_Validate_Callback($this->_service);
