 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_Barcode extends IfwZend_Validate_Abstract
{
     ...
     * Barcode adapter
     *
     * @var IfwZend_Validate_Barcode_BarcodeAdapter
     */
    protected $_adapter;
     ...
     *
     * @param  string|IfwZend_Config|
     *         IfwZend_Validate_Barcode_BarcodeAdapter $adapter Barcode adapter to use
     * @return void
    ...
    public function __construct($adapter)
    {
        ...
        if (is_array($adapter)) {
            ...
            if (array_key_exists('adapter', $adapter)) {
                ...
                throw new IfwZend_Validate_Exception("Missing option 'adapter'");
            }
        }
     ...
     *
     * @return IfwZend_Validate_Barcode_BarcodeAdapter
     */
     ...
     *
     * @param  string|IfwZend_Validate_Barcode $adapter Barcode adapter to use
    ...
    public function setAdapter($adapter, $options = null)
    {
        ...
        //require_once 'IfwZend/Loader.php';
        if (Ifw_Zend_Loader::isReadable('IfwZend/Validate/Barcode/' . $adapter. '.php')) {
            $adapter = 'IfwZend_Validate_Barcode_' . $adapter;
        }
        ...
        if (!$this->_adapter instanceof IfwZend_Validate_Barcode_AdapterInterface) {
            //require_once 'IfwZend/Validate/Exception.php';
            throw new IfwZend_Validate_Exception(
                "Adapter " . $adapter . " does not implement IfwZend_Validate_Barcode_AdapterInterface"
            );
        }
     ...
     * @return IfwZend_Validate_Barcode
     */
