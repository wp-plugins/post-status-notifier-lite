 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Validate_Date extends IfwZend_Validate_Abstract
{
    ...
    protected $_messageTemplates = array(
        self::INVALID        => "Invalid type given. String, integer, array or IfwZend_Date expected",
     ...
     * Optional locale
     *
     * @var string|IfwZend_Locale|null
     */
    protected $_locale;
     ...
     *
     * @param  string|IfwZend_Config $options OPTIONAL
     * @return void
     */
    public function __construct($options = array())
    {
        ...
        if (!array_key_exists('locale', $options)) {
            ...
            if (IfwZend_Registry::isRegistered('IfwZend_Locale')) {
                $options['locale'] = IfwZend_Registry::get('IfwZend_Locale');
            }
        }
     ...
     *
     * @return string|IfwZend_Locale|null
     */
     ...
     * @return IfwZend_Validate_Date provides a fluent interface
     */
     ...
     * according to IfwZend_Date, see IfwZend_Date::isDate()
     *
     * @param  string|array|IfwZend_Date $value
     * @return boolean
     */
    public function isValid($value)
    {
        if (!is_string($value) && !is_int($value) && !is_float($value) &&
            !is_array($value) && !($value instanceof IfwZend_Date)) {
        ...
        if (($this->_format !== null) || ($this->_locale !== null) || is_array($value) ||
             $value instanceof IfwZend_Date) {
            //require_once 'IfwZend/Date.php';
            if (!IfwZend_Date::isDate($value, $this->_format, $this->_locale)) {
    ...
    private function _checkFormat($value)
    {
        try {
            ...
            $parsed = IfwZend_Locale_Format::getDate($value, array(
            ...
            if (isset($parsed['year']) and ((strpos(strtoupper($this->_format), 'YY') !== false) and
                ...
                $parsed['year'] = IfwZend_Date::getFullYear($parsed['year']);
            }
        } catch (Exception $e) {
