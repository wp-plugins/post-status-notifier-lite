 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Filter implements IfwZend_Filter_Interface
{
     ...
     *
     * @param  IfwZend_Filter_Interface $filter
     * @param  string $placement
     * @return IfwZend_Filter Provides a fluent interface
     */
    public function addFilter(IfwZend_Filter_Interface $filter, $placement = self::CHAIN_APPEND)
    {
     ...
     * @return IfwZend_Filter Provides a fluent interface
     */
    public function appendFilter(IfwZend_Filter_Interface $filter)
    {
     ...
     * @return IfwZend_Filter Provides a fluent interface
     */
    public function prependFilter(IfwZend_Filter_Interface $filter)
    {
    ...
    /**
     * @deprecated
     * @see IfwZend_Filter::filterStatic()
     *
     * @param  mixed        $value
    ...
    {
        trigger_error(
            'IfwZend_Filter::get() is deprecated as of 1.9.0; please update your code to utilize IfwZend_Filter::filterStatic()',
            E_USER_NOTICE
        );
     ...
     * relative to the IfwZend_Filter namespace. This method automatically loads the class,
    ...
    public static function filterStatic($value, $classBaseName, array $args = array(), $namespaces = array())
    {
        ...
        $namespaces = array_merge((array) $namespaces, self::$_defaultNamespaces, array('IfwZend_Filter'));
        foreach ($namespaces as $namespace) {
            ...
            if (!class_exists($className, false)) {
                ...
                } catch (IfwZend_Exception $ze) {
                    continue;
                }
            }

            $class = new ReflectionClass($className);
            if ($class->implementsInterface('IfwZend_Filter_Interface')) {
        ...
        throw new IfwZend_Filter_Exception("Filter class not found from basename '$classBaseName'");
    }
}
