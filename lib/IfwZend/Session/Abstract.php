 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwZend_Session_Abstract
{
    /**
     ...
     * but current IfwZend_Session has been marked as read-only.
     */
    const _THROW_NOT_WRITABLE_MSG = 'IfwZend_Session is currently marked as read-only.';


    /**
     * Error message thrown when an action requires reading session data,
     * but current IfwZend_Session is not marked as readable.
     */
    const _THROW_NOT_READABLE_MSG = 'IfwZend_Session is not marked as readable.';
    ...
    protected static function _namespaceUnset($namespace, $name = null)
    {
        if (self::$_writable === false) {
             ...
             */
            //require_once 'IfwZend/Session/Exception.php';
            throw new IfwZend_Session_Exception(self::_THROW_NOT_WRITABLE_MSG);
        }
