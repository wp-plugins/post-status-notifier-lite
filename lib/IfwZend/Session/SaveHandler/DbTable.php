 ...
 * @see IfwZend_Session
 */
//require_once 'IfwZend/Session.php';
...
/**
 * @see IfwZend_Db_Table_Row_Abstract
 */
//require_once 'IfwZend/Db/Table/Row/Abstract.php';

/**
 * @see IfwZend_Config
 */
//require_once 'IfwZend/Config.php';

/**
 * IfwZend_Session_SaveHandler_DbTable
 *
 * @category   Zend
 * @package    IfwZend_Session
 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Session_SaveHandler_DbTable
    extends IfwZend_Db_Table_Abstract
    implements IfwZend_Session_SaveHandler_Interface
{
     ...
     * Constructor
     *
     * $config is an instance of IfwZend_Config or an array of key/value pairs containing configuration options for
     * IfwZend_Session_SaveHandler_DbTable and IfwZend_Db_Table_Abstract. These are the configuration options for
     * IfwZend_Session_SaveHandler_DbTable:
     *
     ...
     *
     * @param  IfwZend_Config|array $config      User-provided configuration
     * @return void
     * @throws IfwZend_Session_SaveHandler_Exception
     */
    public function __construct($config)
    {
        if ($config instanceof IfwZend_Config) {
            ...
            /**
             * @see IfwZend_Session_SaveHandler_Exception
             */
            //require_once 'IfwZend/Session/SaveHandler/Exception.php';

            throw new IfwZend_Session_SaveHandler_Exception(
                '$config must be an instance of IfwZend_Config or array of key/value pairs containing '
              . 'configuration options for IfwZend_Session_SaveHandler_DbTable and IfwZend_Db_Table_Abstract.');
        }
     ...
     * @return IfwZend_Session_SaveHandler_DbTable
     */
    ...
    protected function _setupTableName()
    {
        if (empty($this->_name) && basename(($this->_name = session_save_path())) != $this->_name) {
            ...
            throw new IfwZend_Session_SaveHandler_Exception('session.save_path is a path and not a table name.');
        }
    ...
    /**
     * Retrieve session lifetime considering IfwZend_Session_SaveHandler_DbTable::OVERRIDE_LIFETIME
     *
     * @param IfwZend_Db_Table_Row_Abstract $row
     * @return int
     */
    protected function _getLifetime(IfwZend_Db_Table_Row_Abstract $row)
    {
        $return = $this->_lifetime;
     ...
     * @return int
     */
    protected function _getExpirationTime(IfwZend_Db_Table_Row_Abstract $row)
    {
