 ...
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Navigation_Page_Mvc extends IfwZend_Navigation_Page
{
    /**
     ...
     *
     * @see getHref()
     * @var IfwZend_Controller_Action_Helper_Url
     */
     ...
     * @return IfwZend_Navigation_Page_Mvc   fluent interface, returns self
     * @throws IfwZend_Navigation_Exception  if invalid $action is given
     */
     ...
     * @return IfwZend_Navigation_Page_Mvc   fluent interface, returns self
     * @throws IfwZend_Navigation_Exception  if invalid controller name is given
     */
     ...
     * @return IfwZend_Navigation_Page_Mvc   fluent interface, returns self
     * @throws IfwZend_Navigation_Exception  if invalid module name is given
     */
     ...
     * @return IfwZend_Navigation_Page_Mvc   fluent interface, returns self
     * @throws IfwZend_Navigation_Exception  if invalid $route is given
     */
     ...
     * @see getHref()
     *
     * @param  IfwZend_Controller_Action_Helper_Url $uh  URL helper
     * @return void
     */
    public static function setUrlHelper(IfwZend_Controller_Action_Helper_Url $uh)
    {
        self::$_urlHelper = $uh;
    }
