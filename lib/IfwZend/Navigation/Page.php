...
/**
 * @see IfwZend_Navigation_Container
 */
//require_once 'IfwZend/Navigation/Container.php';

/**
 * Base class for IfwZend_Navigation_Page pages
 *
 * @category  Zend
 * @package   IfwZend_Navigation
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwZend_Navigation_Page extends IfwZend_Navigation_Container
{
    /**
     * Page label
     *
     ...
     *
     * @var string|IfwZend_Acl_Resource_Interface|null
     */
    protected $_resource;
     ...
     * Parent container
     *
     * @var IfwZend_Navigation_Container|null
     */
    protected $_parent;
    ...
    /**
     * Factory for IfwZend_Navigation_Page classes
     *
     ...
     * to IfwZend_Navigation_Page_Uri or IfwZend_Navigation_Page_Mvc. Any other value
     * for 'type' will be considered the full name of the class to construct.
     * A valid custom page class must extend IfwZend_Navigation_Page.
     *
     * If 'type' is not given, the type of page to construct will be determined
     * by the following rules:
     * - If $options contains either of the keys 'action', 'controller',
     *   'module', or 'route', a IfwZend_Navigation_Page_Mvc page will be created.
     * - If $options contains the key 'uri', a IfwZend_Navigation_Page_Uri page
     *   will be created.
     *
     * @param  array|IfwZend_Config $options  options used for creating page
     * @return IfwZend_Navigation_Page        a page instance
     * @throws IfwZend_Navigation_Exception   if $options is not array/IfwZend_Config
     * @throws IfwZend_Exception              if 'type' is specified and
     *                                     IfwZend_Loader is unable to load the
     *                                     class
     * @throws IfwZend_Navigation_Exception   if something goes wrong during
     *                                     instantiation of the page
     * @throws IfwZend_Navigation_Exception   if 'type' is given, and the specified
     *                                     type does not extend this class
     * @throws IfwZend_Navigation_Exception   if unable to determine which class
     *                                     to instantiate
     */
    public static function factory($options)
    {
        ...
        if (!is_array($options)) {
            ...
            throw new IfwZend_Navigation_Exception(
                'Invalid argument: $options must be an array or IfwZend_Config');
        }
        ...
        if(isset($type)) {
            if (is_string($type) && !empty($type)) {
                switch (strtolower($type)) {
                    case 'mvc':
                        $type = 'IfwZend_Navigation_Page_Mvc';
                        break;
                    case 'uri':
                        $type = 'IfwZend_Navigation_Page_Uri';
                        break;
                }

                if (!class_exists($type)) {
                    //require_once 'IfwZend/Loader.php';
                    @Ifw_Zend_Loader::loadClass($type);
                }

                $page = new $type($options);
                if (!$page instanceof IfwZend_Navigation_Page) {
                    //require_once 'IfwZend/Navigation/Exception.php';
                    throw new IfwZend_Navigation_Exception(sprintf(
                            'Invalid argument: Detected type "%s", which ' .
                            'is not an instance of IfwZend_Navigation_Page',
                            $type));
                }
                return $page;
            }
        ...
        if ($hasMvc) {
            //require_once 'IfwZend/Navigation/Page/Mvc.php';
            return new IfwZend_Navigation_Page_Mvc($options);
        } elseif ($hasUri) {
            //require_once 'IfwZend/Navigation/Page/Uri.php';
            return new IfwZend_Navigation_Page_Uri($options);
        } else {
            //require_once 'IfwZend/Navigation/Exception.php';
            throw new IfwZend_Navigation_Exception(
     ...
     * Page constructor
     *
     * @param  array|IfwZend_Config $options   [optional] page options. Default is
     *                                      null, which should set defaults.
     * @throws IfwZend_Navigation_Exception    if invalid options are given
     */
    ...
    /**
     * Sets page properties using a IfwZend_Config object
     *
     * @param  IfwZend_Config $config        config object to get properties from
     * @return IfwZend_Navigation_Page       fluent interface, returns self
     * @throws IfwZend_Navigation_Exception  if invalid options are given
     */
     ...
     * @return IfwZend_Navigation_Page       fluent interface, returns self
     * @throws IfwZend_Navigation_Exception  if empty/no string is given
     */
     ...
     *                                    which sets no id.
     * @return IfwZend_Navigation_Page       fluent interface, returns self
     * @throws IfwZend_Navigation_Exception  if not given string or null
     */
     ...
     * @return IfwZend_Navigation_Page       fluent interface, returns self
     * @throws IfwZend_Navigation_Exception  if target is not string or null
     */
     ...
     * @return IfwZend_Navigation_Page       fluent interface, returns self
     * @throws IfwZend_Navigation_Exception  if access key is not string or null or
     ...
     *
     * @param  array|IfwZend_Config $relations  [optional] an associative array of
     *                                       forward links to other pages
     * @return IfwZend_Navigation_Page          fluent interface, returns self
     */
    public function setRel($relations = null)
    {
        ...
        if (null !== $relations) {
            if ($relations instanceof IfwZend_Config) {
            ...
            if (!is_array($relations)) {
                ...
                throw new IfwZend_Navigation_Exception(
                        ...
                        'array or an instance of IfwZend_Config');
            }
     ...
     *                                    specific order.
     * @return IfwZend_Navigation_Page       fluent interface, returns self
     * @throws IfwZend_Navigation_Exception  if order is not integer or null
     */
     ...
     *
     * @param  string|IfwZend_Acl_Resource_Interface $resource  [optional] resource
     *                                                       to associate with
     *                                                       page. Default is
     *                                                       null, which sets no
     *                                                       resource.
     * @throws IfwZend_Navigation_Exception                     if $resource if
     *                                                       invalid
     * @return IfwZend_Navigation_Page                          fluent interface,
     *                                                       returns self
     */
    public function setResource($resource = null)
    {
        if (null === $resource || is_string($resource) ||
            $resource instanceof IfwZend_Acl_Resource_Interface) {
            $this->_resource = $resource;
        } else {
            //require_once 'IfwZend/Navigation/Exception.php';
            throw new IfwZend_Navigation_Exception(
                    'Invalid argument: $resource must be null, a string, ' .
                    ' or an instance of IfwZend_Acl_Resource_Interface');
        }
     ...
     *
     * @return string|IfwZend_Acl_Resource_Interface|null  ACL resource or null
     */
    ...
    public function isVisible($recursive = false)
    {
        if ($recursive && isset($this->_parent) &&
            $this->_parent instanceof IfwZend_Navigation_Page) {
     ...
     *
     * @param  IfwZend_Navigation_Container $parent  [optional] new parent to set.
     *                                            Default is null which will set
     *                                            no parent.
     * @return IfwZend_Navigation_Page               fluent interface, returns self
     */
    public function setParent(IfwZend_Navigation_Container $parent = null)
    {
        if ($parent === $this) {
            //require_once 'IfwZend/Navigation/Exception.php';
            throw new IfwZend_Navigation_Exception(
     ...
     *
     * @return IfwZend_Navigation_Container|null  parent container or null
     */
     ...
     * @return IfwZend_Navigation_Page       fluent interface, returns self
     * @throws IfwZend_Navigation_Exception  if property name is invalid
     */
     ...
     * @param  string $name               property name
     * @return void
     * @throws IfwZend_Navigation_Exception  if the property is native
     */
