...
/**
 * IfwZend_Navigation_Container
 *
 * Container class for IfwZend_Navigation_Page classes.
 *
 * @category  Zend
 * @package   IfwZend_Navigation
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license   http://framework.zend.com/license/new-bsd     New BSD License
 */
abstract class IfwZend_Navigation_Container implements RecursiveIterator, Countable
{
    /**
     * Contains sub pages
     *
     ...
     * calling {@link IfwZend_Navigation_Page::setParent()}.
     *
     * @param  IfwZend_Navigation_Page|array|IfwZend_Config $page  page to add
     * @return IfwZend_Navigation_Container                     fluent interface,
     *                                                       returns self
     * @throws IfwZend_Navigation_Exception                     if page is invalid
     */
    public function addPage($page)
    {
        ...
        if (is_array($page) || $page instanceof IfwZend_Config) {
            //require_once 'IfwZend/Navigation/Page.php';
            $page = IfwZend_Navigation_Page::factory($page);
        } elseif (!$page instanceof IfwZend_Navigation_Page) {
            //require_once 'IfwZend/Navigation/Exception.php';
            throw new IfwZend_Navigation_Exception(
                    'Invalid argument: $page must be an instance of ' .
                    'IfwZend_Navigation_Page or IfwZend_Config, or an array');
        }
     ...
     *
     * @param  array|IfwZend_Config|IfwZend_Navigation_Container  $pages  pages to add
     * @return IfwZend_Navigation_Container                    fluent interface,
     *                                                      returns self
     * @throws IfwZend_Navigation_Exception                    if $pages is not 
     *                                                      array, IfwZend_Config or
     *                                                      IfwZend_Navigation_Container
     */
    public function addPages($pages)
    {
        if ($pages instanceof IfwZend_Config) {
            $pages = $pages->toArray();
        }

        if ($pages instanceof IfwZend_Navigation_Container) {
        ...
        if (!is_array($pages)) {
            ...
            throw new IfwZend_Navigation_Exception(
                    ...
                    'instance of IfwZend_Config or an instance of ' .
                    'IfwZend_Navigation_Container');
        }
     ...
     * @return IfwZend_Navigation_Container  fluent interface, returns self
     */
     ...
     *
     * @return array  array of IfwZend_Navigation_Page instances
     */
     ...
     *
     * @param  IfwZend_Navigation_Page|int $page  page to remove, either a page
     ...
     *
     * @param  IfwZend_Navigation_Page $page       page to look for
     * @param  bool                 $recursive  [optional] whether to search
     *                                          recursively. Default is false.
     * @return bool                             whether page is in container
     */
    public function hasPage(IfwZend_Navigation_Page $page, $recursive = false)
    {
     ...
     * @return IfwZend_Navigation_Page|null  matching page or null
     */
     ...
     * @param  string $property  name of property to match against
     * @param  mixed  $value     value to match property against
     * @return array             array containing only IfwZend_Navigation_Page
     *                           instances
     */
     ...
     * @throws IfwZend_Navigation_Exception  if method does not exist
     */
     ...
     *
     * @return IfwZend_Navigation_Page       current page or null
     * @throws IfwZend_Navigation_Exception  if the index is invalid
     */
     ...
     * Implements RecursiveIterator interface.
     *
     * @return IfwZend_Navigation_Page|null
     */
