 ...
 * @category   Zend
 * @package    IfwZend_Date
 * @subpackage IfwZend_Date_Cities
 * @copyright  Copyright (c) 2005-2011 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class IfwZend_Date_Cities
{
    /**
     ...
     * @return array
     * @throws IfwZend_Date_Exception When city is unknown
     */
    public static function City($city, $horizon = false)
    {
        ...
        throw new IfwZend_Date_Exception('unknown city');
    }
