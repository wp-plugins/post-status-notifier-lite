 ...
 * </pre>
 */
class IfwTwig_TokenParser_Spaceless extends IfwTwig_TokenParser
{
    /**
    ...
    public function parse(IfwTwig_Token $token)
    {
        ...
        return new IfwTwig_Node_Spaceless($body, $lineno, $this->getTag());
    }

    public function decideSpacelessEnd(IfwTwig_Token $token)
    {
