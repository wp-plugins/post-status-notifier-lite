 ...
 */
class IfwTwig_Node_SandboxedModule extends IfwTwig_Node_Module
{
    protected $usedFilters;
    protected $usedTags;
    protected $usedFunctions;

    public function __construct(IfwTwig_Node_Module $node, array $usedFilters, array $usedTags, array $usedFunctions)
    {
