...
class IfwTwig_Node_Expression_Test_Defined extends IfwTwig_Node_Expression_Test
{
    public function __construct(IfwTwig_NodeInterface $node, $name, IfwTwig_NodeInterface $arguments = null, $lineno)
    {
        ...
        if ($node instanceof IfwTwig_Node_Expression_Name) {
    ...
    protected function changeIgnoreStrictCheck(IfwTwig_Node_Expression_GetAttr $node)
    {
        $node->setAttribute('ignore_strict_check', true);

        if ($node->getNode('node') instanceof IfwTwig_Node_Expression_GetAttr) {
