...
abstract class IfwTwig_Test_IntegrationTestCase extends PHPUnit_Framework_TestCase
{
    ...
    protected function doIntegrationTest($file, $message, $condition, $templates, $exception, $outputs)
    {
        ...
        $loader = new IfwTwig_Loader_Array($templates);
        ...
        foreach ($outputs as $match) {
            ...
            $twig = new IfwTwig_Environment($loader, $config);
            ...
            try {
                ...
                if ($e instanceof IfwTwig_Error_Syntax) {
                    $e->setTemplateFile($file);

                    throw $e;
                }

                throw new IfwTwig_Error(sprintf('%s: %s', get_class($e), $e->getMessage()), -1, $file, $e);
            }
            ...
            try {
                ...
                if ($e instanceof IfwTwig_Error_Syntax) {
                    ...
                    $e = new IfwTwig_Error(sprintf('%s: %s', get_class($e), $e->getMessage()), -1, $file, $e);
                }
