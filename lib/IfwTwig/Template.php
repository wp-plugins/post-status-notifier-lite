...
abstract class IfwTwig_Template implements IfwTwig_TemplateInterface
{
     ...
     * directly.
     *
     * @return IfwTwig_TemplateInterface|false The parent template or false if there is no parent
     */
    public function getParent(array $context)
    {
        ...
        if (false === $parent) {
            return false;
        } elseif ($parent instanceof IfwTwig_Template) {
    ...
    public function displayParentBlock($name, array $context, array $blocks = array())
    {
        ...
        if (isset($this->traits[$name])) {
            ...
            throw new IfwTwig_Error_Runtime(sprintf('The template has no parent and no traits defining the "%s" block', $name), -1, $this->getTemplateName());
        }
    }
    ...
    protected function displayWithErrorHandling(array $context, array $blocks = array())
    {
        try {
            ...
            // this is mostly useful for IfwTwig_Error_Loader exceptions
            // see IfwTwig_Error_Loader
            ...
            throw new IfwTwig_Error_Runtime(sprintf('An exception has been thrown during the rendering of a template ("%s").', $e->getMessage()), -1, null, $e);
        }
    }
     ...
     *
     * @throws IfwTwig_Error_Runtime if the variable does not exist and Twig is running in strict mode
     */
    final protected function getContext($context, $item, $ignoreStrictCheck = false)
    {
        if (!array_key_exists($item, $context)) {
            ...
            throw new IfwTwig_Error_Runtime(sprintf('Variable "%s" does not exist', $item), -1, $this->getTemplateName());
        }
    ...
    protected function getAttribute($object, $item, array $arguments = array(), $type = IfwTwig_TemplateInterface::ANY_CALL, $isDefinedTest = false, $ignoreStrictCheck = false)
    {
        ...
        if (isset(self::$cache[$class]['methods'][$lcItem])) {
            ...
            throw new IfwTwig_Error_Runtime(sprintf('Method "%s" for object "%s" does not exist', $item, get_class($object)), -1, $this->getTemplateName());
        }
        ...
        if ($object instanceof IfwTwig_TemplateInterface) {
            return $ret === '' ? '' : new IfwTwig_Markup($ret, $this->env->getCharset());
        }
