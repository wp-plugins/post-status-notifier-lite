...
class IfwTwig_NodeVisitor_SafeAnalysis implements IfwTwig_NodeVisitorInterface
{
    ...
    public function getSafe(IfwTwig_NodeInterface $node)
    {
    ...
    public function leaveNode(IfwTwig_NodeInterface $node, IfwTwig_Environment $env)
    {
        ...
        } elseif ($node instanceof IfwTwig_Node_Expression_BlockReference) {
            // blocks are safe by definition
            $this->setSafe($node, array('all'));
        } elseif ($node instanceof IfwTwig_Node_Expression_Parent) {
            // parent block is safe by definition
            $this->setSafe($node, array('all'));
        } elseif ($node instanceof IfwTwig_Node_Expression_Conditional) {
        ...
        } elseif ($node instanceof IfwTwig_Node_Expression_Function) {
        ...
        } elseif ($node instanceof IfwTwig_Node_Expression_MethodCall) {
