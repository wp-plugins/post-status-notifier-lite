 ...
 */
abstract class Ifw_Wp_Env_Abstract
{
    /**
     * Plugin's root file PHP pathinfo() data
     * @var Ifw_Wp_Pathinfo_Abstract
     */
    protected $_pathinfo;
    ...
    /**
     * 
     * @param Ifw_Wp_Pathinfo_Abstract $pathinfo
     */
    protected function __construct(Ifw_Wp_Pathinfo_Abstract $pathinfo)
    {
