 ...
 * @version  $Id$
 */
class Ifw_Wp_ORM_ORM extends Ifw_Wp_ORM_Idiorm
{
    /**
    ...
    public static function usePdo($connection_name)
    {
        ...
        return $usePdo && Ifw_Wp_Server_Php::isPdoMysql();
    }
    ...
    /**
     * Overwrite to get an Ifw_Wp_ORM_ORM instance
     *
     * @param string $table_name
     * @param string $connection_name
     * @return Ifw_Wp_ORM_ORM|ORM
     */
    ...
    /**
     * Overwrite to get an Ifw_Wp_ORM_ORM instance from for_table
     *
     * @param $row
     * @return Ifw_Wp_ORM_ORM|ORM
     */
