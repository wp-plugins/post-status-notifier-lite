...
abstract class Ifw_Wp_Plugin_ListTable_Abstract extends WP_List_Table
{
    /**
     * @var
     */
    ...
    /**
     * @var Ifw_Wp_Plugin_ListTable_Data_Interface
     */
    protected $_data;
     ...
     * 
     * @param array $args
     * @param Ifw_Wp_Plugin_ListTable_Data_Interface $data
     */
    public function __construct($args = array(),
                                Ifw_Wp_Plugin_ListTable_Data_Interface $data,
    ...
    protected function _initData()
    {
        ...
        // assign the data from Ifw_Wp_Plugin_ListTable_Data_Interface to the $items property
