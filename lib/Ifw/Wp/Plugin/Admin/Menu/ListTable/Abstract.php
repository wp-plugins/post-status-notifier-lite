...
abstract class Ifw_Wp_Plugin_Admin_Menu_ListTable_Abstract extends WP_List_Table
{
    /**
     * @var
     */
    ...
    /**
     * @var Ifw_Wp_Plugin_Admin_Menu_ListTable_Data_Interface
     */
    protected $_data;
     ...
     * 
     * @param array $args
     * @param Ifw_Wp_Plugin_Admin_Menu_ListTable_Data_Interface $data
     */
    public function __construct($args = array(),
                                Ifw_Wp_Plugin_Admin_Menu_ListTable_Data_Interface $data,
                                Ifw_Wp_Plugin_Manager $pm)
    {
    ...
    protected function _init()
    {
        ...
        if (isset($this->_options['ajax']) && $this->_options['ajax'] == true) {
            Ifw_Wp_Proxy_Action::add($this->_wpActionPrefix . 'after_display', array($this, 'loadAjaxScript'));
        }
        Ifw_Wp_Proxy_Action::add($this->_wpActionPrefix . 'after_display', array($this, 'loadScriptReplaceSearchBox'));
    }
    ...
    protected function _initData()
    {
        ...
        // assign the data from Ifw_Wp_Plugin_Admin_Menu_ListTable_Data_Interface to the $items property
    ...
    {
        $filter = new IfwZend_Filter_Word_UnderscoreToCamelCase();
    ...
    public function extra_tablenav($pos)
    {
        ...
        Ifw_Wp_Proxy_Action::add($this->_wpActionPrefix . '_before_controls_top', $this);

        if (method_exists($this, $methodName)) {
            call_user_func(array($this, $methodName));
        }

        Ifw_Wp_Proxy_Action::add($this->_wpActionPrefix . '_after_controls_top', $this);
    }
    ...
    /** (non-PHPdoc)
     * @see Ifw_Wp_Plugin_Admin_Menu_ListTable_Data_Interface::getHiddenColumns()
     */
    ...
    {
        return Ifw_Wp_Proxy_Filter::apply(
    ...
    public function display()
    {
        ...
        <form id="<?php echo $this->_id; ?>" method="post" action="<?php echo $this->_formAction; ?>" class="ifw-listtable">
            ...
            <?php endif; ?>
            <?php
            Ifw_Wp_Proxy::doAction($this->_wpActionPrefix . 'before_display', $this);
            echo parent::display();
            Ifw_Wp_Proxy::doAction($this->_wpActionPrefix .  'after_display', $this);
            ?>
        </form>
        <?php
    }
