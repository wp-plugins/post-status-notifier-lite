 ...
 * @package  Ifw_Wp
 */
class Ifw_Wp_Plugin_Admin_Menu_Metabox_PluginStatus extends Ifw_Wp_Plugin_Admin_Menu_Metabox_Ajax
{
    /**
     * (non-PHPdoc)
    ...
    public function getAjaxResponse()
    {
        ...
        $context = array(
            ...
            'iframe_src' => Ifw_Wp_Proxy_Admin::getUrl() . substr(Ifw_Wp_Proxy_Admin::getMenuUrl($this->_pm, 'selftest'), 1)
        );
