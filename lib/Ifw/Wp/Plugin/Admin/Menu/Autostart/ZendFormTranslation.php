 ...
 * @version  $Id$
 */ 
class Ifw_Wp_Plugin_Admin_Menu_Autostart_ZendFormTranslation extends Ifw_Wp_Plugin_Admin_Menu_Autostart_Abstract
{
    public function execute()
    {
        $translator = new IfwZend_Translate(
            'array',
            $this->_menu->getPm()->getPathinfo()->getRootLib() . 'Ifw/Zend/Form/resources/languages',
