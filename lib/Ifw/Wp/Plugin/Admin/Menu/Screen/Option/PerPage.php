 ...
 * @version  $Id$
 */ 
class Ifw_Wp_Plugin_Admin_Menu_Screen_Option_PerPage extends Ifw_Wp_Plugin_Admin_Menu_Screen_Option_Abstract
{
    /**
     * @var string
     */
     ...
     * @throws Ifw_Wp_Plugin_Admin_Menu_Screen_Exception
     */
    protected function _register()
    {
        $label = $this->getLabel();
        if (empty($label)) {
            throw new Ifw_Wp_Plugin_Admin_Menu_Screen_Exception('Missing screen option label');
        }
        $optionName = $this->getOptionName();
        if (empty($optionName)) {
            throw new Ifw_Wp_Plugin_Admin_Menu_Screen_Exception('Missing screen option name');
        }
