 ...
 * @package   
 */ 
abstract class Ifw_Wp_Plugin_Menu_Page_Main implements Ifw_Wp_Plugin_Menu_Page_Interface
{
    /**
    ...
    {
        Ifw_Wp_Proxy_Action::doPlugin($this->_pm, 'before_load_menu_page', $this);
        ...
        /**
         * @var Ifw_Wp_Plugin_Menu_Page_Sub $subPage
         */
        foreach($this->getSubPages() as $subPage) {

            Ifw_Wp_Proxy_Action::doPlugin($this->_pm, 'before_load_submenu_page', $subPage);
            ...
            Ifw_Wp_Proxy_Action::doPlugin($this->_pm, 'after_load_submenu_page', $subPage);
            if ($this->_pm->getAccess()->getPage() == $subPage->getSlug()) {
                $subPage->onLoad();
            }
        }

        Ifw_Wp_Proxy_Action::doPlugin($this->_pm, 'after_load_menu_page', $this);
    ...
    public function _callback()
    {
        if ($this->getCallback() instanceof Ifw_Wp_Plugin_Application_PageMapperInterface) {
            ...
            Ifw_Wp_Proxy_Action::doPlugin($this->_pm, 'menu_page_callback', $this);
        }
    }
     ...
     * @return $this
     */
    public function registerSubPage(Ifw_Wp_Plugin_Menu_Page_Sub $subPage)
    {
        array_push($this->_subPages, $subPage);
        Ifw_Wp_Proxy_Action::doPlugin($this->_pm, 'after_register_submenu_page', $subPage);
        return $this;
    }
