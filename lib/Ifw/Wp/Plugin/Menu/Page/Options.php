 ...
 * @package   
 */ 
abstract class Ifw_Wp_Plugin_Menu_Page_Options implements Ifw_Wp_Plugin_Menu_Page_Interface
{
    /**
    ...
    {
        Ifw_Wp_Proxy_Action::doPlugin($this->_pm, 'before_load_options_page', $this);
        ...
        Ifw_Wp_Proxy_Action::doPlugin($this->_pm, 'after_load_options_page', $this);
        if ($this->_pm->getAccess()->getPage() == $this->getSlug()) {
            $this->onLoad();
        }
    }
    ...
    public function _callback()
    {
        if ($this->getCallback() instanceof Ifw_Wp_Plugin_Application_PageMapperInterface) {
            ...
            Ifw_Wp_Proxy_Action::doPlugin($this->_pm, 'options_page_callback', $this);
        }
    }
