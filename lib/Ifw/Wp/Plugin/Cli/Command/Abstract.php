 ...
 * @package  Ifw_Wp
 */
abstract class Ifw_Wp_Plugin_Cli_Command_Abstract
{
    /**
     ...
     *
     */
    public function __construct ($command, $params, Ifw_Wp_Plugin_Manager $pm)
    {
        $this->_pm = $pm;
    ...
    protected function _validateSupportedParams()
    {
        ...
        foreach ($requiredParams as $reqParam) {
            ...
            if (!isset($this->_params[$reqParam['name']]) && !isset($this->_params[$reqParam['shortName']])) {
                throw new Ifw_Wp_Plugin_Cli_Command_Exception_MissingOperand($this->_fetchUsage());
            }
        }
    }
