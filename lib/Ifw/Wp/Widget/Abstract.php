 ...
 * @version  $Id$
 */
abstract class Ifw_Wp_Widget_Abstract extends WP_Widget
{
    /**
    ...
    public function update($new_instance, $old_instance)
    {
        ...
        foreach ($this->_options as $option) {
            if (isset($option['sanitizer']) && function_exists($option['sanitizer'])) {
                // set defined sanitizer
                $value = $option['sanitizer']($new_instance[$option['name']]);
            } else {
                // default sanitizer
     ...
     */
    protected function _initPluginManager()
    {
    ...
    {
        $this->_tpl = Ifw_Wp_Tpl::getFilesytemInstance($this->_pm);
    }
