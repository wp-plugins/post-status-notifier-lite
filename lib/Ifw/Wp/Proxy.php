...
class Ifw_Wp_Proxy
{
    ...
    /**
     * @var Ifw_Wp_Proxy_Script
     */
    protected $_scriptProxy;
    
    /**
     * @var Ifw_Wp_Proxy_Style
     */
    protected $_styleProxy;
    
    /**
     * @var Ifw_Wp_Proxy_JQuery
     */
    protected $_jqueryProxy;
    
    /**
     * @var Ifw_Wp_Proxy_WPML
     */
    protected $_wpmlProxy;
    
    
    /**
     * Retrieves singleton Ifw_Wp_Proxy object
    ...
    /**
     * @return Ifw_Wp_Proxy_Script
     */
    public function script()
    {
        if ($this->_scriptProxy == null) {
            $this->_scriptProxy = new Ifw_Wp_Proxy_Script($this, $this->_pm);
        }
        return $this->_scriptProxy;
    }
    
    /**
     * @return Ifw_Wp_Proxy_Style
     */
    public function style()
    {
        if ($this->_styleProxy == null) {
            $this->_styleProxy = new Ifw_Wp_Proxy_Style($this, $this->_pm);
        }
        return $this->_styleProxy;
    }
    
    /**
     * @return Ifw_Wp_Proxy_JQuery
     */
    public function jQuery()
    {
        if ($this->_jqueryProxy == null) {
            $this->_jqueryProxy = new Ifw_Wp_Proxy_JQuery($this, $this->_pm);
        }
        return $this->_jqueryProxy;
    }
    
    /**
     * @return Ifw_Wp_Proxy_WPML
     */
    public function WPML()
    {
        if ($this->_wpmlProxy == null) {
            $this->_wpmlProxy = new Ifw_Wp_Proxy_WPML($this, $this->_pm);
        }
     ...
     * @deprecated use Ifw_Wp_Proxy_Blog::getVersion
     * @return string
     */
    ...
    {
        $filterTag = $option;
        return Ifw_Wp_Proxy_Filter::apply($filterTag, get_option($option, $default));
    }
