 ...
 * @version  $Id$
 */
class Ifw_Wp_Proxy_WPML extends Ifw_Wp_Proxy_Abstract
{
    /**
     ...
     *
     *
     * @throws Ifw_Wp_Proxy_WPML_Exception
     * @return boolean
     */
    protected function _checkStatus()
    {
        if (!function_exists('icl_get_default_language')) {
            throw new Ifw_Wp_Proxy_WPML_Exception('Wpml function not found: icl_get_default_language');
        } elseif (!function_exists('icl_get_languages')) {
            throw new Ifw_Wp_Proxy_WPML_Exception('Wpml function not found: icl_get_languages');
        } elseif (!defined('ICL_LANGUAGE_CODE')) {
            throw new Ifw_Wp_Proxy_WPML_Exception('Wpml constant not found: ICL_LANGUAGE_CODE');
        }
