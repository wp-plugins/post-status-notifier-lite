...
class Ifw_Wp_Proxy_JQuery
{
    ...
    public static function loadEffect($effect)
    {
        if (in_array($effect, self::getEffects())) {
            Ifw_Wp_Proxy_Script::load('jquery-effects-'. $effect);
        }
    }
     ...
     * @return array
     */
    public static  function getUiThemes(Ifw_Wp_Plugin_Manager $pm)
    {
        $themes = array();
     ...
     * @return string
     */
    public static function getUiThemeRoot(Ifw_Wp_Plugin_Manager $pm)
    {
     ...
     * @return string
     */
    public static function getUiThemeUrl($theme_name, Ifw_Wp_Plugin_Manager $pm)
    {
     ...
     * @return bool
     */
    public static function isValidUiTheme($theme_name, Ifw_Wp_Plugin_Manager $pm)
    {
     ...
     * @return false
     */
    public static function loadUiTheme($theme_name, Ifw_Wp_Plugin_Manager $pm, $handle='jquery-ui-custom')
    {
        if (self::isValidUiTheme($theme_name, $pm)) {
            Ifw_Wp_Proxy_Style::load($handle, self::getUiThemeUrl($theme_name, $pm));
            return true;
        }
        return false;
    }
     ...
     */
    public static function getUiThemeFile($theme_name, Ifw_Wp_Plugin_Manager $pm)
    {
        $file_name = '';
