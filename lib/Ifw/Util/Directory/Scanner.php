 ...
 * @version  $Id$
 */ 
class Ifw_Util_Directory_Scanner
{
    /**
     * @var string
     */
     ...
     * @return \Ifw_Util_Directory_Scanner_Result
     */
    public function getClassesImplementingInterface($interface, $includeAbstracts = false)
    {
        ...
        return new Ifw_Util_Directory_Scanner_Result($result);
    }
    ...
    {
        $contents = array();
        $dir = new Ifw_Util_Directory_Iterator($this->_dir);
